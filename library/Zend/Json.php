...
class Zend_Json
{
    ...
    {
        ////// Add by Erwin.St 020822
        if(is_array($valueToEncode) && Zend_Controller_Front::getInstance()->getRequest()->getModuleName() == 'erems'){ //// Erems
            require_once APPLICATION_PATH . "/modules/erems/box/Tools.php";
            $valueToEncode = Main_Box_Tools::generateShowExecSP($valueToEncode);
        }
        ///////

        /* SEFTIAN ALFREDO 20230803 */
        if(is_array($valueToEncode) && (Zend_Controller_Front::getInstance()->getRequest()->getModuleName() == 'cashier' || Zend_Controller_Front::getInstance()->getRequest()->getModuleName() == 'appsmgmt')){ // cashier
            require_once APPLICATION_PATH . "/modules/cashier/box/Tools.php";
            $valueToEncode = Main_Box_Tools::debugExecuteSP($valueToEncode);
        }
        /*##########################*/
