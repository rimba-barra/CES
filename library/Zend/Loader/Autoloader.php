...
class Zend_Loader_Autoloader
{
    ...
    public function getClassAutoloaders($class)
    {
		...
		// Get autoloader exception
		protected static function getClassAutoloader(){
		
			Zend_File_Transfer_Adapter_Abstract::getPluginsLoader();
	}
