...
/**
 * Description of ExportpersonalController
 *
 * @author MIS
 */
class Hrd_ExportpersonalController extends Box_Models_App_Hermes_AbstractController {
...
//    }
   ...
   public function exportpersonalRead() {
        $obj = new Hrd_Models_Report_Exportpersonal();
