 ...
 * @author MIS
 */
class Hrd_TransferapitransactionController extends Box_Models_App_Hermes_AbstractController {
        ...
        if($pt_id == '999'){
            ...
            if($arr_temp_union_projectpt){
                foreach($arr_temp_union_projectpt as $key => $item){
                    ...
                    //added by michael 2023-07-20|yg nonactive date lebih kecil dari hari ini tetap muncul
                    $appdata['end_date'] = date('Y-m-d');

                    $hasil_emp = $dao->getAllProjectPt($this->getAppRequest(), $em, $this->getAppSession(), $appdata);
                    $emp = $hasil_emp[1];

                    //added by michael 2023-07-20|balikin dari yg diatas
                    $appdata['end_date'] = $end_date;
    ...
    public function codecherry($item_emp,$company_code,$data_param){
        ...
        if($get_productivity_form_code[0]){
            ...
            $data['productivity_form_code'] = null;
        }
        ...
        if($get_productivitydetail_form_code[0]){
            ...
            $data['productivitydetail_form_code'] = null;
        }
