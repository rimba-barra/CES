 ...
 * @author MIS
 */
class Hrd_AllemployeeController extends Box_Models_App_Hermes_AbstractController {
    ...
    public function allRead() {
        ...
        $dataList = new Box_Models_App_DataListCreator('', 'allemployee', array(), array());
        $dao = new Hrd_Models_AllemployeeDao();
        $header = new Hrd_Models_Master_Allemployee();
    ...
    public function exportRead() {
        ...
        $dao = new Hrd_Models_AllemployeeDao();
        $obj = new Hrd_Models_Report_Exportallemployee();     
        
        $params = $this->getAppData();
        $result = $dao->getAllEmployeeExport(json_decode($params['data'], TRUE), $this->getAppSession());
        $return = $obj->create_excel_allemployee($params['export'],$result);
