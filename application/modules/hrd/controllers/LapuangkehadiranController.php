 ...
 * @author MIS
 */
class Hrd_LapuangkehadiranController extends Box_Models_App_Hermes_AbstractController {
    ...
    public function initRead(){
       ...
       $otherAT = array(array(
        ...
        $dm->setHasil(array($pt,$project,$allDepartment,$allAlokasiBiaya,$otherAT));
    ...
    public function exportdataRead() {
        $obj = new Hrd_Models_Report_Exportlaptransport();
