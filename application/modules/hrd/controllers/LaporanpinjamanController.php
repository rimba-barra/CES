 ...
 * @author MIS
 */
class Hrd_LaporanpinjamanController extends Box_Models_App_Hermes_AbstractController {
    ...
    public function initRead(){
       ...
       $otherAT = array(array(
        ...
        $dm->setHasil(array($pt,$project,$allDepartment,$allDivision,$allkt,$allCategories,$allStatusAr,$otherAT));
