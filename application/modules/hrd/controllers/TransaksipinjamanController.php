 ...
 * @author MIS
 */
class Hrd_TransaksipinjamanController extends Box_Models_App_Hermes_AbstractController {
    ...
    public function allRead() {
        ...
        $dataList = new Box_Models_App_DataListCreator('', 'pinjaman', array('employee','tipepinjaman','marriagestatus','department','group'),array('detail'));
        $dao = new Hrd_Models_Pinjaman_TransaksiDao();
        $header = new Hrd_Models_Pinjaman_Pinjaman();
    ...
    public function employeeRead() {
        $dm = new Box_Models_App_Hermes_DataModel();
        $dataList = new Box_Models_App_DataListCreator('', 'employee', array('department','group','marriagestatus'), array());
    ...
    public function pelunasanRead(){
        ...
        $dao = new Hrd_Models_Pinjaman_TransaksiDao();
        $hasil = $dao->updateLunas($this->getAppSession(), $data["month"],$data["year"],$data["employee_id"]);
    ...
    public function batalpelunasanRead(){
        ...
        $dao = new Hrd_Models_Pinjaman_TransaksiDao();
        $hasil = $dao->batalLunas($this->getAppSession(), $data["month"],$data["year"],$data["employee_id"]);
    ...
    public function mainCreate() {
        ...
        $dm = new Box_Models_App_Hermes_DataModel();
        $obj = new Hrd_Models_Pinjaman_Pinjaman();
