 ...
 * @author MIS
 */
class Hrd_TrainingreportgroupController extends Box_Models_App_Hermes_AbstractController {
    ...
    public function initRead(){
        ...
        /// subholding list
        // $dao = new Hrd_Models_Training_Trainingallsubholding_Dao();
        // $kategoriallshFilter = new Hrd_Models_Training_Trainingallsubholding_Trainingallsubholding();
        // $hasilallsh = $dao->getAllWoPL();
        // $allsh = array();
        // foreach ($hasilallsh[1] as $recordallsh){
    
        //     $sh = new Hrd_Models_Training_Trainingallsubholding_Trainingallsubholding();
        //     $sh->setArrayTable($recordallsh);
        //     $allsh[] = $sh;
        // }
    ...
    public function exportdataRead() {
        $obj = new Hrd_Models_Report_Exporttraininggroup();
        ...
        $result = $obj->exceldata($post_data, $this->getAppSession());  
        $hasil = TRUE;
        $arrayRespon = array(
            "HASIL" => $hasil);
