...
class Hrd_BobotnilaiController extends Box_Models_App_Hermes_WingedController {
    ...
    public function allRead(){
        ...
        $dataList = new Box_Models_App_DataListCreator('', 'bobotnilai', array(),array());
    ...
    protected function getMainDao() {
        return new Hrd_Models_Master_BobotNilaiDao();
    }

    protected function getMainFieldID() {
        return "bobotnilai_id";
    }
    ...
    protected function getMainValidator() {
        return new Hrd_Models_Master_BobotNilaiValidator();
    }
