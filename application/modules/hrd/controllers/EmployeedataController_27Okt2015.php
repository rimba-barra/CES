 ...
 * @author MIS
 */
class Hrd_EmployeedataController extends Box_Models_App_Hermes_AbstractController {
    ...
    public function initRead(){
       ...
       $other = array(array("RT_SPOUSE"=>  Box_Config::getv("RT_SPOUSE"),
                            "RT_CHILD"=>  Box_Config::getv("RT_CHILD"),
                            "RT_SAUDARA"=>  Box_Config::getv("RT_SAUDARA"),
                            "RT_FRIEND"=>  Box_Config::getv("RT_FRIEND"),
                            "RT_FATHER"=>  Box_Config::getv("RT_FATHER"),
                            "RT_MOTHER"=>  Box_Config::getv("RT_MOTHER")));
       $otherAT = array(array(
        ...
        $dm->setHasil(array($pt,$project,$allDepartment,$allStatusAr,$other,$otherAT));
