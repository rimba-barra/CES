 ...
 * @author MIS
 */
class Hrd_OvertimereportController extends Box_Models_App_Hermes_AbstractController {
    ...
    public function initRead(){
     ...
     //    var_dump($_SESSION["Ciputra"]["common"]["btab_sessid"]);
      //  var_dump($_SESSION["Ciputra"]["common"]["modules"]);
       ...
       $otherAT = array(array(
        ...
        $dm->setHasil(array($pt,$project,$allDepartment,$allEmployee,$allDivision,$allCategories,$allStatusAr,$otherAT));
    ...
    public function exportdataRead() {
        $obj = new Hrd_Models_Report_Exportlapovertime();
