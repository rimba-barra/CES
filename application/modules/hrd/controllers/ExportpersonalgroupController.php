...
/**
 * Description of ExportpersonalgroupController
 *
 * @author MIS
 */
class Hrd_ExportpersonalgroupController extends Box_Models_App_Hermes_AbstractController {
...
//    }
    ...
    public function initRead(){
       ...
       $otherAT = array(array(
        ...
        $dm->setHasil(array($pt,$project,$allDepartment,$allDivision,$allCategories,$allEmployee,$allStatusAr,$otherAT));
   ...
   public function exportpersonalgroupRead() {
        $obj = new Hrd_Models_Report_Exportpersonalgroup();
