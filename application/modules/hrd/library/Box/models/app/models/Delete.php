 ...
 * @author MIS
 */
class Box_Models_App_Models_Delete extends Box_Models_App_AbModel {
    private $hasil;
    private $idProperty;
     
    public function __construct($controller, $debug = '') {
        $this->hasil = new Box_Models_App_HasilSaveUpdate();
    ...
    public function execute(Box_Models_App_BlackHole $blackHole){
        $idP = $this->idProperty;
        ...
        $decan = new Box_Models_App_Decan($idAr);
