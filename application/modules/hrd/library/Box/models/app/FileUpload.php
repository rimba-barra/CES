 ...
 * @author TOMMY-MIS
 */
class Box_Models_App_FileUpload {
    private $folder;
    private $prefixName;
    private $errorMsg;
    private $success;
    ...
    public static function getFilePath($folder,$fileName){
        return APPLICATION_PATH . '/../'.$folder.''.$fileName;
    }
    ...
    public function run(){
        ...
        $pathFile = APPLICATION_PATH . '/..'.$this->folder. $this->fileName;
        ...
        $upload->addFilter('Rename', array('target' => $pathFile, 'overwrite' => true));
