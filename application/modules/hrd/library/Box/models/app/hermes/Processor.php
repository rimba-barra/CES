 ...
 * @author MIS
 */
class Box_Models_App_Hermes_Processor {
    ...
    public function doRead(Box_Models_App_Hermes_AbstractController $controller) {
        $app = new Box_Models_App_Models_ReadWorms($controller, $this->getSampleData());
    ...
    /*added 6 Mei 2014 */
    public function doDelete(Box_Models_App_Hermes_AbstractController $controller){
        $dataModel = NULL;
        ...
        $app = new Box_Models_App_Models_Delete($controller);
