 ...
 * @author MIS
 */
abstract class Box_Models_App_Hermes_AbstractController extends Box_Models_App_Controller {
    private $processor;
    private $app;
    ...
    protected function selectedRequestor(Box_Kouti_Requestor $requestor) {
    ...
    /*@return Box_Models_App_Hermes_Processor
     * 
     */
    protected function getDefaultProcessor(){
        return new Box_Models_App_Hermes_Processor();
    }
    
    public function setApp(Box_Models_App_AbModel $app){
        $this->app = $app;
    }
     ...
     */
    protected function setArrayTable(Box_Kouti_Remora $remora,$data) {
    ...
    protected function fillData($data, & $filledArray, Box_Models_App_Creator $creator, $creatorName, $creatorParams = NULL) {
        if (count($data) > 0) {
