...
abstract class Box_Kouti_AbApp {
    ...
    public function setHasil(Box_Kouti_InterHasil $interHasil) {
        $this->hasil = $interHasil;
    }

    public function setSession(Box_Kouti_InterSession $interSession) {
    ...
    protected final function prosesZendSession() {
        ...
        $ourSes = $this->session;
        if ($ourSes instanceof Box_Kouti_InterSession) {
            if ($ses != NULL) {
