 ...
 * @author TOMMY-MIS
 */
class Hrd_Models_Payroll_Lembur_Komponen extends Box_Models_ObjectEmbedData implements Box_Kouti_Remora,Box_Models_Master_InterProjectPt  {
    private $project;
    private $pt;
    ...
    public function __construct() {
        parent::__construct();
        $this->embedPrefix = "komponenlembur_";
    }
    ...
    public function setArrayTable($dataArray = NULL) {
        ...
        if(isset ($x['komponenlembur_id'])){
           $this->setId($x['komponenlembur_id']); 
        }
