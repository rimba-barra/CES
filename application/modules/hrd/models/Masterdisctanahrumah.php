...
class Hrd_Models_Masterdisctanahrumah extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_masterdisctanahrumah';
    }
            ...
            try {
                ...
                switch ($this->setting->_param['mode_read']) {
                    ...
                    case 'approve':
                        ...
                        $this->setting->_iddata = $param['disctanah_rumah_id'];
                        $this->setting->_param = $param;
                        $result = $this->setting->executeSP();
