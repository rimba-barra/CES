 ...
 * @author TOMMY-MIS
 */
class Hrd_Models_Leave_SanksiKeterlambatan extends Box_Models_ObjectEmbedData implements  Box_Kouti_Remora, Box_Models_Master_InterProjectPt  {
    private $project;
    private $projectid;
    private $pt;
    private $ptid;
    private $sanksiketerlambatan_id;
    private $periode;
    private $periode_month;
    private $leavegroup;
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->embedPrefix = "sanksiketerlambatan_";
    }
    ...
    public function setArrayTable($dataArray = NULL) {
        ...
        if(isset ($x['sanksiketerlambatan_id'])){
           $this->setId($x['sanksiketerlambatan_id']); 
        }
        if(isset ($x['periode'])){
           $this->setPeriode($x['periode']); 
        }
        if(isset ($x['periode_month'])){
           $this->setPeriodeMonth($x['periode_month']); 
        }
    ...
    public function getArrayTable() {
        ...
        $x = array(
            'sanksiketerlambatan_id'=>$this->getId(),
            'periode'=>$this->getPeriode(),
            'periode_month'=>$this->getPeriodeMonth(),
