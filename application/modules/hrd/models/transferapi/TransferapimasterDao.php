 ...
 * @author TOMMY-MIS
 */
class Hrd_Models_Transferapi_TransferapimasterDao extends Box_Models_App_AbDao implements Box_Models_App_BlackHole {
    ...
    public function saveMaster(Box_Models_App_HasilRequestRead $r, Hrd_Models_Transferapi_Transferapimaster $em,$session,$data,$jsonString,$jsonStringResult) {
        ...
        if($data['value'] == 'employee'){
            ...
            if($jsonString['statusinformation_contract_end'] != '-' && $jsonString['statusinformation_contract_end'] != '1900-01-01'){
                ...
                $statusinformation_contract_end = null;
            }
            ...
            if($jsonString['statusinformation_contract_start'] != '-' && $jsonString['statusinformation_contract_start'] != '1900-01-01'){
                ...
                $statusinformation_contract_start = null;
            }
            ...
            if($jsonString['statusinformation_consultant_end'] != '-' && $jsonString['statusinformation_consultant_end'] != '1900-01-01'){
                ...
                $statusinformation_consultant_end = null;
            }
            ...
            if($jsonString['statusinformation_consultant_start'] != '-' && $jsonString['statusinformation_consultant_start'] != '1900-01-01'){
                ...
                $statusinformation_consultant_start = null;
            }
...
// print_r($opsi_input);die();
    ...
    public function saveMasterBeforeApi(Box_Models_App_HasilRequestRead $r, Hrd_Models_Transferapi_Transferapimaster $em,$session,$data,$jsonString) {
        ...
        if($data['value'] == 'employee'){
            ...
            if($jsonString['statusinformation_assignation_date'] != '-' && $jsonString['statusinformation_assignation_date'] != '1900-01-01'){
                ...
                $statusinformation_assignation_date = null;
            }
            ...
            if(!array_key_exists('project_id', $jsonString)) $jsonString['project_id'] = null;
            if(!array_key_exists('project_name', $jsonString)) $jsonString['project_name'] = null;
            if(!array_key_exists('pt_id', $jsonString)) $jsonString['pt_id'] = null;
            if(!array_key_exists('pt_name', $jsonString)) $jsonString['pt_name'] = null;
            if(!array_key_exists('employee_id', $jsonString)) $jsonString['employee_id'] = null;
            if(!array_key_exists('employee_name', $jsonString)) $jsonString['employee_name'] = null;
            if(!array_key_exists('employee_nik', $jsonString)) $jsonString['employee_nik'] = null;
            if(!array_key_exists('nik_group', $jsonString)) $jsonString['nik_group'] = null;
            if(!array_key_exists('sex', $jsonString)) $jsonString['sex'] = null;
            if(!array_key_exists('religion_religion_id', $jsonString)) $jsonString['religion_religion_id'] = null;
            if(!array_key_exists('religion_religion', $jsonString)) $jsonString['religion_religion'] = null;
            if(!array_key_exists('birth_date', $jsonString)) $jsonString['birth_date'] = null;

            if(!array_key_exists('birth_place', $jsonString)) $jsonString['birth_place'] = null;
            if(!array_key_exists('id_type', $jsonString)) $jsonString['id_type'] = null;
            if(!array_key_exists('ktp_number', $jsonString)) $jsonString['ktp_number'] = null;
            if(!array_key_exists('marriagestatus_marriagestatus_id', $jsonString)) $jsonString['marriagestatus_marriagestatus_id'] = null;
            if(!array_key_exists('marriagestatus_marriagestatus', $jsonString)) $jsonString['marriagestatus_marriagestatus'] = null;
            if(!array_key_exists('nationality', $jsonString)) $jsonString['nationality'] = null;
            if(!array_key_exists('npwp', $jsonString)) $jsonString['npwp'] = null;
            if(!array_key_exists('ptkp_id', $jsonString)) $jsonString['ptkp_id'] = null;
            if(!array_key_exists('ptkp_code', $jsonString)) $jsonString['ptkp_code'] = null;
            if(!array_key_exists('department_department_id', $jsonString)) $jsonString['department_department_id'] = null;
            if(!array_key_exists('department_department', $jsonString)) $jsonString['department_department'] = null;

            if(!array_key_exists('banding_banding_id', $jsonString)) $jsonString['banding_banding_id'] = null;
            if(!array_key_exists('banding_banding', $jsonString)) $jsonString['banding_banding'] = null;
            if(!array_key_exists('group_group_id', $jsonString)) $jsonString['group_group_id'] = null;
            if(!array_key_exists('group_code', $jsonString)) $jsonString['group_code'] = null;
            if(!array_key_exists('position_position_id', $jsonString)) $jsonString['position_position_id'] = null;
            if(!array_key_exists('position_position', $jsonString)) $jsonString['position_position'] = null;
            if(!array_key_exists('phone_number', $jsonString)) $jsonString['phone_number'] = null;
            if(!array_key_exists('email', $jsonString)) $jsonString['email'] = null;
            if(!array_key_exists('email_ciputra', $jsonString)) $jsonString['email_ciputra'] = null;
            if(!array_key_exists('employeestatus_employeestatus_id', $jsonString)) $jsonString['employeestatus_employeestatus_id'] = null;
            if(!array_key_exists('employeestatus_employeestatus', $jsonString)) $jsonString['employeestatus_employeestatus'] = null;

            if(!array_key_exists('statusinformation_hire_date', $jsonString)) $jsonString['statusinformation_hire_date'] = null;
            if(!array_key_exists('payroll_group', $jsonString)) $jsonString['payroll_group'] = null;
            if(!array_key_exists('payrollgroup_id', $jsonString)) $jsonString['payrollgroup_id'] = null;
            if(!array_key_exists('ktp_address', $jsonString)) $jsonString['ktp_address'] = null;
            if(!array_key_exists('address', $jsonString)) $jsonString['address'] = null;
            if(!array_key_exists('payroll_currency', $jsonString)) $jsonString['payroll_currency'] = null;
            if(!array_key_exists('payment_method', $jsonString)) $jsonString['payment_method'] = null;
            if(!array_key_exists('bank_rekening', $jsonString)) $jsonString['bank_rekening'] = null;
            if(!array_key_exists('nomor_rekening', $jsonString)) $jsonString['nomor_rekening'] = null;
            if(!array_key_exists('nama_rekening', $jsonString)) $jsonString['nama_rekening'] = null;

            if(!array_key_exists('calendar_company', $jsonString)) $jsonString['calendar_company'] = null;
            if(!array_key_exists('work_shift', $jsonString)) $jsonString['work_shift'] = null;
            if(!array_key_exists('tax_country_code', $jsonString)) $jsonString['tax_country_code'] = null;
            if(!array_key_exists('fingerprintcode', $jsonString)) $jsonString['fingerprintcode'] = null;
            if(!array_key_exists('cost_center_code', $jsonString)) $jsonString['cost_center_code'] = null;
            if(!array_key_exists('no_bpjs_k', $jsonString)) $jsonString['no_bpjs_k'] = null;
            if(!array_key_exists('no_bpjs_kk', $jsonString)) $jsonString['no_bpjs_kk'] = null;
            if(!array_key_exists('no_bpjs_pp', $jsonString)) $jsonString['no_bpjs_pp'] = null;
            if(!array_key_exists('no_manulife_p', $jsonString)) $jsonString['no_manulife_p'] = null;
            if(!array_key_exists('no_asuransi', $jsonString)) $jsonString['no_asuransi'] = null;

            if(!array_key_exists('worklocation_id', $jsonString)) $jsonString['worklocation_id'] = null;
            if(!array_key_exists('worklocation', $jsonString)) $jsonString['worklocation'] = null;
            if(!array_key_exists('worklocation_project_id', $jsonString)) $jsonString['worklocation_project_id'] = null;
            if(!array_key_exists('worklocation_project', $jsonString)) $jsonString['worklocation_project'] = null;
            if(!array_key_exists('worklocation_pt_id', $jsonString)) $jsonString['worklocation_pt_id'] = null;
            if(!array_key_exists('worklocation_pt', $jsonString)) $jsonString['worklocation_pt'] = null;
            if(!array_key_exists('ibu_kandung', $jsonString)) $jsonString['ibu_kandung'] = null;
            if(!array_key_exists('alokasibiaya_alokasibiaya_id', $jsonString)) $jsonString['alokasibiaya_alokasibiaya_id'] = null;
            if(!array_key_exists('code_alokasibiaya', $jsonString)) $jsonString['code_alokasibiaya'] = null;
            if(!array_key_exists('name_alokasibiaya', $jsonString)) $jsonString['name_alokasibiaya'] = null;
            if(!array_key_exists('alokasibiaya_alokasibiaya_id2', $jsonString)) $jsonString['alokasibiaya_alokasibiaya_id2'] = null;
            if(!array_key_exists('code_alokasibiaya2', $jsonString)) $jsonString['code_alokasibiaya2'] = null;
            if(!array_key_exists('name_alokasibiaya2', $jsonString)) $jsonString['name_alokasibiaya2'] = null;
            if(!array_key_exists('alokasibiaya_alokasibiaya_id3', $jsonString)) $jsonString['alokasibiaya_alokasibiaya_id3'] = null;
            if(!array_key_exists('code_alokasibiaya3', $jsonString)) $jsonString['code_alokasibiaya3'] = null;
            if(!array_key_exists('name_alokasibiaya3', $jsonString)) $jsonString['name_alokasibiaya3'] = null;
            if(!array_key_exists('hari_kerja_perminggu', $jsonString)) $jsonString['hari_kerja_perminggu'] = null;
            if(!array_key_exists('statusinformation_id', $jsonString)) $jsonString['statusinformation_id'] = null;
    ...
    public function updateMaster(Box_Models_App_HasilRequestRead $r, Hrd_Models_Transferapi_Transferapimaster $em,$session,$data,$jsonString,$jsonStringResult) {
        ...
        if($data['value'] == 'employee'){
            ...
            $success_changeprofile = null;
            $success_changepayroll = null;
            $temp_result = null;
            $message_change = null;
