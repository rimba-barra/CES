...
class Hrd_Models_App_Box_LeaveProcessor extends Hrd_Models_App_Box_Processor {
    ...
    public function daoProses($dao, $object, $modeCreate) {
        ...
        switch ($modeCreate) {
            ...
            case "generatecutibesar":
                return $this->cutibesarDo($dao, $object, $modeCreate);
                break;
        }
    }
    ...
    public static function validateHakCuti(Hrd_Models_Master_Employee $em, Hrd_Models_Leave_LeaveEntitlement $le) {
        ...
        if ($le->getLeavegroup() == Box_Config::LEAVE_GROUP_BESAR) {
                ...
                /* di comment karena terdapat perubahan peraturan, menjadi cuti besar diberi setiap tahun
    ...
    private function cutibesarDo($dao, $object, $modeCreate) {        
        $daoResult = $dao->generatecutibesar($this->getSession(), $object);
        return $daoResult;
