...
/**
 * Description of KomponenGaji
 *
 * @author TOMMY-MIS
 */
class Hrd_Models_App_Mastertable_KomponenGaji extends Box_Models_App_Masterdata_Masterdata {
    public function getDao() {
        return new Hrd_Models_Payroll_Komponen_Dao();
    }

    public function getTableClass() {
        return new Hrd_Models_Payroll_Komponen_Komponen();
    }
