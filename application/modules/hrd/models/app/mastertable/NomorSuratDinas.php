...
/**
 * Description of NomorSuratDinas
 *
 * @author TOMMY-MIS
 */
class Hrd_Models_App_Mastertable_NomorSuratDinas extends Box_Models_App_Masterdata_Masterdata  {
    public function getDao() {
        return new Hrd_Models_Dinas_NomorSuratDao();
    }
