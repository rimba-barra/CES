 ...
 * @author TOMMY-MIS
 */
class Hrd_Models_App_Mastertable_Projectsh extends Box_Models_App_Masterdata_Masterdata {
    ...
    public function getTableClass() {
        return new Box_Models_Master_Projectsh();
    }
	...
	*/
	 ...
	 protected function getMethod($object) {
        ...
        $data 		= $this->getDao()->getAllProjectsh($project_id, $pt_id);
