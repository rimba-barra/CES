...
//class Hrd_Models_Performancemanagement_Approvalmatrixemployee extends Box_Models_ObjectEmbedData implements Box_Kouti_Remora, Box_Models_Master_InterProjectPt,  Box_Arried{
class Hrd_Models_Performancemanagement_Approvalmatrixemployee extends Box_Models_ObjectEmbedData implements Box_Kouti_Remora, Box_Arried{
    private $nik;
    private $name;
    private $birthPlace;
    ...
    public function setArrayTable($dataArray=NULL) {
        ...
        if(isset ($x['position_description'])){
           $this->setPosition($x['position_description']); 
        }
    ...
    public function setPosition($position_description) {
