...
//class Hrd_Models_Performancemanagement_Monitoringmatrixemployee extends Box_Models_ObjectEmbedData implements Box_Kouti_Remora, Box_Delien_DelimiterCandidate, Box_Arried {
class Hrd_Models_Performancemanagement_Monitoringmatrixemployee extends Box_Models_ObjectEmbedData implements Box_Kouti_Remora, Box_Models_Master_InterProjectPt,  Box_Arried{
    private $nik;
    private $name;
    private $birthPlace;
