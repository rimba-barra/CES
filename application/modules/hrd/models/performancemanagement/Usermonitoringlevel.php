...
class Hrd_Models_Performancemanagement_Usermonitoringlevel extends Box_Models_ObjectEmbedData implements Box_Kouti_Remora, Box_Delien_DelimiterCandidate, Box_Arried {
//class Hrd_Models_Performancemanagement_Usermonitoringlevel extends Box_Models_ObjectEmbedData implements Box_Kouti_Remora{
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->embedPrefix = "usermonitoringlevel_";
        $this->detail = array();
    }
    ...
    public function setArrayTable($dataArray = NULL) {
        ...
        $this->setId(isset($x['access_id']) ? $x['access_id'] : 0);
        $this->project_id 		= isset($project_id) ? $project_id : 0;
        $this->pt_id 			= isset($pt_id) ? $pt_id : 0;
        $this->access_id 		= isset($x['access_id']) ? $x['access_id'] : 0;
        ...
        $this->access_commitee	= isset($x['access_commitee']) ? $x['access_commitee'] : 0;
        unset($x);
    }
    ...
    public function getArrayTable() {
        $x = array(
            ...
            'access_commitee'	=> $this->access_commitee
        );
        return $x;
    }
    ...
    public function getAccess_commitee() {
        return $this->access_commitee;
    }

    public function setAccess_commitee($access_commitee) {
        $this->access_commitee = $access_commitee;
    }
