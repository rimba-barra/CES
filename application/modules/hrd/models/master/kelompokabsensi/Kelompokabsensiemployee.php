...
class Hrd_Models_Master_Kelompokabsensi_Kelompokabsensiemployee extends Box_Models_ObjectEmbedData implements Box_Kouti_Remora, Box_Models_Master_InterProjectPt,  Box_Arried{
    private $nik;
    private $name;
    private $birthPlace;
