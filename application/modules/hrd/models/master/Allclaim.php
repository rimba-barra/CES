...
class Hrd_Models_Master_Allclaim extends Box_Models_ObjectEmbedData implements Box_Kouti_Remora, Box_Arried{
   ...
   private $code_group;
   private $code_ptkp;
   private $code_jenispengobatan;
   private $value_plafon;
   private $year_now;
   private $total_amount_penggantian;
   private $total_saldo;
   ...
   public function setArrayTable($dataArray=NULL) {
      ...
      if(isset ($x['code_group'])){
         $this->setCodeGroup($x['code_group']); 
      }
      if(isset ($x['code_ptkp'])){
         $this->setCodePtkp($x['code_ptkp']); 
      }
      if(isset ($x['code_jenispengobatan'])){
         $this->setCodeJenis($x['code_jenispengobatan']); 
      }
      if(isset ($x['value_plafon'])){
         $this->setValuePlafon($x['value_plafon']); 
      }
      if(isset ($x['year_now'])){
         $this->setYearNow($x['year_now']); 
      }
      if(isset ($x['total_amount_penggantian'])){
         $this->setTotalAmountPenggantian($x['total_amount_penggantian']); 
      }
      if(isset ($x['total_saldo'])){
         $this->setTotalSaldo($x['total_saldo']); 
      }
      ...
      if(isset ($x['sign_saldo'])){
         $this->setSignSaldo($x['sign_saldo']); 
      }
   ...
   public function getArrayTable(){
      ...
      $x = array(
         ...
         "code_group"=>$this->getCodeGroup(),
         "code_ptkp"=>$this->getCodePtkp(),
         "code_jenispengobatan"=>$this->getCodeJenis(),
         "value_plafon"=>$this->getValuePlafon(),
         "year_now"=>$this->getYearNow(),
         "total_amount_penggantian"=>$this->getTotalAmountPenggantian(),
         "total_saldo"=>$this->getTotalSaldo(),
         "jenispengobatan_id"=>$this->getJenisPengobatanId(),
         "year"=>$this->getYear(),
         "sign_saldo"=>$this->getSignSaldo(),
      );
   ...
   public function setCodeGroup($code_group) {
       $this->code_group = $code_group;
   }

   public function getCodePtkp() {
       return $this->code_ptkp;
   }
   public function setCodePtkp($code_ptkp) {
       $this->code_ptkp = $code_ptkp;
   }

   public function getCodeJenis() {
       return $this->code_jenispengobatan;
   }
   public function setCodeJenis($code_jenispengobatan) {
       $this->code_jenispengobatan = $code_jenispengobatan;
   }

   public function getValuePlafon() {
       return $this->value_plafon;
   }
   public function setValuePlafon($value_plafon) {
       $this->value_plafon = $value_plafon;
   }

   public function getYearNow() {
       return $this->year_now;
   }
   public function setYearNow($year_now) {
       $this->year_now = $year_now;
   }

   public function getTotalAmountPenggantian() {
       return $this->total_amount_penggantian;
   }
   public function setTotalAmountPenggantian($total_amount_penggantian) {
       $this->total_amount_penggantian = $total_amount_penggantian;
   }

   public function getTotalSaldo() {
       return $this->total_saldo;
   }
   public function setTotalSaldo($total_saldo) {
   ...
   public function getSignSaldo() {
       return $this->sign_saldo;
   }
   public function setSignSaldo($sign_saldo) {
       $this->sign_saldo = $sign_saldo;
   }
