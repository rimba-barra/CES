...
class Hrd_Models_Masterdisckaryawan extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_masterdisckaryawan';
    }
            ...
            try {
                ...
                switch ($this->setting->_param['mode_read']) {
                    ...
                    case 'approve':
                        ...
                        $this->setting->_iddata = $param['disckaryawan_id'];
                        $this->setting->_param = $param;
                        $result = $this->setting->executeSP();
    ...
    public function validateapproveData($param) {       
        $this->setting->_paramsql = 'validateapprove';
        $this->setting->_iddata = $param['disckaryawan_id'];
        $this->setting->_param = $param;
        $result = $this->setting->executeSP();
