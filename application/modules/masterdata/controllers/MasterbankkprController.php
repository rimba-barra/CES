...
class Masterdata_MasterbankkprController extends Zend_Controller_Action {
    ...
    function readAction() {
        ...
        $model_bankkpr = new Masterdata_Models_Masterbankkpr();
    ...
    function updateAction() {
        ...
        $mode_bankkpr = new Masterdata_Models_Masterbankkpr();
