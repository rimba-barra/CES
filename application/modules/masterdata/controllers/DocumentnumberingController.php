...
class Masterdata_DocumentnumberingController extends Zend_Controller_Action
{
	protected $model;
	...
	function init()
	{
		...
		$this->model = new Masterdata_Models_Documentnumbering();
	}
	...
	function getdocnocounterAction()
	{
		$this->result = $this->model->getdocnoCounter($this->getRequest()->getPost());
		echo Zend_Json::encode($this->result);
		$this->_helper->viewRenderer->setNoRender(true);
	}	
