...
class Master_MastercityController extends ApliMasterController {
    ...
    public function allRead() {
        ...
        $dm->setDataList(new Master_Box_Models_App_DataListCreator('', 'city', array('provinsi','country','citytype'), array("deletedRows")));
