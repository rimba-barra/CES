...
class Master_MasterprovinsiController extends ApliMasterController {
    ...
    public function allRead() {
        ...
        $dm->setDataList(new Master_Box_Models_App_DataListCreator('', 'provinsi', array('country'), array("deletedRows")));
