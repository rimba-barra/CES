...
class Master_MastercountryController extends ApliMasterController {
    ...
    public function allRead() {
        ...
        $dm->setDataList(new Master_Box_Models_App_DataListCreator('', 'country', array(), array("deletedRows")));
