...
class Master_MasterprojectController extends ApliMasterController {
    ...
    public function allRead() {
        ...
        $dm->setDataList(new Master_Box_Models_App_DataListCreator('', 'project', array(), array("deletedRows")));
