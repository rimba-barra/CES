...
class Apli {
    ...
    public static function generateExtJSModelDirect($creator) {
        ...
        $ct = new Master_Box_Models_App_Hermes_DataModel();
        $ct->setDataList(new Master_Box_Models_App_DataListCreator('', $creator, array(), array()));
    ...
    if(!$creator || !$detail) {
        ...
        $ct = new Master_Box_Models_App_Hermes_DataModel();
        $ct->setDataList(new Master_Box_Models_App_DataListCreator('', $creator, $detail, array()));
    ...
    if(!$creator || !$detail || !$sub) {
        ...
        $ct = new Master_Box_Models_App_Hermes_DataModel();
        $ct->setDataList(new Master_Box_Models_App_DataListCreator('', $creator, $detail, $sub));
    ...
    public static function getRequest($params){
        ...
        $cashierReq = new Master_Box_Models_App_HasilRequestRead(array());
    ...
    public function getCustomRead($dao,Master_Box_Models_App_HasilRequestRead $request, $ses, $modeReads) {
