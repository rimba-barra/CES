...
class Master_Box_Delien_DelimiterEnhancer {
    ...
    public function setDelimiterCandidate(Master_Box_Delien_DelimiterCandidate $x) {
    ...
    public function generate() {
        ...
        foreach ($dcA as $k => $v) {
            ...
            if ($v instanceof Master_Box_Arried) {
                $tempAr = $v->getArray();
