...
abstract class Master_Box_Kouti_AbApp {
    ...
    public function setHasil(Master_Box_Kouti_InterHasil $interHasil) {
        $this->hasil = $interHasil;
    }

    public function setSession(Master_Box_Kouti_InterSession $interSession) {
    ...
    protected final function prosesZendSession() {
        ...
        $ourSes = $this->session;
        if ($ourSes instanceof Master_Box_Kouti_InterSession) {
            if ($ses != NULL) {
