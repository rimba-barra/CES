 ...
 * @author MIS
 */
class Master_Box_Models_App_Models_Delete extends Master_Box_Models_App_AbModel {
    private $hasil;
    private $idProperty;
     
    public function __construct($controller, $debug = '') {
        $this->hasil = new Master_Box_Models_App_HasilSaveUpdate();
    ...
    public function execute(Master_Box_Models_App_BlackHole $blackHole){
        $idP = $this->idProperty;
        ...
        $decan = new Master_Box_Models_App_Decan($idAr);
