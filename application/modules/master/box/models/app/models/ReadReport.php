 ...
 * @author MIS
 */
class Master_Box_Models_App_Models_ReadReport extends Master_Box_Models_App_Models_ReadWorms {
    private $addedParams;
    private $ctrl;
    private $xUrl;
    ...
    public function doStandartInit() {
        $appDao = new Master_Box_Models_Master_AppDao();
        $pt = new Master_Box_Models_Master_Pt();
        $project = new Master_Box_Models_Master_Project();
    ...
    /*@added 24 Maret 2014*/
    protected function processParams(Master_Box_Models_Master_Pt $pt,  Master_Box_Models_Master_Project $project){
