 ...
 * @author MIS
 */
abstract class Master_Box_Models_App_Hermes_AbstractController extends Master_Box_Models_App_Controller {
    ...
    protected function selectedRequestor(Master_Box_Kouti_Requestor $requestor) {
    ...
    /* @return Master_Box_Models_App_Hermes_Processor
     * 
     */

    protected function getDefaultProcessor() {
        return new Master_Box_Models_App_Hermes_Processor();
    }

    public function setApp(Master_Box_Models_App_AbModel $app) {
        $this->app = $app;
    }
    ...
    protected function setArrayTable(Master_Box_Kouti_Remora $remora, $data) {
    ...
    protected function fillData($data, & $filledArray, Master_Box_Models_App_Creator $creator, $creatorName, $creatorParams = NULL) {
        if (count($data) > 0) {
