 ...
 * @author TOMMY-MIS
 */
class Master_Models_App_Db extends Zend_Db_Table_Abstract{
    protected $_schema = '';
    private $dbError = null;
    protected $_name = 'th_mysupertable';
    private $preparedSql;

    public function __construct($config = array()) {
        $this->_schema = Master_Models_App_Config::DB_NAME;
    ...
    private function logError(){
        $file = 'master_log.txt';
        $file = APPLICATION_PATH . '/../public/app/master/log/' . $file;
