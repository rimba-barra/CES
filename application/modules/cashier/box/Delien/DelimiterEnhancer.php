...
class Cashier_Box_Delien_DelimiterEnhancer {
    ...
    public function setDelimiterCandidate(Cashier_Box_Delien_DelimiterCandidate $x) {
    ...
    public function generate() {
        ...
        foreach ($dcA as $k => $v) {
            ...
            if ($v instanceof Cashier_Box_Arried) {
                $tempAr = $v->getArray();
