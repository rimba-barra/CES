 ...
 * @author MIS
 */
class Cashier_Box_Models_App_HasilRequestRead extends Cashier_Box_Kouti_Hasil {
    ...
    public function __construct($array) {
        ...
        $this->others = array();
        $this->module = '';
        $this->setForm(array("mode_read" => "", "page" => 1, "limit" => 25, "module" => "", "mode_update" => "", "others" => array()));
    ...
    function getModeUpdate() {
        return $this->modeUpdate;
    }

    function setModeUpdate($modeUpdate) {
    ...
    protected function setFormFromParams() {
        ...
        $form["mode_update"] = $this->modeUpdate;
        $form["page"] = $this->page;
    ...
    protected function setParamsFromForm() {
        ...
        $this->modeUpdate = $form["mode_update"];
        $this->page = $form["page"];
    ...
    public function getXmlValue() {
        ...
        if (!empty($this->others)) {
            ...
            if ($formSearch) {
                ...
                $array = $formSearch;
                $xml = new Cashier_Helpers_Functionmodule;
