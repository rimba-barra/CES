...
class Cashier_Box_Library_Emailkasbank extends Zend_Db_Table_Abstract {
    ...
    public function __construct($mailtype = "voucher") {
        //TLS = tcp://    use port 25
        ...
        } elseif ($mailtype == "cashbank") {
            $this->emailserver = 'smtp.office365.com';
            $this->emailuser = 'laporankasbank@ciputra.com';
            $this->emailuserpassword = '0p#nM1nd#d$akura0707';
        }        
