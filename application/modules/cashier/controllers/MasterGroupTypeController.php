...
class Cashier_MasterGroupTypeController extends ApliCashierController {
    ...
    public function allRead() {
        ...
        $dm->setDataList(new Cashier_Box_Models_App_DataListCreator('', 'multiproject', array('user', 'project'), array("deletedRows")));
