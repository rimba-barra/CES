...
class Cashier_PurchaselettertbController extends Zend_Controller_Action {
    ...
    function readAction() {
        ...
        if ($requestorCode == 'pl__tb') { /* request api from tirta */
            ...
            $model_purchaseletter = new Cashier_Models_Purchaseletter();
    ...
    function updateAction() {
        ...
        $mode_purchaseletter = new Cashier_Models_Purchaseletter();
