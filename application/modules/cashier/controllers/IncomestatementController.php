...
class Cashier_IncomestatementController extends Zend_Controller_Action {
    ...
    function readAction() {
        ...
        $ses->report_path = APPLICATION_PATH . '/../public/app/cahier/report/';
    ...
    function createAction() {
        ...
        $model = new Gl_Models_Incomestatement();
