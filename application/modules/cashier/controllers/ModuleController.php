...
class Cashier_ModuleController extends Zend_Controller_Action {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Module();
        ...
        $post_data['modulename'] = $this->getRequest()->getPost('modulename');
        $post_data['description'] = $this->getRequest()->getPost('description');
        $result = $model->moduleRead($post_data);
    ...
    function createAction() {
        ...
        $model = new Cashier_Models_Module();
        $result = $model->moduleCreate($post_data);
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Module();
        $result = $model->moduleUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Module();
        $result = $model->moduleDelete($post_data);
