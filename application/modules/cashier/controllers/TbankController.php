...
class Cashier_TbankController extends Zend_Controller_Action {
    function init() {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Tbank();
        ...
        $post_data['terbilang'] = '';
        $post_data['sortkasbank_id'] = $this->getRequest()->getPost('sortkasbank_id');
        $post_data['format'] = $this->getRequest()->getPost('format');
       
       

        $result = $model->bankRead($post_data);
        $result['project_name'] = $this->session->getCurrentProjectName();
        $result['pt_name'] = $this->session->getCurrentPtName();
        $result['fullname_user'] = $this->session->getUserFullName();
        $result['userid'] = $this->session->getUserId();
    ...
    function createAction() {
        ...
        $model = new Cashier_Models_Tbank();
        $result = $model->bankCreate($post_data);
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Tbank();
        $result = $model->bankUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Tbank();
        $result = $model->bankDelete($post_data);
    ...
    function coadetailreadAction() {
        $this->getResponse()->setHeader('Content-Type', 'application/json');
        $result = array('data' => array(), 'total' => 0, 'success' => false);
        $model = new Cashier_Models_Tbankcoadetail();
        $post_data['page'] = $this->getRequest()->getPost('page');
        $post_data['start'] = $this->getRequest()->getPost('start');
        $post_data['limit'] = $this->getRequest()->getPost('limit');
        ...
        $post_data['coa'] = $this->getRequest()->getPost('coa');
        $post_data['hideparam'] = $this->getRequest()->getPost('hideparam');
         $post_data['detailrequest'] = $this->getRequest()->getPost('detailrequest');
        ...
        $post_data['description'] = $this->getRequest()->getPost('description');
        $post_data['active'] = $this->getRequest()->getPost('active');
        $result = $model->bankcoadetailRead($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function coadetailcreateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Tbankcoadetail();
        $result = $model->bankcoadetailCreate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function coadetailupdateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Tbankcoadetail();
        $result = $model->bankcoadetailUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function coadetaildeleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Tbankcoadetail();
        $result = $model->bankcoadetailDelete($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
     function vendorreadAction() {
        $this->getResponse()->setHeader('Content-Type', 'application/json');
        $result = array('data' => array(), 'total' => 0, 'success' => false);
        $model = new Cashier_Models_Tbankvendor();
        $post_data['page'] = $this->getRequest()->getPost('page');
        $post_data['start'] = $this->getRequest()->getPost('start');
        $post_data['limit'] = $this->getRequest()->getPost('limit');
    ...
    function outtransbonreadAction() {
        $this->getResponse()->setHeader('Content-Type', 'application/json');
        $result = array('data' => array(), 'total' => 0, 'success' => false);
        $model = new Cashier_Models_Tbankbon();
        $post_data['page'] = $this->getRequest()->getPost('page');
        $post_data['start'] = $this->getRequest()->getPost('start');
        $post_data['limit'] = $this->getRequest()->getPost('limit');
        $post_data['hideparam'] = $this->getRequest()->getPost('hideparam');
