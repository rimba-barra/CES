...
class Cashier_MasterdebitsourceController extends Zend_Controller_Action {

    function init() {
        $this->session = Zend_Controller_Action_HelperBroker::getStaticHelper('session');
        $this->_model = new Cashier_Models_Masterdebitsource();
    }
    ...
    function readAction() {
        ...
        $post_data['debitsource'] = $this->getRequest()->getPost('debitsource');
        ...
        $result = $this->_model->MasterdebitsourceRead($post_data);
    ...
    function createAction() {
        ...
        $result = $this->_model->MasterdebitsourceCreate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function updateAction() {
        ...
        $result = $this->_model->MasterdebitsourceUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $result = $this->_model->MasterdebitsourceDelete($post_data);
