...
class Cashier_MasterMultiProjectController extends ApliCashierController {

    public function init() {
        $this->setDao(new Cashier_Models_Dao_MultiProjectDao());
        $this->setValidator(new Cashier_Models_Validator_MultiProjectValidator());
        $this->setObject(new Cashier_Models_Master_MultiProject());
    ...
    public function allRead() {
        ...
        $dm->setDataList(new Cashier_Box_Models_App_DataListCreator('', 'multiproject', array('user', 'project'), array("deletedRows","detailpt","deletedDetailRows")));
