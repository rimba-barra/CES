...
class Cashier_ReportparamController extends Zend_Controller_Action {
    function init() {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Reportparam();
        ...
        $post_data['reportparam_id'] = $this->getRequest()->getPost('reportparam_id');
    ...
    function createAction() {
        ...
        $model = new Cashier_Models_Reportparam();
        $result = $model->reportparamCreate($post_data);
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Reportparam();
        $result = $model->reportparamUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Reportparam();
        $result = $model->reportparamDelete($post_data);
