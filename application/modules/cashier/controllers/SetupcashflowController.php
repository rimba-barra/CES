...
class Cashier_SetupcashflowController extends Zend_Controller_Action {

    function init() {
        $this->session = Zend_Controller_Action_HelperBroker::getStaticHelper('session');
        $this->_generaldata = new Cashier_Helpers_Defaultdata();
        $this->_modeldata = new Cashier_Models_Setupcashflow();
    }
    ...
    function copyAction() {
        ...
        $result = $this->_modeldata->copyData($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
}
