...
class Cashier_MasterplafonController extends Zend_Controller_Action {
    ...
    function readAction() {
        ...
        $model_plafon = new Cashier_Models_Masterplafon();
    ...
    function updateAction() {
        ...
        $mode_plafon = new Cashier_Models_Masterplafon();
