...
class Cashier_GeneratefileController extends Zend_Controller_Action {
    function init() {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Generatefile();
        ...
        $post_data['generatefile_id'] = $this->getRequest()->getPost('generatefile_id');
        $post_data['generatefile'] = $this->getRequest()->getPost('generatefile');
        $post_data['description'] = $this->getRequest()->getPost('description');       
        $result = $model->generatefileRead($post_data);
    ...
    function createAction() {
        ...
        $model = new Cashier_Models_Generatefile();
        $result = $model->generatefileCreate($post_data);
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Generatefile();
        $result = $model->generatefileUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Generatefile();
        $result = $model->generatefileDelete($post_data);
