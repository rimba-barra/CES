...
class Cashier_GrouptypeController extends Zend_Controller_Action {
    function init() {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Grouptype();
        ...
        $post_data['grouptype_id'] = $this->getRequest()->getPost('grouptype_id');
        $post_data['grouptype'] = $this->getRequest()->getPost('grouptype');
        $post_data['description'] = $this->getRequest()->getPost('description');       
        $result = $model->grouptypeRead($post_data);
    ...
    function createAction() {
        ...
        $model = new Cashier_Models_Grouptype();
        $result = $model->grouptypeCreate($post_data);
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Grouptype();
        $result = $model->grouptypeUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Grouptype();
        $result = $model->grouptypeDelete($post_data);
