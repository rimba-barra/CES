...
class Cashier_MasterprefixController extends ApliCashierController {
    ...
    public function exportAction() {
        ...
        $request = Apli::getRequest($post_data);

        $model = new Cashier_Models_Dao_MasterprefixDao();
        $result = $model->exportdata($request, $session);
