...
class Cashier_MasterbanktypeController extends Zend_Controller_Action {

    function init() {
        $this->session = Zend_Controller_Action_HelperBroker::getStaticHelper('session');
        $this->_model = new Cashier_Models_Masterbanktype();
    }
    ...
    function readAction() {
        ...
        $result = $this->_model->MasterbanktypeRead($post_data);
    ...
    function createAction() {
        ...
        $result = $this->_model->MasterbanktypeCreate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function updateAction() {
        ...
        $result = $this->_model->MasterbanktypeUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $result = $this->_model->MasterbanktypeDelete($post_data);
