...
class Cashier_JenisusahaController extends Zend_Controller_Action {
    function init() {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Jenisusaha();
        ...
        $post_data['jenisusaha'] = $this->getRequest()->getPost('jenisusaha');
        $post_data['description'] = $this->getRequest()->getPost('description');       
        $result = $model->jenisusahaRead($post_data);
    ...
    function createAction() {
        ...
        $model = new Cashier_Models_Jenisusaha();
        $result = $model->jenisusahaCreate($post_data);
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Jenisusaha();
        $result = $model->jenisusahaUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Jenisusaha();
        $result = $model->jenisusahaDelete($post_data);
