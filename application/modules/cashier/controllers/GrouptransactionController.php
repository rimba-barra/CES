...
class Cashier_GrouptransactionController extends Zend_Controller_Action {
    function init() {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Grouptransaction();
        ...
        $post_data['is_default'] = $this->getRequest()->getPost('is_default');
        $post_data['active'] = $this->getRequest()->getPost('active');

        $result = $model->grouptransactionRead($post_data);
    ...
    function createAction() {
        ...
        $model = new Cashier_Models_Grouptransaction();
        $result = $model->grouptransactionCreate($post_data);
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Grouptransaction();
        $result = $model->grouptransactionUpdate($post_data);
         echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Grouptransaction();
        $result = $model->grouptransactionDelete($post_data);
