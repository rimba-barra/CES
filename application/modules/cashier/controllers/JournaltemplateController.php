...
class Cashier_JournaltemplateController extends Zend_Controller_Action {
    function init() {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Journaltemplate();
        ...
        $result = $model->journaltemplateRead($post_data);
    ...
    function createAction() {
        ...
        $model = new Cashier_Models_Journaltemplate();
        $result = $model->journaltemplateCreate($post_data);
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Journaltemplate();
        $result = $model->journaltemplateUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Journaltemplate();
        $result = $model->journaltemplateDelete($post_data);
