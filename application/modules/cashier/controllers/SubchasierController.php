...
class Cashier_SubchasierController extends Zend_Controller_Action {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Subchasier();
        ...
        $result = $model->subchasierRead($post_data);
    ...
    function createAction() {
        ...
        $model = new Cashier_Models_Subchasier();
        $result = $model->subchasierCreate($post_data);
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Subchasier();
        $result = $model->subchasierUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Subchasier();
        $result = $model->subchasierDelete($post_data);
