...
class Cashier_RcashController extends Zend_Controller_Action {
    function init() {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Rcash();
        ...
        $result = $model->RcashRead($post_data);
    ...
    function createAction() {
        ...
        $model = new Cashier_Models_Rcash();
        $result = $model->RcashCreate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Rcash();
        $result = $model->RcashUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Cashier_Models_Rcash();
        $result = $model->RcashDelete($post_data);
        echo Zend_Json::encode($result);
