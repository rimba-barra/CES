...
class Cashier_RcashadvanceController extends Zend_Controller_Action {
    function init() {
    ...
    function readAction() {
        ...
        $model = new Cashier_Models_Rcashadvance();
        ...
        $post_data['status'] = $this->getRequest()->getPost('statuscia');
