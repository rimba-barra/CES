 ...
 * @author MIS
 */
class Cashier_Models_Transaction_Voucherardetail extends Cashier_Box_Models_ObjectEmbedData implements Cashier_Box_Kouti_Remora, Cashier_Box_Models_Master_InterProjectPt, Cashier_Box_Delien_DelimiterCandidate {
...
//    }''
    ...
    function setOppaid($oppaid) {
        ...
        if (isset($x['paymenttype_id'])) {
            $this->setPaymentType($x['paymenttype_id']);
        }
        if (isset($x['oppaid'])) {
            $this->setOppaid($x['oppaid']);
        }
    ...
    public function getArrayTable() {
        $x = array(
            ...
            'final' => $this->getFinal(),
            'noAR' => $this->getNoAR(),
            'oppaid' => $this->getOppaid(),
            'paymenttype_id' => $this->getPaymentType(),
