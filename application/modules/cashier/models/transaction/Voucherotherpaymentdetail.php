 ...
 * @author MIS
 */
class Cashier_Models_Transaction_Voucherotherpaymentdetail extends Cashier_Box_Models_ObjectEmbedData implements Cashier_Box_Kouti_Remora, Cashier_Box_Models_Master_InterProjectPt, Cashier_Box_Delien_DelimiterCandidate {
    ...
    public function getArrayTable() {
        $x = array(
            ...
            'paymenttype_paymenttype_id' => $this->getPaymentType()->getId(),
