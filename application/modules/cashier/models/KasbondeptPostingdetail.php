...
class Cashier_Models_KasbondeptPostingdetail extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_td_kasbondeptpostingdetail';
    }

    function KasbondeptPostingdetailRead($param) {
    ...
    public function KasbondeptPostingdetailCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    public function KasbondeptPostingdetailUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    function KasbondeptPostingdetailDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
