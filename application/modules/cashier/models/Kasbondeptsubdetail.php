...
class Cashier_Models_Kasbondeptsubdetail extends Zend_Db_Table_Abstract {
    ...
    function KasbondeptsubdetailRead($param) {
    ...
    public function KasbondeptsubdetailCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    public function KasbondeptsubdetailUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    function KasbondeptsubdetailDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
