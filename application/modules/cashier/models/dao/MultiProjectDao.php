 ...
 * @author MIS
 */
class Cashier_Models_Dao_MultiProjectDao extends Cashier_Box_Models_App_AbDaoCashier implements Cashier_Box_Models_App_BlackHole {
    ...
    public function check_pt($multiproject_id, $pt_id)
    {
        $hasil = $this->dbTable->SPExecute('sp_get_selected_detail_pt', $multiproject_id, $pt_id);
        return $hasil;
    }
