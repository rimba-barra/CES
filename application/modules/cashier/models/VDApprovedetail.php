...
class Cashier_Models_VDApprovedetail extends Zend_Db_Table_Abstract {
    ...
    function VDApprovedetailRead($param) {
    ...
    public function VDApprovedetailCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    public function VDApprovedetailUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    function VDApprovedetailDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
