...
class Cashier_Models_VDPostingdesc extends Zend_Db_Table_Abstract {
    ...
    function VDPostingdescRead($param) {
    ...
    public function VDPostingdescCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    public function VDPostingdescUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    function VDPostingdescDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
