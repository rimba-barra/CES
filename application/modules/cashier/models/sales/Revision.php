 ...
 * @author tommytoban
 */
class Cashier_Models_Sales_Revision extends Cashier_Box_Models_ObjectEmbedData implements Cashier_Box_Kouti_Remora {
    ...
    public function __construct($embedPrefix=NULL) {
        ...
        $this->approve = new Cashier_Models_Master_Approve();
        $this->approveReal = new Cashier_Models_Master_Approve();
        $this->approveColl = new Cashier_Models_Master_Approve();
        $this->approveManager = new Cashier_Models_Master_Approve();
        $this->reject = new Cashier_Models_Master_Reject();
        $this->type = new Cashier_Models_Master_RevisionType();
        $this->purchasletter = new Cashier_Models_Purchaseletter_PurchaseLetter();
    ...
    public function setType(Cashier_Models_Master_RevisionType $type) {
        $this->type = $type;
    }
    ...
    public function setApprove(Cashier_Models_Master_Approve $approve) {
    ...
    public function setReject(Cashier_Models_Master_Reject $reject) {
        $this->reject = $reject;
    }
    ...
    function setApproveReal(Cashier_Models_Master_Approve $approveReal) {
    ...
    function setApproveColl(Cashier_Models_Master_Approve $approveColl) {
    ...
    function setApproveManager(Cashier_Models_Master_Approve $approveManager) {
