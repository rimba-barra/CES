 ...
 * @author tommytoban
 */
abstract class Cashier_Models_Sales_Change extends Cashier_Box_Models_ObjectEmbedData{
    protected $note;
    protected $date;
    ...
    public function __construct() {
        ...
        $this->revision = new Cashier_Models_Sales_Revision();
    }
    ...
    public function setReason(Cashier_Models_Sales_Reason $reason) {
        $this->reason = $reason;
    }
    ...
    public function setRevision(Cashier_Models_Sales_Revision $revision) {
