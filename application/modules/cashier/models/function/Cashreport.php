...
class Cashier_Models_Function_Cashreport extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->_tmp_report = 'tmp_rpt_cashreport';
    ...
    function getgrandtotalprojectptkasbank($sp, $project_id, $pt_id) {
        $this->setting->_storeprocedure = $sp;
        $this->setting->_project_id = $project_id;
        $this->setting->_pt_id = $pt_id;
