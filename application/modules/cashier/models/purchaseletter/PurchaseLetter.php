 ...
 * @author MIS
 */
class Cashier_Models_Purchaseletter_PurchaseLetter extends Cashier_Box_Models_ObjectEmbedData implements Cashier_Box_Kouti_Remora{
    ...
    public function __construct($embedPrefix=NULL) {
     ...
     //   $this->embedPrefix = 'purchaseletter_';
        ...
        $this->unit = new Cashier_Models_Unit_UnitTran();
    ...
    public function setUnit(Cashier_Models_Unit_UnitTran $unit) {
        $this->unit = $unit;
    }
    ...
    public function setCustomer(Cashier_Models_Master_CustomerProfile $customer) {
