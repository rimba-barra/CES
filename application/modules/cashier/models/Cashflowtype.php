...
class Cashier_Models_Cashflowtype extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_cashflowtype';
    }
    ...
    function RoutesAllActions($param) {
        ...
        if (is_array($param) && count($param)) {
            try {
                ...
                if (isset($param['cashflowtype_id'])) {
                    if ($param['cashflowtype_id'] > 0) {
                        $this->setting->_iddata = $param['cashflowtype_id'];
