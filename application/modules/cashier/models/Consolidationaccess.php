...
class Cashier_Models_Consolidationaccess extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_consolidationaccess';
    }
    ...
    function RoutesAllActions($param) {
        ...
        if (is_array($param) && count($param)) {
            try {
                ...
                if (isset($param['consolidation_access_id'])) {
                    if ($param['consolidation_access_id'] > 0) {
                        $this->setting->_iddata = $param['consolidation_access_id'];
    ...
    function deleteData($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            $key_name = 'consolidation_access_id';
