...
class Cashier_Models_Masterbanktype extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_m_banktype';
    }

    public function MasterbanktypeRead($param) {
    ...
    public function MasterbanktypeCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
    ...
    public function MasterbanktypeUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
                $this->setting->_paramsql = 'update';
                $this->setting->_iddata = $param['banktype_id'];
    ...
    public function MasterbanktypeDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            $key_name = 'banktype_id';
