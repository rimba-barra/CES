...
class Cashier_Models_VDPostingsubdetail extends Zend_Db_Table_Abstract {
    ...
    function VDPostingsubdetailRead($param) {
    ...
    public function VDPostingsubdetailCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    public function VDPostingsubdetailUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    function VDPostingsubdetailDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
