...
class Cashier_Models_Popupduedatecashadvance extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_popupcashadvance';
        $this->getglobalparam();
    }

    public function getglobalparam() {
        $this->setting->_tabledata = $this->setting->_m_globalparam;
        $param = array('name' => 'cashadvance_reminder_max_duedate_days', 'deleted' => 0);
