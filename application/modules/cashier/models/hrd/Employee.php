 ...
 * @author MIS
 */
class Cashier_Models_Hrd_Employee extends Cashier_Box_Models_ObjectEmbedData implements Cashier_Box_Kouti_Remora {
    private $nik;
    private $name;
    private $pt;
    private $project;
    ...
    public function __construct($params=NULL) {
        ...
        $this->jabatan = new Cashier_Models_Hrd_Jabatan();
