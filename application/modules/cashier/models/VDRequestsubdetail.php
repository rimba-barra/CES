...
class Cashier_Models_VDRequestsubdetail extends Zend_Db_Table_Abstract {
    ...
    function VDRequestsubdetailRead($param) {
    ...
    public function VDRequestsubdetailCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    public function VDRequestsubdetailUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    function VDRequestsubdetailDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
