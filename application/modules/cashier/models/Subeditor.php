...
class Cashier_Models_Subeditor extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_subeditor';
    }

    public function SubeditorRead($param) {
    ...
    public function SubeditorCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
    ...
    public function SubeditorUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
                $this->setting->_paramsql = 'update';
                $this->setting->_iddata = $param['journalsubdetail_id'];
                // echo "<pre>";
                // print_r($param);
                // echo $this->setting->_iddata;
    ...
    public function SubeditorDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
