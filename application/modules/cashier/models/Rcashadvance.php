...
class Cashier_Models_Rcashadvance extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_th_kasbon_rev';
    }
            ...
            try {
                ...
                switch ($this->setting->_param['hideparam']) {
                    case 'default':
                        ...
                        break;
                    case 'updaterevision':   
                        $this->setting->_paramsql = 'updaterevision';
                        $this->setting->_iddata = $param['kasbonrevision_id'];
                        $result = $this->setting->executeSP();
                        $valid = $result[1][0]['VALIDDATA'];
                        $counter = $result[2][0]['RECORD_TOTAL'];
                        $message = $result[3][0]['MSG'];
