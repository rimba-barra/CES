...
class Cashier_Models_VDRequestdesc extends Zend_Db_Table_Abstract {
    ...
    function VDRequestdescRead($param) {
    ...
    public function VDRequestdescCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    public function VDRequestdescUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    function VDRequestdescDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
