...
class Cashier_Models_Prosesposting_Incomestatement extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->_report = new Cashier_Models_Prosesposting_Reportdata();
        $this->_lr = new Cashier_Models_Prosesposting_Createlr();
