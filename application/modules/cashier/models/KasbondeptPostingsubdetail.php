...
class Cashier_Models_KasbondeptPostingsubdetail extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_td_kasbondeptpostingsubdetail';
    }

    function KasbondeptPostingsubdetailRead($param) {
    ...
    public function KasbondeptPostingsubdetailCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    public function KasbondeptPostingsubdetailUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
                $this->setting->_paramsql = 'update';               
                $this->setting->_iddata = $param['kasbondeptsubdetail_id'];
                switch ($this->setting->_param['hideparam']) {
    ...
    function KasbondeptPostingsubdetailDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            $key_name = 'kasbondeptsubdetail_id';
