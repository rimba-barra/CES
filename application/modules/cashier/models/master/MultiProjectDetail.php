 ...
 * @author MIS
 */
class Cashier_Models_Master_MultiProjectDetail extends Cashier_Box_Models_ObjectEmbedData implements Cashier_Box_Kouti_Remora,  Cashier_Box_Models_Master_InterProjectPt,Cashier_Box_Delien_DelimiterCandidate {
    ...
    private $isused;
    private $type;
    private $consolidationdetail_id;
    private $deleted;
    private $percentage;
    private $code;
    ...
    public function setArrayTable($dataArray = NULL) {
        ...
        if(isset ($x['consolidationdetail_id'])){
           $this->setConsolidationdetailId($x['consolidationdetail_id']); 
        }
        if(isset ($x['deleted'])){
    ...
    public function getArrayTable() {
        ...
        $x = array(
            ...
            "type"=>$this->getType(),
            "consolidationdetail_id"=>$this->getConsolidationdetailId(),
     ...
     * @return mixed
     */
    public function getConsolidationdetailId()
    {
        return $this->consolidationdetail_id;
    }

    public function setConsolidationdetailId($consolidationdetail_id)
    {
        $this->consolidationdetail_id = $consolidationdetail_id;
