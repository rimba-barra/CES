 ...
 * @author MIS
 */
class Cashier_Models_Master_Purpose extends Cashier_Box_Models_ObjectEmbedData implements Cashier_Box_Kouti_Remora,Cashier_Box_Models_Master_InterProjectPt {
    private $code;
    private $name;
    private $description;
    private $project;
