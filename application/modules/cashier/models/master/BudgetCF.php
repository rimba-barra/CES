 ...
 * @author MIS
 */
class Cashier_Models_Master_BudgetCF extends Cashier_Box_Models_ObjectEmbedData implements Cashier_Box_Kouti_Remora,  Cashier_Box_Models_Master_InterProjectPt,Cashier_Box_Delien_DelimiterCandidate {
    

    private $coaId;
    private $setupcasflowId;
  ...
  //    }
    ...
    function setcoa_name($coa_name) {
        $this->coa_name = $coa_name;
    }

    function getSetupcashflowId() {
        return $this->setupcasflowId;
    }
    ...
    function setSetupcashflowId($setupcasflowId) {
        $this->setupcasflowId = $setupcasflowId;
    }
    function setDepartmentId($departmentId) {
        $this->departmentId = $departmentId;
    }
    function setCashflowtypeId($cashflowtypeId) {
    ...
    public function setArrayTable($dataArray = NULL) {
        ...
        if(isset ($x['coa_name'])){
           $this->setcoa_name($x['coa_name']); 
        }
        if(isset ($x['setupcashflow_id'])){
           $this->setSetupcashflowId($x['setupcashflow_id']); 
        }
    ...
    public function getArrayTable() {
        ...
        $x = array(
            ...
            "coa_name"         => $this->getcoa_name(),
            "setupcashflow_id" => $this->getSetupcashflowId(),
