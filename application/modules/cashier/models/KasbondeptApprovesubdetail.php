...
class Cashier_Models_KasbondeptApprovesubdetail extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->setting->_storeprocedure = 'sp_td_kasbondeptsubdetail';
    }

    function KasbondeptApprovesubdetailRead($param) {
    ...
    public function KasbondeptApprovesubdetailCreate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    public function KasbondeptApprovesubdetailUpdate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $this->setting->_param = $param;
    ...
    function KasbondeptApprovesubdetailDelete($param = array()) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
