...
class Gl_SetlapneracaController extends Zend_Controller_Action {
    ...
    function readAction() {
        ...
        $model = new Gl_Models_Setlapneraca();
        $result = $model->setlapneracaRead($post_data);
    ...
    function createAction() {
        ...
        $model = new Gl_Models_Setlapneraca();
        $result = $model->setlapneracaCreate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function updateAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Gl_Models_Setlapneraca();
        $result = $model->setlapneracaUpdate($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
    ...
    function deleteAction() {
        ...
        $post_data = Zend_Json::decode($this->getRequest()->getPost('data'));
        $model = new Gl_Models_Setlapneraca();
        $result = $model->setlapneracaDelete($post_data);
        echo Zend_Json::encode($result);
        $this->_helper->viewRenderer->setNoRender(true);
    }
