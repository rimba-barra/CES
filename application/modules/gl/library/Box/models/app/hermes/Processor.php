 ...
 * @author MIS
 */
class Gl_Box_Models_App_Hermes_Processor {
    ...
    public function doRead(Gl_Box_Models_App_Hermes_AbstractController $controller) {
        $app = new Gl_Box_Models_App_Models_ReadWorms($controller, $this->getSampleData());
    ...
    /*added 6 Mei 2014 */
    public function doDelete(Gl_Box_Models_App_Hermes_AbstractController $controller){
        $dataModel = NULL;
        ...
        $app = new Gl_Box_Models_App_Models_Delete($controller);
