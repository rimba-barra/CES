 ...
 * @author MIS
 */
class Gl_Box_Models_App_Models_ReadReport extends Gl_Box_Models_App_Models_ReadWorms {
    private $addedParams;
    private $ctrl;
    private $xUrl;
    ...
    public function doStandartInit() {
        $appDao = new Gl_Box_Models_Master_AppDao();
        $pt = new Gl_Box_Models_Master_Pt();
        $project = new Gl_Box_Models_Master_Project();
    ...
    /*@added 24 Maret 2014*/
    protected function processParams(Gl_Box_Models_Master_Pt $pt,  Gl_Box_Models_Master_Project $project){
