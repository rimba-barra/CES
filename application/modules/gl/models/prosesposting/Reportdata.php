...
class Gl_Models_Prosesposting_Reportdata extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->_query = new Gl_Models_Prosesposting_Qdata();
    }
        ...
        if (!empty($resultcalculate)) {
            foreach ($resultcalculate as $rowcalculate) {
                ...
                $recordcalculate = array(
                    "calculate_lastmonth" => $c_last+0,
                    "calculate_thismonth" => $c_this+0,
                    "calculate_budget" => $c_budget+0,
                    "calculate_lastyear" => $c_year+0
                );
    ...
    public function set_total() {
        ...
        foreach ($resultcoa as $row) {
            ...
            if (!empty($resultamount[0])) {
                ...
                $record = array(
                    "calculate_lastmonth" => $total_last+0,
                    "calculate_thismonth" => $total_this+0,
                    "calculate_budget" => $total_budget+0,
                    "calculate_lastyear" => $total_year+0
                );
    ...
    function set_grand() {
        ...
        $recordgross = array(
            "calculate_lastmonth" => $gross_grand_lastmonth+0,
            "calculate_thismonth" => $gross_grand_thismont+0,
            "calculate_budget" => $gross_grand_budget+0,
            "calculate_lastyear" => $gross_grand_lastyear+0
        );
        ...
        $recordoperatingincome = array(
            "calculate_lastmonth" => ($gross_grand_lastmonth) - ($operating_grand_lastmonth)+0,
            "calculate_thismonth" => ($gross_grand_thismont) - ($operating_grand_thismont)+0,
            "calculate_budget" => ($gross_grand_budget) - ($operating_grand_budget)+0,
            "calculate_lastyear" => ($gross_grand_lastyear) - ($operating_grand_lastyear)+0
        );
        ...
        $recordearing = array(
            "calculate_lastmonth" => ($gross_grand_lastmonth) - ($operating_grand_lastmonth) + ($other_grand_lastmonth)+0,
            "calculate_thismonth" => ($gross_grand_thismont) - ($operating_grand_thismont) + ($other_grand_thismont)+0,
            "calculate_budget" => ($gross_grand_budget) - ($operating_grand_budget) + ($other_grand_budget)+0,
            "calculate_lastyear" => ($gross_grand_lastyear) - ($operating_grand_lastyear) + ($other_grand_lastyear)+0
        );
        ...
        $recordnet = array(
            "calculate_lastmonth" => ($gross_grand_lastmonth) - ($operating_grand_lastmonth) + ($other_grand_lastmonth) - ($tax_grand_lastmonth) + ($compre_grand_lastmonth)+0,
            "calculate_thismonth" => ($gross_grand_thismont) - ($operating_grand_thismont) + ($other_grand_thismont) - ($tax_grand_thismont) + ($compre_grand_thismont)+0,
            "calculate_budget" => ($gross_grand_budget) - ($operating_grand_budget) + ($other_grand_budget) - ($tax_grand_budget) + ($compre_grand_budget)+0,
            "calculate_lastyear" => ($gross_grand_lastyear) - ($operating_grand_lastyear) + ($other_grand_lastyear) - ($tax_grand_lastyear) + ($compre_grand_lastyear)+0
        );
