...
class Gl_Models_Incomestatementkp extends Zend_Db_Table_Abstract {
    ...
    function genReportexcelthismonth($param) {
       ...
       /* $sql = '';
        ...
        $sql = 'exec gl_2018.dbo.sp_reportincomestatement_kp '.$param['pt_id'].','.$param['monthdata'].','.$param['yeardata'].','.$param['level'].','.$param['project_id'];
        $sheet = 0 ; 
        ...
        */
        ...
        //show selected data
        $sql = str_replace('*', 'coa, name, calculate_thismonth',$sql);
        $sql = 'exec gl_2018.dbo.sp_reportincomestatement_kp '.$param['pt_id'].','.$param['monthdata'].','.$param['yeardata'].','.$param['level'].','.$param['project_id'].','.$param['is_zerovalue'];
        $sheet = 0 ; 
        ...
        $col = array('description','end_balance_lastmonth', 'end_balance');
        $titles = array('DESCRIPTION', 'CURRENT MONTH', 'YEAR TO DATE');  
    ...
    /*function genReportexcel($param, $sql, $sheet, $additional) {
        ...
        $filename = "report_income_statement_kp.xls";
    ...
    function genReportexcel($param, $sql, $sheet, $additional, $col, $titles) {
        ...
        $doc->getActiveSheet()->getStyle("A5:C5")->applyFromArray($titleArraystyle);
        $doc->getActiveSheet()->getStyle('B6:C'.$lastrecord)->getNumberFormat()->setFormatCode('#,##0.00');
       ...
       // $doc->getActiveSheet()->removeColumn('G');
