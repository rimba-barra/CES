 ...
 * @author MIS
 */
class Gl_Models_App_Box_GlReadWorms extends Gl_Box_Models_App_Models_ReadWorms {
    ...
    public function prosesObjects($name, $dataDao) {
        ...
        foreach ($dataDao as $object) {
            ...
            if (is_array($object)) {
                if (count($object) > 0) {
                    if (key_exists(0, $object) &&  $object[0] instanceof Gl_Box_Models_ObjectEmbedData) {
