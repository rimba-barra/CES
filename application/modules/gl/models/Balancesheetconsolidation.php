...
class Gl_Models_Balancesheetconsolidation extends Zend_Db_Table_Abstract {
    ...
    function genReportexcelthismonth($param) {
        ...
        $sql = 'exec gl_'.$param['yeardata'].'.dbo.sp_reportbalancesheet_kp '.$param['pt_id'].','.$param['monthdata'].','.$param['yeardata'].','.$param['level'];
        $sheet = 0 ; 
