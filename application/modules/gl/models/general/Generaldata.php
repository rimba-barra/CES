...
class Gl_Models_General_Generaldata extends Zend_Db_Table_Abstract {
    ...
    function init() {
        ...
        $this->_function = new Gl_Models_General_Functionmodule;
        $this->setting = new Gl_Models_General_Setdata;
