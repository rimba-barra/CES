...
class Gl_Models_Incomestatement extends Zend_Db_Table_Abstract {
    function init() {
        date_default_timezone_set('Asia/Jakarta');    
        ...
        $this->_query = new Gl_Models_Query_Incomestatement();
    }
...
//                }
    ...
    function set_grand(){
        ...
        $gross_grand_lastmonth = $resultgross['grand_lastmonth']+0;
        $gross_grand_thismont = $resultgross['grand_thismonth']+0;
        $gross_grand_budget = $resultgross['grand_budget']+0;
        $gross_grand_lastyear = $resultgross['grand_lastyear']+0;
