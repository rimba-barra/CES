 ...
 * @author MIS
 */
class Erems_Models_App_Box_FormorderijbProcessor extends Erems_Models_App_Box_Processor {
    ...
    public function daoUpdate($dao, $object) {
        ...
        $decan = new Erems_Box_Models_App_Decan(explode(",", $data["formorderijb_id"]));
