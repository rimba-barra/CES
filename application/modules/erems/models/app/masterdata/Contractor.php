 ...
 * @author tommytoban
 */
class Erems_Models_App_Masterdata_Contractor extends Erems_Box_Models_App_Masterdata_Masterdata {
    ...
    protected function getMethod($object){
       // return $this->getDao()->getContractor();
        return $this->getDao()->getContractorProjectPt($object);
    }
