 ...
 * @author tommytoban
 */
class Erems_Models_App_Masterdata_Department extends Erems_Box_Models_App_Masterdata_Masterdata {
    ...
    protected function getMethod($object){
        return $this->getDao()->getAllDepartmentWOPL($this->requestRead, $this->appSession);
    }
