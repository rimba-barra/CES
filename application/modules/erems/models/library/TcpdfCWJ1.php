...
class Erems_Models_Library_TcpdfCWJ1 implements Erems_Models_Payment_PrintBisaMulti{
...
/// sort hasil print
  ...
  <tr>
    ...
    <td colspan="2" height="23" width="300">' . $dataPayment['customer'] .'</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="12"  width="460" ><font size="9">'. $dataPayment['terbilang']. '</font></td>'
                                    . '</tr>';
