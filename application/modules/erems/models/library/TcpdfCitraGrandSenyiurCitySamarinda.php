...
class Erems_Models_Library_TcpdfCitraGrandSenyiurCitySamarinda {
...
/// sort hasil print
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" height="30" valign="top" align="right">&nbsp;</td>
  </tr>   
  <tr>
    <td width="115" valign>&nbsp;</td>
    <td colspan="2" width="400" height="45">' . $dataPayment['customer'] . '</td>
  </tr>';
