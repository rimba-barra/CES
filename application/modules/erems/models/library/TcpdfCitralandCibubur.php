...
class Erems_Models_Library_TcpdfCitralandCibubur {
...
/// sort hasil print
  ...
  <tr>
    <td width="150">&nbsp;</td>
    <td colspan="2" height="45" width="300">' . $dataPayment['customer'] . '</td>
  </tr>';
                            ...
                            $html .='<tr>'
                                    . '<td width="150">&nbsp;</td>'
                                    . '<td colspan="2" height="40"  width="350">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="150">&nbsp;</td>'
                                    . '<td colspan="2" height="50" width="350">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
