...
class Erems_Models_Library_TcpdfCitraSunSemarang{
...
/// sort hasil print
  ...
  $html .=' <tr>
    <td width="40">&nbsp;</td>
    <td width="380" height="35"><p style="font-size:13px; font-weight:bold">' . $dataPayment['amount'] . '</p></td>
        <td>&nbsp;</td>
  </tr>';
 ...
 */
  ...
  $html .=' <tr>
    <td width="40">&nbsp;</td>
    <td width="380" height="10" style="font-size:13px; font-weight:bold"><br><br>' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
