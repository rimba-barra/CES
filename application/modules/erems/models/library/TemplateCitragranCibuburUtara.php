...
class Erems_Models_Library_TemplateCitragranCibuburUtara {
...
//dari 82
  ...
  <tr>
    <td width="120">&nbsp;</td>
    <td colspan="2" height="65" width="300">' . $dataPayment['customer'] . '<br/>'.$dataPayment['customer_address'].'</td>
  </tr>';
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="65"  width="400">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="48" width="400">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
  ...
  $html .=' <tr>
    <td width="80">&nbsp;</td>
    <td width="290" height="53">' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
  ...
  $html .=' <tr>
    <td width="80">&nbsp;</td>
    <td width="390" height="60" style="font-size: small;"><br/><br/>Catatan : Uang Tanda Jadi / Uang yang sudah dibayarkan tidak dapat<br/> 				
                  dikembalian/hangus oleh sebab apapun juga kecuali penolakan KPR<br/> 				
                  (pot. by adm Rp.10,000,000.)</td>
        <td><br/><br/><br/>'.$dataPayment['user'].'</td>
  </tr>';
                        }
				*/
				if ($this->tipe == 1) {
  $html .=' <tr>
    <td width="80">&nbsp;</td>
    <td width="345" height="60" style="font-size: small;">&nbsp;</td>
        <td><br/><br/><br/>'.$dataPayment['user'].'</td>
  </tr>';
                        }
