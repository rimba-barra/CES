 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCiputraInternational {
    public function getTxt($hasil){
        //$fileName = "test_local.bat";
        $fileName = $hasil["file_name"];
        $penandataTangan  = 'Fellicia Juliani';//$hasil["penandatangan"];
            ...
            $txt .= "echo.>>testfile \n";
            $txt .= "echo.>>testfile \n";
            $txt .= "echo                    " . preg_replace('/[&]/', 'dan', $hasil["customer_name"]) . " >>testfile \n";
            $txt .= "echo.>>testfile \n";
            $txt .= "echo.>>testfile \n";
            $txt .= "echo.>>testfile \n";
            $txt .= "echo.>>testfile \n";
