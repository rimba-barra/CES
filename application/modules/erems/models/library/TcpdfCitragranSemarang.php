...
class Erems_Models_Library_TcpdfCitragranSemarang{
...
/// sort hasil print
  ...
  <tr>
    ...
    <td colspan="2" height="18" width="300">' . $dataPayment['customer'] .'</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="110">&nbsp;</td>'
                                    . '<td colspan="2" height="45" width="400">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
  ...
  $html .=' <tr>
    <td width="40">&nbsp;</td>
    <td width="380" height="30"><br><br>' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
  ...
  $html .=' <tr>
    <td width="60">&nbsp;</td>
    <td width="330" height="70" style="font-size: small;"></td>
		<td><br><br><br> <!--UPITA LUKI WINDIASI--></td>
 ...
 */
  ...
  $html .=' <tr>
    <td width="40">&nbsp;</td>
    <td width="380" height="40"><br><br>' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
  
    $html .=' <tr>
    <td width="60">&nbsp;</td>
    <td width="330" height="40" style="font-size: small;"></td>
  ...
  $html .=' <tr>
    <td width="40">&nbsp;</td>
    <td width="380" height="10"><br><br>' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
