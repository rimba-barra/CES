...
class Erems_Models_Library_TemplateCitralandKendari{
...
/// sort hasil print
  ...
  <tr>
    <td width="120">&nbsp;</td>
    <td colspan="2" height="22" width="300">' . $dataPayment['customer'] .'</td>
  </tr>';
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="23"  width="470">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="40" width="400">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
  ...
  $html .=' <tr>
    <td width="40">&nbsp;</td>
    <td width="330" height="15">' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
  ...
  $html .=' <tr>
    <td width="40">&nbsp;</td>
    <!--<td width="360" height="5" style="font-size: small;"></td>-->
     <!--<td ><u>&nbsp;&nbsp;&nbsp;Finance Controller&nbsp;&nbsp;&nbsp;</u></td>-->
	<td width="250" height="5" style="font-size: small;"></td>
		<td width="300"><u>PT. Ciputra Abdi Persada Dan PT. Graha Pelita Indah</u></td>
  </tr>';
  
    $html .=' <tr>
    <td width="25">&nbsp;</td>
	<!--<td width="280" height="80" style="font-size: small;"></td>-->
    <td width="120" height="80" style="font-size: small;"></td>
 ...
 */
  ...
  <tr>
    ...
    <td colspan="2" height="22" width="300">' . $dataPayment['customer'] .'</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="25"  width="470">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
  ...
  $html .=' <tr>
    ...
    $html .=' <tr>
    <td width="25">&nbsp;</td>
    <!--<td width="280" height="75" style="font-size: small;"></td>-->
	<td width="120" height="75" style="font-size: small;"></td>
  ...
  $html .=' <tr>
    ...
    $html .=' <tr>
    <td width="25">&nbsp;</td>
    <!--<td width="280" height="5" style="font-size: small;"></td>-->
	<td width="120" height="5" style="font-size: small;"></td>
        <td align="right">Arsip</td>
  </tr>';
