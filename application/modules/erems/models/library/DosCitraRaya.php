...
class Erems_Models_Library_DosCitraRaya implements Erems_Models_Payment_PrintBisaMulti{
    public function getOptions() {
        return array(
			  ...
			  array("value"=>8,"text"=>"Template Installment Payment","selected"=>false,"user_id"=>0),
			  array("value"=>9,"text"=>"Template Installment Payment2","selected"=>false,"user_id"=>0),
			  array("value"=>2,"text"=>"Template Others Payment","selected"=>false,"user_id"=>0),
			  array("value"=>3,"text"=>"Template Others Payment 2","selected"=>false,"user_id"=>0),
			  array("value"=>4,"text"=>"Template Others Payment Kasir","selected"=>false,"user_id"=>0)
