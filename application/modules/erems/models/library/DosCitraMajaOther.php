 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitraMajaOther implements Erems_Models_Payment_PrintBisaMulti{
   
    public function getOptions() {
        return array(
			  array("value"=>1,"text"=>"Template Others","selected"=>false,"user_id"=>5843),
        );
    }
	...
	public function getTxt($hasil){
        ...
        $penandataTangan  = $hasil["penandatangan"];
			...
			$txt .= "echo.>>testfile.txt \n";
            $txt .= "echo                     otherpayment " . $hasil["customer_name"] . " >>testfile.txt \n";
			$txt .= "echo.>>testfile.txt \n";
			//$txt .= "echo.>>testfile.txt \n";
