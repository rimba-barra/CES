...
/// sort hasil print
  ...
  <tr>
    ...
    <td colspan="2" height="21" width="300">' . $dataPayment['customer'] .'</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="10"  width="460" ><font size="8">'. $dataPayment['terbilang']. '</font></td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="35" width="400">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
