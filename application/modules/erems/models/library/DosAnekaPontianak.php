 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosAnekaPontianak implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
            array("value"=>1,"text"=>"Template 1 ( Retno )","selected"=>true,"user_id"=>0),
            array("value"=>2,"text"=>"Template 2 ( Romian )","selected"=>false,"user_id"=>0),
			array("value"=>3,"text"=>"Template 3 ( Tine )","selected"=>false,"user_id"=>0),
			 array("value"=>4,"text"=>"Template 4 ( Caroline )","selected"=>false,"user_id"=>0),
              array("value"=>5,"text"=>"Template 5 ( Nora )","selected"=>false,"user_id"=>0),
			  array("value"=>7,"text"=>"Template 6 ( Instalment Felix )","selected"=>false,"user_id"=>0),
			  array("value"=>6,"text"=>"Template Others Payment ( Retno )","selected"=>true,"user_id"=>0)
        );
    }
