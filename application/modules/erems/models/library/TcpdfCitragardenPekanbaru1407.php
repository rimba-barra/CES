...
class Erems_Models_Library_TcpdfCitragardenPekanbaru1407 {
    ...
    public function run(Erems_Box_Models_App_Session $ses, $dataPayments, $sortPaymentIds) {
        ...
        $maxStr = 100; // adobe reader xi
        $maxStr = 100; // adobe reader x
...
/// sort hasil print
            ...
            if (intval($payId) > 0) {
                foreach ($dataPayments as $dataPayment) {
                    if ($dataPayment["id"] == $payId) {
                        ...
                        $noteAr = Erems_Box_Tools::potongKalimat(1110, $dataPayment['note']);
                        $terbilangAr = Erems_Box_Tools::potongKalimat(1110, $dataPayment['terbilang']);
  ...
  <tr>
    <td width="150">&nbsp;</td>
    <td colspan="2" height="65" style="padding-left:10px">' . $dataPayment['customer'] . '</td>
  </tr>';
                        ...
                        for ($i = 0; $i < count($noteAr); $i++) {
                            ...
                            $html .='<tr>'
                                    . '<td width="150">&nbsp;</td>'
                                    . '<td colspan="2" '.$height.'><br>'. $noteAr[$i]. '</td>'
                                    . '</tr>';
                        }
    ...
    <td width="10">&nbsp;</td>
    <td width="390">&nbsp;</td>
        <td height="20" style="line-height:12px"><br><br><br>&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$dataPayment['date'] . '</td>
  </tr>';
  ...
  $html .=' <tr>
    <td width="10">&nbsp;</td>
    <td width="390" height="50" style="line-height:16px">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size:13px">' . $dataPayment['amount'] . '</b></td>
        <td>&nbsp;</td>
  </tr>';
