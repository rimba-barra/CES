 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitragardenCityJakarta implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
		/*
            array("value"=>1,"text"=>"Template 1","selected"=>true,"user_id"=>1878),
            array("value"=>2,"text"=>"Template 2","selected"=>false,"user_id"=>7903),
			array("value"=>3,"text"=>"Template 3","selected"=>false,"user_id"=>114),
			 array("value"=>4,"text"=>"Template 4","selected"=>false,"user_id"=>1),
              array("value"=>5,"text"=>"Template 5","selected"=>false,"user_id"=>5893),
			  array("value"=>6,"text"=>"Template 6","selected"=>false,"user_id"=>9432),
			  */
              array("value"=>7,"text"=>"Template Installment Anggi","selected"=>false,"user_id"=>0),
			  array("value"=>10,"text"=>"Template Installment Nora","selected"=>false,"user_id"=>0),
			  array("value"=>11,"text"=>"Template Installment Regina","selected"=>false,"user_id"=>0),
              array("value"=>13,"text"=>"Template Installment Nia","selected"=>false,"user_id"=>0),
			  array("value"=>8,"text"=>"Template Installment ReginaNew","selected"=>false,"user_id"=>0),
			 // array("value"=>8,"text"=>"Template Yulia","selected"=>false,"user_id"=>0),
			  //array("value"=>9,"text"=>"Template Nia","selected"=>false,"user_id"=>0),
			  array("value"=>14,"text"=>"Template Others Nia","selected"=>false,"user_id"=>0),
			  array("value"=>9,"text"=>"Template Others Nora","selected"=>false,"user_id"=>0),
			  array("value"=>12,"text"=>"Template Others Regina New","selected"=>false,"user_id"=>0)
        );
    }
	...
	public function getTxt9_OLD($hasil){
