...
/**
 * Description of TcpdfBmwCilegonBaru.php
 *
 * @author MIS
 */
require_once dirname(__DIR__) . '../../library/tcpdf/tcpdf.php';

class Erems_Models_Library_TcpdfBmwCilegonBaru {
...
/// sort hasil print
  ...
  <tr>
    <td width="70">&nbsp;</td>
    <td colspan="2" height="40">' . $dataPayment['customer'] . '</td>
  </tr>';
                        ...
                        for ($i = 0; $i < count($noteAr); $i++) {
                            $height = "";
                            if($i==count($noteAr)-1){
                                $height = $i==0?$heightAwalNote:$heightAwalNote-(10*$i);
                                $height = 'height="'.$height.'"';
                            }
                            $html .='<tr>'
                                    . '<td width="70">&nbsp;</td>'
