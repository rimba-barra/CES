...
/**
 * Description of DosCitralakeSuites
 *
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitralakeSuites implements Erems_Models_Payment_PrintBisaMulti{
	...
	public function getTxt40($hasil){
        //$fileName = "test_local.bat";
        $fileName = $hasil["file_name"];
        $penandataTangan  = $hasil["penandatangan"];
	...
	public function getOptions() {
        return array(
            ...
            array("value"=>2,"text"=>"Template 2 ( Nora )","selected"=>false,"user_id"=>0),
			//array("value"=>3,"text"=>"Template 3 ( SettingNew )","selected"=>false,"user_id"=>5893),
			array("value"=>4,"text"=>"Template Installment_Test ( Nora )","selected"=>false,"user_id"=>0),
			array("value"=>5,"text"=>"Template Others_Test ( Nora )","selected"=>false,"user_id"=>0),
        );
    }
