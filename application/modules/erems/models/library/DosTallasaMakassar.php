...
/**
 * Description of Erems_Models_Library_DosTallasaMakassar
 *
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosTallasaMakassar {
    public function getTxt($hasil){
        ...
        $penandataTangan  = $hasil["penandatangan"];
			...
			*/
			...
			// FORMAT WINDOWS 10
			$txt .= "copy testfile \"\\\\localhost\MY EPSON LX-310\" \n"; $previewRemoveTxt1 = "copy testfile \"\\\\localhost\MY EPSON LX-310\" \n";
