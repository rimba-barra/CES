...
/**
 * Description of DosBmwCilegon
 *
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitraNagoyaBatam implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
			...
			array("value"=>6,"text"=>"Template 6 ( Installment Nora SettingNew )","selected"=>false,"user_id"=>0)
        );
    }
    ...
    // $txt .= "echo                                                                    " . Erems_Box_Tools::formatDate($hasil["payment_date"]) . " >>testfile.txt \n";
      ...
      public function getTxt5($hasil){
        ...
        $penandataTangan  = $hasil["penandatangan"];
            ...
            $txt .= "echo              template5     " . $hasil["customer_name"] . " >>testfile.txt \n";
            $txt .= "echo.>>testfile.txt \n";
			$txt .= "echo.>>testfile.txt \n";
