...
/**
 * Description of DosCitraGardenCitySamarinda
 *
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitraGardenCitySamarinda implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
            ...
            array("value"=>2,"text"=>"Template 2 ( Zainal )","selected"=>false,"user_id"=>0),
			array("value"=>3,"text"=>"Template 3 ( Nita )","selected"=>false,"user_id"=>0)
        );
    }
