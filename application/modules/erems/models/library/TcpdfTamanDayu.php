...
class Erems_Models_Library_TcpdfTamanDayu {
...
/// sort hasil print
                ...
                foreach ($dataPayments as $dataPayment) {
                    if ($dataPayment["id"] == $payId) {
                        ...
                        $noteAr = Erems_Box_Tools::potongKalimat(150, $dataPayment['note']);
						 ...
						 $alamatAr = Erems_Box_Tools::potongKalimat(150, $dataPayment['customer_address']);
  ...
  <tr>
    <td width="120">&nbsp;</td>
    <td colspan="2" height="10">' . $dataPayment['customer'] . '</td>
  </tr>';
                      
						$html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="40">'. $dataPayment['customer_address']. '</td>'
                                    . '</tr>';
						$html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="40">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
                        $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="75">'. $dataPayment['note']. '</td>'
                                    . '</tr>';
                        ...
                        $html .='<tr>
    <td width="50">&nbsp;</td>
    <td width="335">' . $dataPayment['amount'] . '</td>
    ...
    <td height="90">&nbsp;</td>
  						...
  						$html .='<tr>
  	<td width="260">&nbsp;</td>
    <td width="180">Ananda Krismawan</td>
        <td height="20">Dwi Handayani</td>
  </tr>';
