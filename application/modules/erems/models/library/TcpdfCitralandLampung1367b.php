...
class Erems_Models_Library_TcpdfCitralandLampung1367b {
	
	//user: GARDIKA CAHYA B
...
/// sort hasil print
  ...
  <tr>
    ...
    <td colspan="2" height="65" width="300">' . $dataPayment['customer'] . '</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="230">&nbsp;</td>'
                                    . '<td colspan="2" height="60"  width="300">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
 ...
 */
  ...
  $html .=' <tr>
    <td width="150">&nbsp;</td>
    <td width="350" height="43">' . $dataPayment['amount'] . '</td>
