...
class Erems_Models_Library_DosCitraLakeSawangan implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
            ...
            array("value"=>2,"text"=>"Template 2 ( Romian )","selected"=>false,"user_id"=>7903),
			array("value"=>3,"text"=>"Template 3 ( Tine )","selected"=>false,"user_id"=>114),
			 array("value"=>4,"text"=>"Template 4 ( Caroline )","selected"=>false,"user_id"=>1),
              array("value"=>5,"text"=>"Template 5 ( Nora )","selected"=>false,"user_id"=>5893),
			  array("value"=>6,"text"=>"Template 6 ( Nia )","selected"=>false,"user_id"=>9432),
			  array("value"=>7,"text"=>"Template 7 ( Regina )","selected"=>false,"user_id"=>13375),
        );
    }
