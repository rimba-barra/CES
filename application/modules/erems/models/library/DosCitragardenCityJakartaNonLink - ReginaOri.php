 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitragardenCityJakartaNonLink implements Erems_Models_Payment_PrintBisaMulti{
   
    public function getOptions() {
        return array(
			  array("value"=>1,"text"=>"Template Regina","selected"=>false,"user_id"=>0),
        );
    }
