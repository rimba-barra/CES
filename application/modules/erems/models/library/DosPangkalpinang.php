 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosPangkalpinang implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
            array("value"=>1,"text"=>"Template 1 ( Febri )","selected"=>true,"user_id"=>1878),
