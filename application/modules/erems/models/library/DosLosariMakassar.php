...
/**
 * Description of DosLosariMakassar
 *
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosLosariMakassar {
    public function getTxt($hasil){
        ...
        $penandataTangan  = $hasil["penandatangan"];
			...
			*/
			...
			// FORMAT WINDOWS 10
			$txt .= "copy testfile \"\\\\localhost\EPSON LX-310 ESCP\" \n"; $previewRemoveTxt1 = "copy testfile \"\\\\localhost\EPSON LX-310 ESCP\" \n";
