...
class Erems_Models_Library_TcpdfCitragardenPekanbaru {
...
/// sort hasil print
  ...
  <tr>
    <td width="150">&nbsp;</td>
    <td colspan="2" height="35" style="padding-left:10px">' . $dataPayment['customer'] . '</td>
  </tr>';
    ...
    <td width="10">&nbsp;</td>
    <td width="390">&nbsp;</td>
        <td height="20" style="line-height:10px"><br><br><br>&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$dataPayment['date'] . '</td>
  </tr>';
  ...
  $html .=' <tr>
    <td width="10">&nbsp;</td>
    <td width="390" height="0" style="line-height:10px">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
