...
class Erems_Models_Library_TcpdfCitraGardenCityMalangOT {
    ...
    public function run(Erems_Box_Models_App_Session $ses, $dataPayments, $sortPaymentIds) {
        ...
        $fileName = 'otherspayment_' . $ses->getProject()->getId() . '_' . $ses->getPt()->getId() . '.pdf';
...
/// sort hasil print
  ...
  <tr>
    <td width="80">&nbsp;</td>
    <td colspan="2" height="65" valign="top" align="right"> <br /><br />Tgl SP : ' . $dataPayment['purchase_date'] . '</td>
  </tr>   
  <tr>
    <td width="250" valign>&nbsp;</td>
    <td colspan="2" height="30">' . $dataPayment['customer'] . '</td>
  </tr>';
                        ...
                        for ($i = 0; $i < count($terbilangAr); $i++) {
                            ...
                            $html .='<tr>'
                                    . '<td width="250">&nbsp;</td>'
                                    . '<td width="340" colspan="2" '.$height.'>'. $terbilangAr[$i]. '</td>'
                                    . '</tr>';
                        }
...
$html .='<tr>
    <td width="195">&nbsp;</td>
    <td width="290">&nbsp;</td>
        <td height="50" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;'.date("d-m-",strtotime($dataPayment['date'])) .'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.date("y",strtotime($dataPayment['date'])) . '</td>
  </tr>';


                        $html .='<tr>
    <td width="200">&nbsp;</td>
    <td width="290">' . $dataPayment['amount'] . '</td>
