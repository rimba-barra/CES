...
class Erems_Models_Library_TcpdfCitraCityBalikpapan {
    ...
    public function run(Erems_Box_Models_App_Session $ses, $dataPayments, $sortPaymentIds) {
        ...
        $maxStr = 90; // adobe reader xi
        $maxStr = 90; // adobe reader x
...
/// sort hasil print
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" height="50" valign="top" align="right">&nbsp;</td>
  </tr>   
  <tr>
    <td width="110" valign>&nbsp;</td>
    <td colspan="2" height="45">' . $dataPayment['customer'] . '</td>
  </tr>';
                        ...
                        for ($i = 0; $i < count($noteAr); $i++) {
                            ...
                            $html .='<tr>'
                                    . '<td width="110">&nbsp;</td>'
                                    . '<td colspan="2" height="45">'. $noteAr[$i]. '</td>'
                                    . '</tr>';
                        }
                        ...
                        $html .='<tr>
    <td width="110">&nbsp;</td>
    <td width="310">' . $dataPayment['amount'] . '</td>
