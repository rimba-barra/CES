...
/// sort hasil print
  ...
  <tr>
    <td width="120" valign>&nbsp;</td>
    <td colspan="2" height="50">AAA' . $dataPayment['customer'] . '</td>
  </tr>';
    ...
    <td width="390">' . $dataPayment['amount'] . '</td>
        <td height="50" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$dataPayment['payment_date_tgl'] .' AAA '.$dataPayment['payment_date_tahun'] . '</td>
  </tr>';
