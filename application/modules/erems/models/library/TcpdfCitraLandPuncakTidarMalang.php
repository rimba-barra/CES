...
class Erems_Models_Library_TcpdfCitraLandPuncakTidarMalang{
...
/// sort hasil print
  ...
  <tr>
    <td width="120">&nbsp;</td>
    <td colspan="2" height="26" width="300">' . $dataPayment['customer'] .'</td>
  </tr>';
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="5"  width="460" ><font size="10">'. $dataPayment['terbilang']. '</font></td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="50" width="420">'. $dataPayment['note'].'  '. $dataPayment['date'].'</td>'
                                   . '</tr>';
    ...
    <td width="40">&nbsp;</td>
    <td width="360">&nbsp;</td>
        <td height="30">&nbsp;&nbsp;'.date("d-m-Y") . '</td>
  </tr>';
                        
  $html .=' <tr>
    <td width="60">&nbsp;</td>
    <td width="380" height="60"><p style="font-size:13px; font-weight:bold">' . $dataPayment['amount'] . '</p></td>
        <td>&nbsp;</td>
  </tr>';
  ...
  $html .=' <tr>
    <td width="60">&nbsp;</td>
    <td width="330" height="85" style="font-size: small;"></td>
		<td><br> '.ucwords(strtoupper($dataPayment['user'])).' </td>
  </tr>';
 ...
 */
  ...
  <tr>
    ...
    <td colspan="2" height="21" width="300">' . $dataPayment['customer'] .'</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="10"  width="460" ><font size="10">'. $dataPayment['terbilang'].'</font></td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="75" width="400">'. $dataPayment['note'].'  '. $dataPayment['date'].'</td>'
                                   . '</tr>';
    ...
    <td width="40">&nbsp;</td>
    <td width="360">&nbsp;</td>
        <td height="5">&nbsp;&nbsp;'.date("d-m-Y") . '</td>
  </tr>';
                        
  $html .=' <tr>
    <td width="60">&nbsp;</td>
    <td width="380" height="35" style="font-size:13px; font-weight:bold"><br><br>' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
  ...
  <tr>
    ...
    <td colspan="2" height="17" width="300">' . $dataPayment['customer'] .'</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="80" width="400">'. $dataPayment['note'].'  '. $dataPayment['date'].'</td>'
                                   . '</tr>';
    ...
    <td width="40">&nbsp;</td>
    <td width="360">&nbsp;</td>
        <td height="25">&nbsp;&nbsp;'.date("d-m-Y"). '</td>
  </tr>';
                        
  $html .=' <tr>
    <td width="60">&nbsp;</td>
    <td width="380" height="" style="font-size:13px; font-weight:bold"><br>' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
