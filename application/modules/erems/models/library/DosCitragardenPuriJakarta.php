 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitragardenPuriJakarta implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
		...
		/*
			...
			array("value"=>3,"text"=>"Template 3","selected"=>false,"user_id"=>114),
			  ...
			  */
			  //array("value"=>10,"text"=>"Template Regina","selected"=>false,"user_id"=>13375),
			  //array("value"=>8,"text"=>"Template Yulia","selected"=>false,"user_id"=>5905),
			  array("value"=>9,"text"=>"Template ReginaNew","selected"=>false,"user_id"=>0),
			  array("value"=>10,"text"=>"Template Regina","selected"=>false,"user_id"=>0),
			  array("value"=>11,"text"=>"Template Nia","selected"=>false,"user_id"=>0),
			  array("value"=>12,"text"=>"Template Others Nia","selected"=>false,"user_id"=>0)
        );
    }
	...
	public function getTxt9($hasil){
        ...
        $penandataTangan  = $hasil["penandatangan"];
            ...
            // $txt .= "echo                    asd" . $hasil["customer_name"] . " >>testfile.txt \n";
            // $txt .= "echo.>>testfile.txt \n";
			//$txt .= "echo.>>testfile.txt \n";
			//$txt .= "echo.>>testfile.txt \n";
