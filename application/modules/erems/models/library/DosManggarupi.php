 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosManggarupi implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
            array("value"=>1,"text"=>"Template 1 ( Lidya )","selected"=>true,"user_id"=>0),
            // array("value"=>2,"text"=>"Template 1 ( Raskita )","selected"=>true,"user_id"=>0)
