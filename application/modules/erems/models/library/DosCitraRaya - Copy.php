 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitraRaya implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
		...
		/*
			...
			array("value"=>3,"text"=>"Template 3","selected"=>false,"user_id"=>114),
			  ...
			  */
			  array("value"=>8,"text"=>"Template Elis Niar","selected"=>false,"user_id"=>5843)
