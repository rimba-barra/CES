...
/**
 * Description of TemplateCitragrandcityPalembang
 *
 * @author MIS
 */
require_once dirname(__DIR__) . '../../library/tcpdf/tcpdf.php';

class Erems_Models_Library_TemplateCitragrandcityPalembang {
...
/// sort hasil print
  ...
  <tr>
    <td width="120">&nbsp;</td>
    <td colspan="2" height="50">[TEST] ' . $dataPayment['customer'] . '</td>
  </tr>';
