...
class Erems_Models_Library_TcpdfCitraGardenCityJakartaNonLink {
...
/// sort hasil print
            ...
            if (intval($payId) > 0) {
                foreach ($dataPayments as $dataPayment) {
                    if ($dataPayment["id"] == $payId) {
                        ...
                        $noteAr = Erems_Box_Tools::potongKalimat(170, $dataPayment['note']);
  ...
  <tr>
    <td width="120">&nbsp;</td>
    <td colspan="2" height="30"><p style="font-family:Calibri">&nbsp;' . $dataPayment['customer'] . '</p></td>
  </tr>';
                        
                        for ($i = 0; $i < count($terbilangAr); $i++) {
                            $height = "";
                            if($i==count($terbilangAr)-1){
                                $height = $i==0?$heightTerbilang:$heightTerbilang-(10*$i);
                                $height = 'height="'.$height.'"';
                            }
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" '.$height.'><p style="font-family:Calibri">&nbsp;'. $terbilangAr[$i]. '</p></td>'
                                    . '</tr>';
                        }
                        for ($i = 0; $i < count($noteAr); $i++) {
                            $height = "";
                            if($i==count($noteAr)-1){
                                $height = $i==0?$heightNote:$heightNote-(10*$i);
                                $height = 'height="'.$height.'"';
                            }
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" '.$height.'><p style="font-family:Calibri">&nbsp;'. $noteAr[$i]. '</p></td>'
                                    . '</tr>';
                        }
                        ...
                        $html .='<tr>
    <td width="30">&nbsp;</td>
    <td width="390"><p style="font-family:Calibri">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $dataPayment['amount'] . '</p></td>
        <td height="20"><p style="font-family:Calibri">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$dataPayment['date'] . '</p></td>
  </tr>';
