 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitraRayaNonLink implements Erems_Models_Payment_PrintBisaMulti{
   
    public function getOptions() {
        return array(
			  array("value"=>1,"text"=>"Template Elis Niar","selected"=>false,"user_id"=>5843),
        );
    }
	...
	public function getTxt($hasil){
        ...
        $penandataTangan  = $hasil["penandatangan"];
			...
			$txt .= "echo.>>testfile.txt \n";
			$txt .= "echo                                                                                                                                         " 
			. substr(Erems_Box_Tools::formatDate($hasil["payment_date"]),0,6) ."     ". substr(Erems_Box_Tools::formatDate($hasil["payment_date"]),8,2) . " >>testfile.txt \n\n";
