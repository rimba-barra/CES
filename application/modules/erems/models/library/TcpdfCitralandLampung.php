...
class Erems_Models_Library_TcpdfCitralandLampung {
...
/// sort hasil print
  ...
  <tr>
    ...
    <td colspan="2" height="55" width="300">' . $dataPayment['customer'] . '</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="150">&nbsp;</td>'
                                    . '<td colspan="2" height="50"  width="320">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="150">&nbsp;</td>'
                                    . '<td colspan="2" height="80" width="320">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
