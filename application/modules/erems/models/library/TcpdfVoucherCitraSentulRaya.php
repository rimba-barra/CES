...
class Erems_Models_Library_TcpdfVoucherCitraSentulRaya {
...
/// sort hasil print
  ...
  <tr>
    <td width="70"></td>
    <td height="110" width="309"></td>
    <td width="25"></td> 
    <td width="185"></td>
  </tr>
  <tr>
    <td>'.$dataPayment["paymentno"].'</td>
  ...
  <tr >
    ...
    <td></td> 
    <td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$dataPayment["cair_date"].'</td>
  </tr>
  <tr>
    <td></td>
  ...
  <tr>
    <td></td>
    <td height="58">'.$dataPayment["pricetype"].'</td>
    <td></td> 
    <td></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td></td>
    <td></td> 
    <td align="right">'.$dataPayment["paymentmethod"].'</td>
  </tr>
</table>';
