 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitragrandcityPalembang implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
            array("value"=>1,"text"=>"Template Installment 1 ( Felix )","selected"=>true,"user_id"=>0),
            array("value"=>2,"text"=>"Template Installment  2 ( Caroline )","selected"=>false,"user_id"=>0),
			// array("value"=>3,"text"=>"Template Others Payment 3 ( New )","selected"=>false,"user_id"=>0),
            array("value"=>4,"text"=>"Template Others Payment Caroline","selected"=>false,"user_id"=>0)
        );
    }
