...
class Erems_Models_Library_TcpdfCitraLandCitySamarinda implements Erems_Models_Payment_PrintBisaMulti{
...
$html .='</table>';
	...
	public function getOptions() {
        return array(
            array("value"=>1,"text"=>"Installment Payment","selected"=>true),
            array("value"=>2,"text"=>"Others Payment","selected"=>false)
        );
    }
...
/// sort hasil print
  ...
  <tr>
    <td width="40">&nbsp;</td>
    <td colspan="2" height="62" width="300">' . $dataPayment['customer'] .'</td>
  </tr>';
                            ...
                            $html .='<tr>'
                                    . '<td width="40">&nbsp;</td>'
                                    . '<td colspan="2" height="60"  width="460">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="40">&nbsp;</td>'
                                    . '<td colspan="2"  height="65" width="460">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
                        

						$html .=' <tr height="5">
    <td width="400">&nbsp;</td>
    <td width="200" >'.$dataPayment['date'] . '</td>
        <td>&nbsp;</td>
  </tr>';
$html .=' <tr>
    <td width="410" align="left"><p style="font-size:13px; font-weight:bold">' . $dataPayment['amount'] . '</p></td>
    <td width="200">&nbsp;</td>
        <td>&nbsp;</td>
  </tr>';
...
$html .='</table>';
	...
	public function runTemplateDua(Erems_Box_Models_App_Session $ses, $dataPayments, $sortPaymentIds) {
        ...
        $maxStr = 75; // adobe reader xi
        $maxStr = 75; // adobe reader x
        $lineHeight = $this->params["ln_lineheight"];
        $jumlahLineSpaceNote = $this->params["ln_note"];
        $jumlahLineSpaceTerbilang = $this->params["ln_terbilang"];
        $faktorSpaceNote = $this->params["ln_note_add"];
...
/// sort hasil print
  ...
  <tr>
    <td width="110">&nbsp;</td>
    <td colspan="2" height="43" width="300">'. $dataPayment['customer'] .'</td>
  </tr>';
                            ...
                            $html .='<tr>'
                                    . '<td width="110">&nbsp;</td>'
                                    . '<td colspan="2" height="20"  width="460" ><p style="font-size:11px;">'. $dataPayment['terbilang']. '</font></td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="110">&nbsp;</td>'
                                    . '<td colspan="2" height="35" width="430">'. $dataPayment['note'].'</td>'
                                   . '</tr>';
...
$html .='</table>';
	...
	public function runTemplateTiga(Erems_Box_Models_App_Session $ses, $dataPayments, $sortPaymentIds) {
        ...
        $maxStr = 65; // adobe reader xi
        $maxStr = 65; // adobe reader x
        $lineHeight = $this->params["ln_lineheight"];
        $jumlahLineSpaceNote = $this->params["ln_note"];
        $jumlahLineSpaceTerbilang = $this->params["ln_terbilang"];
        $faktorSpaceNote = $this->params["ln_note_add"];
