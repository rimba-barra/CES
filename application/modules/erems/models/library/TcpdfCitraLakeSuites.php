...
/**
 * Description of Erems_Models_Library_TcpdfBmwCilegon
 *
 * @author MIS
 */
require_once dirname(__DIR__) . '../../library/tcpdf/tcpdf.php';

class Erems_Models_Library_TcpdfCitraLakeSuites implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
            array("value"=>2,"text"=>"Template Kwitansi","selected"=>false),
            //array("value"=>2,"text"=>"Template 2","selected"=>false),
            array("value"=>1,"text"=>"Template NUP","selected"=>true)
        );
    }
	...
	//	$fontname = TCPDF_FONTS::addTTFfont(APPLICATION_PATH . '/../public/app/erems/fonts/tahoma.ttf', 'TrueTypeUnicode', '', 96);
	  ...
	  $fontname = TCPDF_FONTS::addTTFfont(APPLICATION_PATH . '/../public/app/erems/fonts/CALIBRI.ttf', 'TrueTypeUnicode', '', 96);
  ...
  <tr>
    ...
    <td colspan="2" height="20" width="300">' . $dataPayment['customer'] . '</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="55">&nbsp;</td>'
                                    . '<td colspan="2" height="20"  width="330" style="font-size: small;">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="55">&nbsp;</td>'
                                    . '<td colspan="2" height="40" width="340">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
  ...
  $html .=' <tr>
    <td width="50">&nbsp;</td>
    <td width="390" height="105">' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
  ...
  <tr>
    <td width="55">&nbsp;</td>
    <td colspan="2" height="30" width="300">' . $dataPayment['customer'] . '</td>
  </tr>';
                            ...
                            $html .='<tr>'
                                    . '<td width="55">&nbsp;</td>'
                                    . '<td colspan="2" height="40" width="330">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
  ...
  $html .=' <tr>
    <td width="50">&nbsp;</td>
    <td width="390" height="90">&nbsp;&nbsp;&nbsp;&nbsp;' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
  ...
  $html .=' <tr>
    <td width="50">&nbsp;</td>
    <td width="350" height="0">&nbsp;&nbsp;&nbsp;&nbsp;' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
