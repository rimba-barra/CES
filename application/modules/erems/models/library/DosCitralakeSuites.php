 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitralakeSuites implements Erems_Models_Payment_PrintBisaMulti{
        ...
        return array(
            ...
            array("value"=>3,"text"=>"Template 3 ( Tine )","selected"=>false,"user_id"=>114),
             array("value"=>4,"text"=>"Template 4 ( Caroline )","selected"=>false,"user_id"=>1), */
			  ...
			  array("value"=>6,"text"=>"Template ( Installment Nora )","selected"=>false,"user_id"=>0)
        );
    }
