 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCiputraInternational implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
            array("value"=>1,"text"=>"Template 1 ( Others Payment )","selected"=>true,"user_id"=>1878),
