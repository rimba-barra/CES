 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitraLandAmbonNonLink implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
			  array("value"=>1,"text"=>"Non Link","selected"=>false,"user_id"=>0),
        );
    }
