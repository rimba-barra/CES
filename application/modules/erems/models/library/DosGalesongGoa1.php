 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosGalesongGoa1 implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
            array("value"=>1,"text"=>"Template 1 ( Rastika )","selected"=>true,"user_id"=>1878),
