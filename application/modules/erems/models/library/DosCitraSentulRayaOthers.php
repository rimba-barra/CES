 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitraSentulRayaOthers implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getTxt($hasil){
		...
		//	$txt .= "echo.>>testfile.txt \n";
            ...
            //$txt .= "echo  others " . $hasil["customer_name"] . " >>testfile.txt \n";
			$txt = "echo asdsadsads " . $hasil["customer_name"] . " >>testfile.txt \n";
			
			$txt .= "echo.>>testfile.txt \n";
			$txt .= "echo.>>testfile.txt \n";
	
            foreach ($terbilangAr as $ta) {
                $txt .= "echo " . strtoupper($ta) . " >>testfile.txt \n";
            }
            for ($i = 0; $i < $barisMarginBotTerbilang; $i++) {
                $txt .= "echo.>>testfile.txt \n";
            }
            foreach ($noteAr as $no) {
                $txt .= "echo " . strtoupper(preg_replace('/\s+/', ' ',$no)) . " >>testfile.txt \n";
            }
	...
	// $txt .= "echo                                                           " . Erems_Box_Tools::formatDate($hasil["payment_date"]) . " >>testfile.txt \n";
       ...
       //     $txt .= "echo " . Erems_Box_Tools::toCurrency($hasil["total_payment"]) . "                                              >>testfile.txt \n";
          ...
          //  $txt .= "echo              " . Erems_Box_Tools::toCurrency($hasil["total_payment"]) . " >>testfile.txt \n";
           ...
           // $txt .= "copy testfile.txt \"\\\\::1\\epsonkwitansi\" \n"; $previewRemoveTxt1 = "copy testfile.txt \"\\\\::1\\epsonkwitansi\" \n";
			
			
			
			
			// FORMAT WINDOWS 10
			//$txt .= "copy testfile.txt \"\\\\localhost\epsonkwitansi\" \n"; $previewRemoveTxt1 = "copy testfile.txt \"\\\\localhost\epsonkwitansi\" \n";
			  $txt .= "Notepad /p \"testfile.txt\" \n"; $previewRemoveTxt1 = "Notepad /p \"testfile.txt\" \n";
            
            $txt .= "del testfile.txt \n "; $previewRemoveTxt3 = "del testfile.txt \n";
			$txt .= "del ".$fileName; $previewRemoveTxt3 = "del ".$fileName;
    ...
    public function getOptions() {
        return array(
            array("value"=>1,"text"=>"Template 1 ( Uti )","selected"=>true,"user_id"=>1)
        ...
        $penandataTangan  = $hasil["penandatangan"];
          ...
          //  $txt .= "echo              " . Erems_Box_Tools::toCurrency($hasil["total_payment"]) . " >>testfile.txt \n";
			...
			//$txt .= "copy testfile.txt \"\\\\localhost\EPSON LX-310 ESCP\" \n"; $previewRemoveTxt1 = "copy testfile.txt \"\\\\localhost\EPSON LX-310 ESCP\" \n";
			  $txt .= "Notepad /p "testfile.txt" \"\\\\localhost\EPSON LX-310 ESCP\" \n"; $previewRemoveTxt1 = "Notepad /p "testfile.txt" \"\\\\localhost\EPSON LX-310 ESCP\" \n";
