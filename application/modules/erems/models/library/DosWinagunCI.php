...
/**
 * Description of DosDefault
 *
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosWinagunCI {
    public function getTxt($hasil){
        ...
        $penandataTangan  = $hasil["penandatangan"];
            ...
            $barisMarginBotTerbilang = 0;

            $barisMarginBotNote = $barisMarginBotNote - count($noteAr) + 0;
            ...
            $txt .= "echo.>>testfile \n";
            $txt .= "echo.>>testfile \n";
            $txt .= "echo                            clkm" . $hasil["customer_name"] . " >>testfile \n";
            //$txt .= "echo.>>testfile \n";
