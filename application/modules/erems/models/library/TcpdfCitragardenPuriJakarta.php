...
class Erems_Models_Library_TcpdfCitragardenPuriJakarta implements Erems_Models_Payment_PrintBisaMulti{
  ...
  <tr>
    ...
    <td colspan="2" height="30" width="300">' . $dataPayment['customer'] . '</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="80">&nbsp;</td>'
                                    . '<td colspan="2" height="22"  width="330" style="font-size: small;">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="80">&nbsp;</td>'
                                    . '<td colspan="2" height="49" width="330">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
...
/*
  ...
  $html .=' <tr>
    <td width="40">&nbsp;</td>
    <td width="390" height="0" valign="top">' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
 */
		  ...
		  $html .='<tr>'
				. '<td width="40">&nbsp;</td>'
				. '<td colspan="2" height="41" width="450">'. $dataPayment['amount']. '&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
