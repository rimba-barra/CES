 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitraLakeSawangan implements Erems_Models_Payment_PrintBisaMulti{
    ...
    public function getOptions() {
        return array(
            //array("value"=>1,"text"=>"Template 1 ( Retno )","selected"=>true,"user_id"=>1878),
            array("value"=>2,"text"=>"Template ( ReginaNew )","selected"=>false,"user_id"=>7903),
			  array("value"=>5,"text"=>"Template 1 ( Nora )","selected"=>false,"user_id"=>5893),
			  array("value"=>8,"text"=>"Template 2 ( Regina )","selected"=>false,"user_id"=>0),
              array("value"=>12,"text"=>"Template 3 ( Nia )","selected"=>false,"user_id"=>0),
              array("value"=>13,"text"=>"Template ( Others Payment Nia )","selected"=>false,"user_id"=>0),
			  array("value"=>9,"text"=>"Template ( Others Payment Regina )","selected"=>false,"user_id"=>0)
	...
	//2019-10-09 -> dicoba ganti dengan di atas
	public function getTxt7xxxx($hasil){
