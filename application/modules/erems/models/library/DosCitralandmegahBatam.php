 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitralandmegahBatam implements Erems_Models_Payment_PrintBisaMulti{
    public function getOptions() {
		...
		/*
			...
			array("value"=>3,"text"=>"Template 3","selected"=>false,"user_id"=>114),
			  ...
			  */
			  array("value"=>11,"text"=>"Template Installment 1","selected"=>false,"user_id"=>0),
			 // array("value"=>8,"text"=>"Template Yulia","selected"=>false,"user_id"=>0),
			  ...
			  //array("value"=>7,"text"=>"Template Regina","selected"=>false,"user_id"=>5905),
			  array("value"=>12,"text"=>"Template Others Payments 1","selected"=>false,"user_id"=>0)
        );
    }
	...
	public function getTxt12($hasil){
        ...
        $penandataTangan  = $hasil["penandatangan"];
			...
			//$txt .= "echo                                                                  " . Erems_Box_Tools::formatDate($hasil["payment_date"]) . "";
