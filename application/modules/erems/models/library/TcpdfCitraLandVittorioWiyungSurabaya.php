...
class Erems_Models_Library_TcpdfCitraLandVittorioWiyungSurabaya{
...
/// sort hasil print
  ...
  <tr>
    ...
    <td colspan="2" height="21" width="300">' . $dataPayment['customer'] .'</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="35" width="460">'. nl2br($dataPayment['note']). '</td>'
                                   . '</tr>';
    ...
    <td width="40">&nbsp;</td>
    <td width="400">&nbsp;</td>
        <td height="15">&nbsp;&nbsp;'.date("d").' '.Erems_Box_Tools::indoMonthText(intval(date("m"))).' '.date("Y") . '</td>
  </tr>';
  
  $html .='<tr>'
		. '<td width="120">&nbsp;</td>'
		. '<td colspan="2"  width="460"><font size="7">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DISETOR DI BCA (BCJ) Rp '. $dataPayment['amount']. ' '.$dataPayment['duedate'].'</font></td>'
	   . '</tr>';
  ...
  $html .=' <tr>
    <td width="60">&nbsp;</td>
    <td width="360" height="150" style="font-size: small;"></td>
		<td><br>HENNY SUGIARTO</td>
 ...
 */
  ...
  $html .=' <tr>
	<td width="40">&nbsp;</td>
    <td width="380" height="30" style="font-size:13px; font-weight:bold">' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
  
    $html .=' <tr>
    <td width="60">&nbsp;</td>
    <td width="350" height="75" style="font-size: small;"></td>
        <td>HENNY SUGIARTO</td>
  </tr>';
  ...
  $html .=' <tr>
    <td width="40">&nbsp;</td>
    <td width="380" height="30" style="font-size:13px; font-weight:bold">' . nl2br($dataPayment['amount']) . '</td>
        <td>&nbsp;</td>
  </tr>';
  
   $html .=' <tr>
    <td width="60">&nbsp;</td>
    <td width="350"  style="font-size: small;"></td>
        <td>HENNY SUGIARTO</td>
  </tr>';
