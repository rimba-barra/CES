...
/**
 * Description of TemplateCitralandPalembang
 *
 * @author MIS
 */
require_once dirname(__DIR__) . '../../library/tcpdf/tcpdf.php';

class Erems_Models_Library_TemplateCitralandPalembang {
  ...
  <tr>
    ...
    <td colspan="2" height="50">' . $dataPayment['customer'] . '</td>
						...
						*/
						 $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="50" width="420">'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
    ...
    <td width="390">&nbsp;</td>
        <td height="10">&nbsp;</td>
						...
						*/
						...
						$html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="50" width="420">'. $dataPayment['note']. '</td>'
                                    . '</tr>';
    ...
    <td width="30">&nbsp;</td>
    <td width="350">&nbsp;</td>
        <td height="20">Palembang, '.$dataPayment['date'] . '</td>
  </tr>';
                        
  $html .=' <tr>
    <td width="50">&nbsp;</td>
    <td width="390" height="70">' . $dataPayment['amount'] . '</td>
        <td>&nbsp;</td>
  </tr>';
   ...
   $html .='<tr>
    <td width="40">&nbsp;</td>
    <td width="335">&nbsp;</td>
        <td height="10"> '.$dataPayment['ttd_name'].'</td>
  </tr>';
