...
class Erems_Models_Library_TcpdfCWJ1Office1 implements Erems_Models_Payment_PrintBisaMulti{
...
$html .='</table>';
	...
	public function getOptions() {
        return array(
            array("value"=>1,"text"=>"Template 1","selected"=>true)
        );
    }
...
/// sort hasil print
  ...
  <tr>
    <td width="50">&nbsp;</td>
    <td colspan="2" height="65" width="300">' . $dataPayment['customer'] .'</td>
  </tr>';
                            ...
                            $html .='<tr>'
                                    . '<td width="55">&nbsp;</td>'
                                    . '<td colspan="2" height="65"  width="460" >'. $dataPayment['terbilang']. '</td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="50">&nbsp;</td>'
                                    . '<td colspan="2"  height="80" width="460">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
                        

						$html .=' <tr height="5">
    <td width="375" align="left"><p style="font-size:13px; font-weight:bold">' . $dataPayment['amount'] . '</p></td>
    <td width="200" >Jakarta, '.$dataPayment['date'] . '</td>
        <td>&nbsp;</td>
  </tr>';
/*$html .=' <tr>
    <td width="400" align="left"><p style="font-size:13px; font-weight:bold">' . $dataPayment['amount'] . '</p></td>
    <td width="200">&nbsp;</td>
        <td>&nbsp;</td>
  </tr>';
...
/// sort hasil print
  ...
  <tr>
    <td width="120">&nbsp;</td>
    <td colspan="2" height="23" width="300">' . $dataPayment['customer'] .'</td>
  </tr>';
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="17"  width="460" ><font size="9">'. $dataPayment['terbilang']. '</font></td>'
                                    . '</tr>';
                        
                        
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="40" width="460">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
 ...
 */
  ...
  <tr>
    ...
    <td colspan="2" height="21" width="300">' . $dataPayment['customer'] .'</td>
                            ...
                            $html .='<tr>'
                                    . '<td width="120">&nbsp;</td>'
                                    . '<td colspan="2" height="44" width="460">'. $dataPayment['note']. '</td>'
                                   . '</tr>';
