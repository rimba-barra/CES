 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Library_DosCitraLandAmbon implements Erems_Models_Payment_PrintBisaMulti{
	...
	// $txt .= "echo                                                                    " . Erems_Box_Tools::formatDate($hasil["payment_date"]) . " >>testfile.txt \n";
			...
			$txt .= "echo                                                              " .date("d-m-Y") . "  >>testfile.txt \n";
            //$txt .= "echo                                                                       " .Erems_Box_Tools::formatDate($hasil["payment_date"]) . "  >>testfile.txt \n";
			//$txt .= "echo.>>testfile.txt \n";
    ...
    public function getOptions() {
        return array(
            array("value"=>1,"text"=>"Template Installment Test CitraLandAmbon","selected"=>true,"user_id"=>0)
            //array("value"=>2,"text"=>"Template Others ( Uti )","selected"=>true,"user_id"=>0)
