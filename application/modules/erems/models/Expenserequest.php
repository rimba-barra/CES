...
class Erems_Models_Expenserequest extends Zend_Db_Table_Abstract
{
	...
	function expenserequestRead($param)
	{
	...
	function expenserequestCreate($param=array())
	{	
		$return['success'] = false;
		if (is_array($param) && count($param))
		{
	...
	function expenserequestUpdate($param=array())
	{
		$return['success'] = false;
		if (is_array($param) && count($param))
		{
	...
	function expenserequestDelete($param=array())
	{
		$return['success'] = false;
		if (is_array($param) && count($param))
		{
