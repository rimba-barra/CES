...
/**
 * Description of judul_komisi
 *
 * @author MIS
 */
class Erems_Models_Komisi_Pencairan extends Erems_Box_Models_ObjectEmbedData implements Erems_Box_Kouti_Remora,Erems_Box_Models_Master_InterProjectPt {
    private $code;
    private $judul_komisi;
    private $description;
    private $project;
    private $pt;
    private $Addon;
    ...
    public function __construct() {
        parent::__construct();
        $this->embedPrefix = "komisi_pencairan_";
    }
    ...
    public function getName() {
        return $this->judul_komisi;
    }

    public function setName($judul_komisi) {
        $this->judul_komisi = $judul_komisi;
    }
    ...
    public function setModion($Modion) {
     ...
     public function setArrayTable($dataArray=NULL) {
        ...
        if(isset ($x['komisi_pencairan_id'])){
           $this->setId($x['komisi_pencairan_id']); 
        }
        if(isset ($x['code'])){
           $this->setCode($x['code']); 
        }
        if(isset ($x['judul_komisi'])){
           $this->setName($x['judul_komisi']); 
        }
    ...
    public function getArrayTable(){
        $x = array(
            "komisi_pencairan_id"=>$this->getId(),
            "code"=>$this->getCode(),
            "judul_komisi"=>$this->getName(),
