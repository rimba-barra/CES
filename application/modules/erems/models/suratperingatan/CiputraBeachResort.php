...
class Erems_Models_Suratperingatan_CiputraBeachResort
{
    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tgl_print_today = $this->tgl_indo(date('Y-m-d', strtotime("0 day")));
        $tgl_print14 = $this->tgl_indo(date('Y-m-d', strtotime("+14 day")));
        ...
        if (substr($b, 0, 1) == "0") {
            if ($data['pt_id'] == 3178) {
                $nomor_sp_teratas = str_replace("DTA", "DTB", $data["nomor_terakhir"]);
            }
            else if ($data['pt_id'] == 7246) {
                $nomor_sp_teratas = str_replace("DTA", "DTC", $data["nomor_terakhir"]);
            }
            else {
        ...
        $tpl1 =
            '<style>
                ...
                <br/>
                <p align="right" class="spstyle_p">Jakarta, <b>' . $tgl_print_today . '</b></p>
        ...
        $tpl3 =
            ...
            <table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">1. </td>
                        <td align="justify" style="border:none;">
                            Bahwa, sebelumnya Bapak/Ibu telah melakukan pemesanan atas Unit {{unit_number}} di Ciputra Beach Resort Bali berdasarkan Formulir Pesanan No. {{purchaseletter_no}} tertanggal {{tanda_tangan}} antara Bapak/Ibu {{customer_name}} dengan PT {{pt_initial}};
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" style="border:none;" width="1" align="left">2. </td>
                        <td align="justify" style="border:none;">
                            Bahwa, bersama ini Kami/PT {{pt_initial}} memberitahukan kepada Bapak/Ibu selaku pemesan unit {{unit_number}}, {{cluster}}, bahwa berdasarkan catatan kami, Bapak/Ibu sampai dengan tanggal ' . $tgl_print_today . ' belum melaksanakan pembayaran angsuran yang telah jatuh tempo. Atas hal tersebut, total tunggakan yang harus diselesaikan menjadi sebagai berikut (dalam rupiah):
                        </td>
        ...
        $tpl4 =
            ...
            <table style="border:none;">
                    ...
                    <tr>
                        <td valign="top" style="border:none;" width="1" align="left">2. </td>
                        <td align="justify" style="border:none;">
                            Bahwa, bersama ini Kami/PT {{pt_initial}} memberitahukan kepada Bapak/Ibu selaku pemesan unit <b>{{unit_number}}, {{cluster}}</b>, hingga surat ini diterbitkan masih terdapat tunggakan angsuran pembayaran yang masih harus dibayarkan oleh Bapak/Ibu kepada Kami/PT {{pt_initial}}, sebagai berikut:
                        </td>
        ...
        $tpl6 = '
			<table width=100%>
				...
				<!--<td>Tagihan</td>
					...
					<td>Denda Keterlambatan <br>( s/d ' . $tgl_print_today . ' )</td>
					<td>Total Dibayar <br>( s/d ' . $tgl_print_today . ' )</td>
                </tr> 
                {{{list_tagihan}}}
                </tbody></table>
                <br/>
        ...
        $tpl7 = '<table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">3. </td>
                        <td align="justify" style="border:none;">
                            Bahwa, berdasarkan hal-hal tersebut diatas, maka Kami/PT {{pt_initial}} mohon kepada Bapak/Ibu agar segera melakukan pelunasan atas tunggakan di atas, paling lambat 14 (empat belas) hari kalender setelah tanggal yang tertera di surat ini atau paling lambat tanggal '.$tgl_print14.' ke rekening berikut:
                        </td>
                    </tr>
                </table>
                <table style="border:none;">
        ...
        $tpl8 = '<table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">3. </td>
                        <td align="justify" style="border:none;">
                            Bahwa pada syarat dan ketentuan Keterlambatan Pembayaran dalam Perjanjian Pengikatan Jual Beli yang berisi:<br>
                            Apabila Pembeli lalai dalam hal terlambat atau kurang dalam melakukan suatu pembayaran kepada Penjual berdasarkan Perjanjian ini, maka Pembeli dikenakan denda sebesar 0.4‰ (nol koma empat permil) per setiap hari keterlambatan dari jumlah terhutang sejak tanggal seharusnya dibayar sampai dilunasi seluruhnya
...
Demikian Surat Peringatan-3 ini disampaikan. Atas perhatian dan kerjasamanya Kami ucapkan terima kasih.';
        ...
        $tpl12 = '</div>
                ...
                Hormat Kami,</br>
                {{pt_name}}</br>
                <img src="https://ces.ciputragroup.com:72/webapps/Ciputra/public/app/main/images/ttd_romy_citralandmark.png" width="120" height="60">
                <img src="https://ces.ciputragroup.com:72/webapps/Ciputra/public/app/main/images/ttd_pak_ronny.jpeg" width="120" height="60">
                <br/>
        ...
        if ($spke == 1) {
            ...
            $tpl = $tpl13 . $tpl4 . $tpl6 . $tpl8 . $tpl11;
        } elseif ($spke == 3) {
