	...
	public function getHTML($spke=null,$data){
        ...
        '<style>
			...
			<!--<p style="text-align: justify;">
				...
				<p style="text-align: justify;">
				Sehubungan dengan hal diatas, mohon Bapak/Ibu dapat segera melakukan pembayaran paling lambat pada tanggal {{max_date_w}} dengan cara transfer ke : <b>PT CITRA MENARA MEGAH VA BCA : '.$data['va_bca'].'.</b><br/></p>
				<table width=100% style="font-family: Arial Narrow;font-size: 11pt; border: none;">
				  ...
				  <tr style="vertical-align: text-top;text-align: justify; border: none;">
					...
					<td style="border: none;">Dapat ditukar dengan kwitansi Asli PT. Citra Menara Megah 14 hari setelah pembayaran di City Management Office Citra 2 Ext. Blok BG 2A No.1, Pegadungan, Kalideres, Jakarta Barat</td>
				  </tr>
				</table>
