...
class Erems_Models_Suratperingatan_CitraLakeSuites {
	...
	public function getHTML($spke=null,$data){
        ...
        '<style>
			...
			$tpl4 = 
                '<p style="font-family: Arial Narrow;font-size: 11pt; font-style: normal; text-align: justify;">Berdasarkan <b>Surat Pemberitahuan 2</b> kami tanggal '.$data['sp2_date'].' No.'.$data['sp2'].', melalui surat ini kami beritahukan kepada Bapak/Ibu selaku pemesan Unit Apartemen CitraLake Suites yang terletak di Lantai/No <b>{{unit_number}} {{cluster}}</b>, bahwa berdasarkan catatan kami, angsuran Unit Apartemen Bapak/Ibu telah jatuh tempo sebesar (dalam rupiah) :</p>        
                        <br/>';
			
			$tpl5 ='<p style="font-family: Arial Narrow;font-size: 11pt; font-style: normal; text-align: justify;">Menindaklanjuti <b>Surat Pemberitahuan 3</b> kami tanggal '.$data['sp3_date'].' No.'.$data['sp3'].', 
			
			kami informasikan bahwa sampai dengan tanggal '.$tgl_print.', kami belum menerima pembayaran atas angsuran yang telah jatuh tempo. Oleh karena itu, melalui ini kami sampaikan kepada Bapak/Ibu selaku pembeli unit <b>{{unit_number}} {{cluster}}</b> Apartemen CitraLake Suites, bahwa pembelian unit tersebut menjadi <b>batal</b>.
			</p>			
			...
			<!--<p style="text-align: justify;">
				Sehubungan dengan hal diatas, mohon Bapak dapat segera melakukan pembayaran dengan cara:<br/>  </p>
				<table width=100% style="font-family: Arial Narrow;font-size: 11pt;">
				  <tr style="vertical-align: text-top;text-align: justify;">
					<td>&nbsp;&nbsp;a.</td>
					<td>Transfer ke : <b>PT CITRA MENARA MEGAH  a/c. 101 1760 401 BANK: PT. BANK BTPN Tbk cab. Jakarta.</b> Mohon  mencantumkan tower, no. blok, dan nama pemesan pada kolom berita di slip transfer (bukti transfer mohon <b>difax ke 6198213</b> Up. <b>Hendriyana/Devi</b> dan segera ditukar dengan kwitansi  CitraLake Suites), atau</td>
				  </tr>
				  <tr style="vertical-align: text-top;text-align: justify;">
					<td>&nbsp;&nbsp;b.</td>
					<td>Membayar langsung ke kasir penerimaan City Management Office, Citra 2 Ext. Blok BG. 2A No. 01, CitraGarden City, Jakarta Barat dengan giro/cek jatuh tempo atau debit BCA</td>
				  </tr>
				</table>
				<p style="text-align: justify;">Kami memberikan waktu sampai dengan tanggal <b>{{max_date_w}}</b> untuk penyelesaian pembayaran diatas. Untuk tindak lanjut penyelesaian dapat menghubungi petugas collection kami, sdri. <b>Hendriyana</b> atau sdri. <b>Devi</b> di no. telp. <b>6198177 ext. 740.</b></p>-->
				
				<p style="text-align: justify;">
				Sehubungan dengan hal diatas, mohon Bapak/Ibu dapat segera melakukan pembayaran paling lambat pada tanggal {{max_date_w}} dengan cara transfer ke virtual account bca atas nama : <b>CITRA MITRA GRAHA KSO a/c. '.$data['va_bca'].' </b><br/></p>
				<table width=100% style="font-family: Arial Narrow;font-size: 11pt; border: none;">
				  ...
				  <tr style="vertical-align: text-top;text-align: justify; border: none;">
					...
					<td style="border: none;">Di infokan melalui <b>WA ke 082122941527, 081281229449 Up. Devi</b></td>
				  </tr>
				  <tr style="vertical-align: text-top;text-align: justify; border: none;">
					<td style="border: none;">&nbsp;&nbsp;b.</td>
					<td style="border: none;">Dapat ditukar dengan kwitansi Asli Citra Mitra Graha, KSO 14 hari setelah pembayaran di City Management Office Citra 2 Ext. Blok BG 2A No.1, Pegadungan, Kalideres, Jakarta Barat</td>
				  </tr>
				</table>
				<p style="text-align: justify;">Untuk tindak lanjut penyelesaian dapat menghubungi petugas collection kami, sdri Devi di no. telp. 021-6198177 ext.740</p>				
				';
