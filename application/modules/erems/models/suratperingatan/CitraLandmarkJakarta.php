 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Suratperingatan_CitraLandmarkJakarta
{
    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tpl2 =
            'Perkenankan Kami <b>PT CIPUTRA CITRA TRISULA</b> (untuk selanjutnya disebut <b>"PT CCT"</b>) hendak menyampaikan hal-hal sebagai berikut:<br/>
            <table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">1. </td>
                        <td align="justify" style="border:none;">
                            Bahwa sebelumnya Kami/PT CCT telah mengirimkan kepada Bapak/Ibu Surat-Surat Peringatan sebagai berikut:<br/>
                    ...
                    <tr>
                        ...
                        <td align="justify" style="border:none;">
                            Bahwa, berdasarkan hal-hal tersebut di atas dan sebagaimana telah kami informasikan melalui surat-surat peringatan sebelumnya mengenai batas tanggal dan jumlah pembayaran tunggakan yang harus Bapak/Ibu bayarkan kepada Kami/PT CCT beserta konfirmasinya, dan oleh karena hingga saat ini Kami belum menerima pembayaran dan konfirmasi pembayaran atas tunggakan angsuran sebesar Rp. ' . number_format($data['total_remaining']) . ' ({{total_remaining_text}} Rupiah) dimaksud, <b>maka dengan berat hati Kami/PT CCT sampaikan bahwa tidak ada pilihan lain bagi Kami/ PT CCT saat ini selain melakukan pemutusan dan/atau pembatalan sepihak Formulir Pesanan Satuan Rumah Susun Tower {{cluster}} @ Citra Landmark Southeast Jakarta No. {{purchaseletter_no}} tertanggal {{tanda_tangan}} dan sejak saat ini dinyatakan berakhir/batal serta tidak berlaku lagi. Maka seluruh pembayaran yang telah Bapak/Ibu bayarkan kepada Kami/PT CCT tidak dapat dikembalikan, serta Unit {{unit_number}} Tower {{cluster}} dimaksud mutlak menjadi hak dan/atau milik Kami/PT CCT sepenuhnya, serta Kami/PT CTT dibebaskan dari upaya hukum perdata/pidana/upaya hukum apapun maupun upaya lainnya.</b>
                        </td>
        ...
        $tpl3 =
            'Perkenankan Kami PT CIPUTRA CITRA TRISULA (untuk selanjutnya disebut "PT CCT") hendak menyampaikan hal-hal sebagai berikut:<br/>
            <table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">1. </td>
                        <td align="justify" style="border:none;">
                            Bahwa, sebelumnya Bapak/Ibu telah melakukan pemesanan atas Unit {{unit_number}} di Apartemen Citra Landmark berdasarkan Formulir Pesanan Satuan Rumah Susun No. {{purchaseletter_no}} tertanggal {{tanda_tangan}} antara Bapak/Ibu {{customer_name}} dengan PT CCT;
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" style="border:none;" width="1" align="left">2. </td>
        ...
        $tpl4 =
            ...
            <table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">1. </td>
                        <td align="justify" style="border:none;">
                            Bahwa sebelumnya Kami/PT CCT telah mengirimkan kepada Bapak/Ibu Surat No. ' . $data['sp1'] . ' tertanggal ' . $this->tgl_indo($data['sp1_date']).' dengan perihal : Surat Peringatan-1;
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" style="border:none;" width="1" align="left">2. </td>
                        <td align="justify" style="border:none;">
                            Bahwa, bersama ini Kami/PT CCT memberitahukan kepada Bapak/Ibu selaku pemesan unit <b>{{unit_number}}, {{cluster}}</b>, hingga surat ini diterbitkan masih terdapat tunggakan angsuran pembayaran atas Unit ({{unit_number}}) di Apartemen Citra Landmark yang masih harus dibayarkan oleh Bapak/Ibu kepada Kami/PT CCT, sebagai berikut:
                        </td>
        ...
        $tpl5 = 'Perkenankan Kami PT CIPUTRA CITRA TRISULA (untuk selanjutnya disebut "PT CCT") hendak menyampaikan hal-hal sebagai berikut:<br/>
            <table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">1. </td>
                        <td align="justify" style="border:none;">
        ...
        $tpl7 = '<table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">3. </td>
                        <td align="justify" style="border:none;">
                            Bahwa, berdasarkan hal-hal tersebut diatas, maka Kami/PT CCT mohon kepada Bapak/Ibu agar segera melakukan pelunasan atas tunggakan di atas, paling lambat 30 (tiga puluh) hari kalender setelah tanggal yang tertera di surat ini atau paling lambat tanggal '.$tgl_print_max.' ke rekening berikut:
                        </td>
                    </tr>
                </table>
                <table style="border:none;">
        ...
        $tpl10 = '<table style="border:none;">
                ...
                <table style="border:none;">
                    <tr style="border:none;">
                        ...
                        <td align="justify" style="border:none;">
                           Bahwa, apabila selambat-lambatnya pada tanggal {{max_date_w}} Bapak/Ibu belum juga melakukan pembayaran kepada Kami/ PT CCT sebesar ' . number_format($data['total_remaining']) . ' sebagaimana Kami/PT CCT sebutkan pada poin nomor 2, 3 dan 4 tersebut diatas, maka Form Pemesanan No. {{purchaseletter_no}} tertanggal {{tanda_tangan}} dapat Kami/PT CCT batalkan sepihak dan seluruh pembayaran yang telah Bapak/Ibu bayarkan kepada Kami/PT CCT tidak dapat dikembalikan, serta Unit {{unit_number}} di Apartemen {{cluster}} sepenuhnya mutlak menjadi hak Kami/PT CCT, serta Kami/PT CTT dibebaskan dari upaya hukum perdata/pidana/upaya hukum apapun maupun upaya lainnya.
                        </td>
                    </tr>
                </table>
                ' . $page_break . '
