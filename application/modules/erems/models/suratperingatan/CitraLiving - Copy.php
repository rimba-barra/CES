...
class Erems_Models_Suratperingatan_CitraLiving {
	...
	public function getHTML($spke=null,$data){
        ...
        '<style>
			...
			$tpl5 ='<p style="font-family: Arial Narrow;font-size: 11pt; font-style: normal; text-align: justify;">Menindaklanjuti <b>Surat Pemberitahuan 3</b> kami tanggal {{tgl_sp3}} No.{{sp3}}, 
			
			kami informasikan bahwa sampai dengan tanggal '.$tgl_print.', kami belum menerima pembayaran atas angsuran yang telah jatuh tempo. Oleh karena itu, melalui ini kami sampaikan kepada Bapak/Ibu selaku pembeli unit <b>{{unit_number}} {{cluster}}</b> Apartemen Citra Living, bahwa pembelian unit tersebut menjadi <b>batal</b>.
			</p>			
			...
			<p style="text-align: justify;">
				Sehubungan dengan hal diatas, mohon Bapak/Ibu dapat segera melakukan pembayaran dengan cara:<br/></p>
				<table width=100% style="font-family: Arial Narrow;font-size: 11pt; border: none;">
				  <tr style="vertical-align: text-top;text-align: justify; border: none;">
					...
					<td style="border: none;">Transfer ke :  CITRA MITRA GRAHA KSO  a/c. 5445.909090 BCA Cab.Citra Garden 2 Ext kalideres, Jakarta  Barat. Mohon  mencantumkan Tower,  Lantai, No. Apartemen, dan nama pemesan pada  kolom  berita  di slip transfer ( bukti transfer mohon difax ke 6198213 Up. Devi/Hendriyana dan segera  ditukar  dengan  kwitansi  CitraGarden City) , atau</td>
				  </tr>
				  <tr style="vertical-align: text-top;text-align: justify; border: none;">
					<td style="border: none;">&nbsp;&nbsp;b.</td>
					<td style="border: none;">Membayar langsung ke kasir  penerimaan  City Management Office, Citra 2 Ext. Blok BG. 2A No. 01, CitraGarden City, Jakarta Barat  dengan  cash, giro / cek jatuh tempo atau debit BCA.</td>
				  </tr>
				</table>
				<p style="text-align: justify;">Kami memberikan waktu sampai dengan tanggal <b>{{max_date_w}}</b> untuk penyelesaian pembayaran diatas. Untuk tindak lanjut penyelesaian dapat menghubungi petugas collection kami, sdri. <b>Devi/Hendriyana</b> di no. telp. <b>6198177 ext. 740.</p>';
