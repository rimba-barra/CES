 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Suratperingatan_CitraGardenPuriJakarta
{
    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tpl4 =
            'Menindaklanjuti <b>Surat Peringatan 2</b> kami tanggal {{tgl_sp2}} No.{{sp2}}, bersama ini kami beritahukan kepada Bapak/Ibu selaku pembeli unit <b>{{unit_number}}</b> , cluster {{cluster}},bahwa berdasarkan catatan kami, Bapak/Ibu sampai dengan tanggal <b>' . $tgl_print . '</b> belum melaksanakan pembayaran yang telah jatuh tempo. Atas hal tersebut, total tunggakan yang harus diselesaikan menjadi sebagai berikut (dalam rupiah) :</p>';

        $tpl5 = 'Menindaklanjuti <b>Surat Peringatan 3</b>, tertanggal {{tgl_sp3}} No.{{sp3}}, kami tegaskan kepada Bapak/Ibu selaku pembeli unit <b>{{unit_number}}</b> , cluster {{cluster}},bahwa pemesanan unit tersebut menjadi <b>batal.</b>
			<br/><br/>
        ...
        $tpl7 = 'Kami memberikan waktu sampai dengan tanggal <b>{{max_date_w}}</b> untuk penyelesaian pembayaran tunggakan diatas. Bapak/Ibu dapat menghubungi petugas Collection kami di no. telp. <b>6198177 ext. 712/710 Yuriene/Novi</b>
					<br/>
        ...
        $tpl10 = 'Kami memberikan waktu sampai dengan tanggal <b>{{max_date_w}}</b> untuk penyelesaian pembayaran diatas. Untuk tindak lanjut penyelesaian dapat menghubungi petugas collection kami di no. telp. <b>6198177 ext. 712/710 Yuriene/Novi</b>
			<br>
			<br>
