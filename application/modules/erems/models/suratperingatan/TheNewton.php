...
class Erems_Models_Suratperingatan_TheNewton
{
    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tpl3 =
            ...
            <table style="border:none;">
                    ...
                    <tr style="border:none;">
                        ...
                        <td align="left" style="border:none;">Bahwa, bersama ini Kami/PT {{pt_initial}} memberitahukan kepada Bapak/Ibu selaku pemesan unit {{unit_number}}, {{cluster}} The Newton, bahwa berdasarkan catatan kami, Bapak/Ibu sampai dengan tanggal ' . $tgl_print_duedate . ' belum melaksanakan pembayaran angsuran yang telah jatuh tempo. Atas hal tersebut, total tunggakan yang harus diselesaikan menjadi sebagai berikut (dalam rupiah):</td>
                    </tr>
                </table><br/>
            ';        
		...
		'<br/>
            ...
            <table style="border:none;">
					...
					<td valign="top" style="border:none;" width="15"></td>
						...
						<td align="left" style="border:none;">Surat No. ' . $data['sp1'] . ' tertanggal ' . $this->tgl_indo($data['sp1_date']).' dengan perihal : Surat Peringatan-1;</td>
                    </tr>
					
					<tr style="border:none;">
					<td valign="top" style="border:none;" width="15"></td>
                        <td valign="top" style="border:none;" width="15">1.2.  </td>
                        <td align="left" style="border:none;">Surat No.  ' . $data['sp2'] . ' tertanggal ' . $this->tgl_indo($data['sp2_date']).' dengan perihal : Surat Peringatan-2.</td>
                    </tr>
                </table><br/>
				<table style="border:none;">
                     <tr style="border:none;">
                        <td valign="top" style="border:none;" width="15">2. </td>
                        <td align="left" style="border:none;" colspan=2>Bahwa, bersama ini Kami/PT {{pt_initial}} memberitahukan kepada Bapak/Ibu selaku pemesan unit {{unit_number}}, {{cluster}} The Newton, bahwa berdasarkan catatan kami, Bapak/Ibu sampai dengan tanggal ' . $tgl_print_duedate . ' belum melaksanakan pembayaran angsuran yang telah jatuh tempo. Atas hal tersebut, total tunggakan yang harus diselesaikan menjadi sebagai berikut (dalam rupiah): <br/></td>
                    </tr>
                </table><br/>
            ';        
        ...
        if ($spke == 1 && $sppjb_stts == 0) {
            ...
            $tpl = $tpl1 . $tpl3 . $tpl6 . $tpl8 . $tpl16;
        } elseif ($spke == 2 && $sppjb_stts == 1) {
            $tpl = $tpl1 . $tpl3 . $tpl6 . $tlp8 . $tpl16;
        } elseif ($spke == 3 && $sppjb_stts == 0) {
            $tpl = $tpl1 . $tpl14 . $tpl6 . $tpl81 . $tpl15;
