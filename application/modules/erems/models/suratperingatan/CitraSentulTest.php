 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Suratperingatan_CitraSentulTest
{
    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tpl6 = '
			...
			Sehubungan dengan hal diatas, mohon Bapak/Ibu dapat segera melakukan pembayaran paling lambat tanggal <b>{{max_date_w}}</b> dengan cara:	
				...
				• &nbsp;&nbsp;Untuk pembayaran langsung ke kasir penerimaan kantor pemasaran CitraRaya :<br/>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;a)&nbsp;Pembiayaan KPR dengan Giro/Cek jatuh tempo, atau Kartu Debit atas nama pemesan atau suami/istri (dikenakan biaya administrasi sesuai ketentuan yang berlaku).<br/>
