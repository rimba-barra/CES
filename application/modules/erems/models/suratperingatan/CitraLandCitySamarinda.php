 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Suratperingatan_CitraLandCitySamarinda
{
    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tpl1 =
            '<style>
				...
				<br/>
				<br/>
                <p class="spstyle_p">Samarinda, ' . $tgl_print . '</p>
        ...
        $tpl5 = 'Sesuai dengan Informasi pesan singkat (via WA) tertanggal ' . $tgl_print . ' yang kami <b>( Lusi Collection )</b> terima dari Sales Marketing 
            ...
            Untuk keterangan lebih jelas bisa menghubungi petugas Collection kami, <b>sdri Lusi</b> di pesawat <b>22596888, 22596999 ext 240<b/>.<br/>
            <br>
			<br>
        ...
        $tpl6 = '
			...
			Sehubungan dengan hal diatas, mohon Bapak/Ibu dapat segera melakukan pembayaran paling lambat tanggal <b>{{max_date_w}}</b> dengan cara:	
				...
				<p>
				• &nbsp;&nbsp;<b>Transfer melalui Rekening BCA 254.031.1920 a/n PT. CIPUTRA GRAHA MITRA</b><br/>
                ...
                Kelalaian dan/ atau keterlambatan kewajiban pembayaran diatas akan mempengaruhi waktu janji serah terima Unit tersebut. Kepastian waktu serah terima Unit akan kami informasikan lebih lanjut setelah dilakukannya kewajiban pembayaran diatas.<br/>
							';
		$tpl7 = 'Kami memberikan waktu sampai dengan tanggal <b>{{max_date_w}}</b> untuk penyelesaian pembayaran tunggakan diatas bersamaan dengan angsuran bulan berjalan. Untuk tindak lanjut penyelesaian dapat menghubungi petugas Collection kami, <b>sdri Dwi</b> di pesawat <b>22596888, 22596999 ext 237.</b>
					<br/>
            Demikian hal ini kami sampaikan, atas perhatian dan kerjasama yang baik dari Bapak/Ibu kami ucapkan terima kasih. ';

        $tpl8 = 'Untuk tindak lanjut penyelesaian dapat menghubungi petugas Collection kami, <b>sdri Yanti / Ferawati</b> di pesawat <b>0541 7283388 - 7283488.</b>
					<br/><br/>
            Demikian hal ini kami sampaikan, atas perhatian dan kerjasama yang baik dari Bapak/Ibu kami ucapkan terima kasih.';
        ...
        $tpl9 = '<style>
				...
				<br/>
				<br/>
                <p class="spstyle_p">Samarinda, <b>' . $tgl_print . '</b></p>
        ...
        $tpl10 = 'Kami memberikan waktu sampai dengan tanggal <b>{{max_date_w}}</b> untuk penyelesaian pembayaran tunggakan diatas bersamaan dengan angsuran bulan berjalan. Untuk tindak lanjut penyelesaian dapat menghubungi petugas Collection kami, <b>sdri Dwi</b> di pesawat <b>22596888, 22596999 ext 237.</b>
			<br>
        ...
        $tpl13 = 'Apabila lewat dari tanggal tersebut diatas maka dengan sangat menyesal kami menganggap Bapak/Ibu membatalkan pemesanan tanah dan bangunan tersebut serta uang yang telah dibayarkan tidak dapat dikembalikan.
		<br/>
		<br/>
			Untuk tindak lanjut penyelesaian dapat menghubungi petugas Collection kami, <b>sdri Yanti / Ferawati</b> di pesawat <b>0541 7283388 - 7283488.</b>
					<br/><br/>
            Demikian hal ini kami sampaikan, atas perhatian dan kerjasama yang baik dari Bapak/Ibu kami ucapkan terima kasih.';

        $tpl14 .= 'Sesuai dengan Informasi pesan singkat (via WA) tertanggal ' . $tgl_print . ' yang kami <b>( Lusi Collection )</b> terima dari Sales Marketing 
            <b>Sulaiman Wibifono</b>, bahwa Bapak/Ibu mengundurkan diri dari pembelian tanah dan bangunan <b>Type {{type_name}} Blok {{unit_number}} Kaw. {{cluster}} ( {{cluster_code}} )</b>.
			<br/><br/>
			Keseluruhan uang yang telah Bapak /Ibu bayarkan <b>tidak dapat dikembalikan</b>. Dengan demikian kami <b>berhak menjual</b> kembali tanah dan bangunan tersebut kepada pihak lain.<br/>
        ...
        if ($spke == 1) {
            ...
            $tpl = $tpl1 . $tpl4 . $tpl6 . $tpl13 . $tpl11;
        } elseif ($spke == 4) {
            $tpl = $tpl9  . $tpl14 . $tpl11;
        } else {
