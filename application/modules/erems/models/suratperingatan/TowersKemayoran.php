    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tpl1 =
            '<style>
                ...
                <p class="spstyle_p" ' . $style . '>No	: <b>' . $nomor_sp_teratas . '</b><br/>
        ...
        $tpl2 =
            '<p style="text-align: justify;font-family: Arial Narrow;font-size: 11pt; font-style: normal;">Menindaklanjuti <b>Surat Peringatan 1</b> kami tanggal ' . $data['sp1_date'] . ' No.' . $data['sp1'] . '. Melalui surat ini kami beritahukan kepada Bapak/Ibu selaku pemesan unit office Citra Towers Kemayoran yang terletak di Lantai/No <b>{{unit_number}} {{cluster}}</b> , bahwa berdasarkan catatan kami, angsuran Unit office Bapak/Ibu telah jatuh tempo sebesar (dalam rupiah) :</p>        
                        <br/></p>';

        $tpl3 =
            '<p style="text-align: justify;font-family: Arial Narrow;font-size: 11pt; font-style: normal;">Melalui surat ini kami informasikan kepada Bapak/Ibu <b>{{customer_name}}</b> selaku pembeli unit office Lantai <b>{{unit_number}} {{cluster}}</b>, bahwa berdasarkan catatan kami Bapak/Ibu <b>{{customer_name}}</b> sampai dengan tanggal <b>' . $tgl_print . '</b> belum melaksanakan pembayaran atas angsuran dan denda yang telah jatuh tempo. Atas hal tersebut, total tunggakan yang harus diselesaikan menjadi sebagai berikut (dalam rupiah):
                        </p>        
                        ';

        $tpl4 =
            'Berdasarkan <b>Surat Peringatan 2</b> kami tanggal ' . $data['sp2_date'] . ' No.' . $data['sp2'] . ', melalui surat ini kami beritahukan kepada Bapak/Ibu selaku pemesan Unit office Citra Towers Kemayoran yang terletak di Lantai/No <b>{{unit_number}} {{cluster}}</b>, bahwa berdasarkan catatan kami, angsuran Unit office Bapak/Ibu telah jatuh tempo sebesar (dalam rupiah) :</p>        
                        <br/>';
        ...
        $tpl5 = '<p style="font-family: Arial Narrow;font-size: 11pt; font-style: normal; text-align: justify;">Menindaklanjuti <b>Surat Peringatan 3</b> kami tanggal ' . $data['sp3_date'] . ' No.' . $data['sp3'] . ', 
			...
			kami informasikan bahwa sampai dengan tanggal ' . $tgl_print . ', kami belum menerima pembayaran atas angsuran yang telah jatuh tempo. Oleh karena itu, melalui ini kami sampaikan kepada Bapak/Ibu selaku pembeli unit <b>{{unit_number}} {{cluster}}</b> office Citra Towers Kemayoran, bahwa pembelian unit tersebut menjadi <b>batal</b>.
			</p>			
			<p style="font-family: Arial Narrow;font-size: 11pt; font-style: normal; text-align: justify;">
			
			Keseluruhan uang yang telah Bapak/Ibu bayarkan <b>tidak dapat dikembalikan</b>. Dengan demikian kami <b>berhak menjual</b> kembali unit office tersebut kepada pihak lain.
			</p>
			<p style="font-family: Arial Narrow;font-size: 11pt; font-style: normal; text-align: justify;">
        ...
        $tpl6 = '
			<table width=100% class="table" style="text-align: justify;font-family: Arial Narrow;font-size: 11pt; font-style: normal;border-collapse: collapse;border: 1px solid black;">
				...
				<tr style="vertical-align: text-top;text-align: center;font-weight: bold;border: 1px solid black;">
					...
					<td style="border: 1px solid black;text-align: center;">Denda Keterlambatan <br>( s/d {{max_date}} )</td>
					<td style="border: 1px solid black;text-align: center;">Total Dibayar <br>( s/d {{max_date}} )</td>
                </tr> 
                {{{list_tagihan}}}
                </tbody></table>
			...
			<!--<p style="text-align: justify;">
				...
				<table width=100% style="font-family: Arial Narrow;font-size: 11pt;">
				  <tr style="vertical-align: text-top;text-align: justify;">
					<td>&nbsp;&nbsp;a.</td>
					<td>Transfer ke : <b>CITRA PEMBINA SUKSES JO a/c. NO REK. 118-00-4500-6789 BANK MANDIRI Cab. Citra 2 Ext Jakarta atau NO REK. 6840-970-688 BANK BCA</b>. Mohon mencantumkan nomor unit office dan nama pemesan pada kolom berita di slip transfer (bukti transfer mohon <b>di email ke septian.hangga@ciputra.com</b> dan segera ditukar dengan kwitansi Citra Towers Kemayoran), atau</td>
				  </tr>
				  <tr style="vertical-align: text-top;text-align: justify;">
					<td>&nbsp;&nbsp;b.</td>
					<td>Membayar langsung ke kasir penerimaan <b>City Management Office, Citra 2 Ext. Blok BG.2A No.01, Citra Garden City, Jakarta Barat</b> dengan giro/cek jatuh tempo, debit MANDIRI atau debit BCA.</td>
				  </tr>
				</table>
			...
			<p style="text-align: justify;">
				Sehubungan dengan hal diatas, mohon Bapak/Ibu dapat segera melakukan pembayaran paling lambat pada tanggal {{max_date_w}} dengan cara transfer ke virtual account mandiri atas nama : <b>CITRA PEMBINA SUKSES JO a/c. '.$data['va_mandiri'].' </b><br/></p>
				<table width=100% style="font-family: Arial Narrow;font-size: 11pt; border: none;">
				  <tr style="vertical-align: text-top;text-align: justify;">
					<td colspan=2>Bukti transfer mohon :</td>
				  </tr>
				  <tr style="vertical-align: text-top;text-align: justify; border: none;">
					<td style="border: none;">&nbsp;&nbsp;a.</td>
					<td style="border: none;">Di infokan melalui <b>WA ke 081284837723 Up. Hangga</b></td>
				  </tr>
				  <tr style="vertical-align: text-top;text-align: justify; border: none;">
					<td style="border: none;">&nbsp;&nbsp;b.</td>
					<td style="border: none;">Dapat ditukar dengan kwitansi Asli CITRA PEMBINA SUKSES JO 14 hari setelah pembayaran di Marketing Gallery Citra Towers Kemayoran, Jl. Benyamin Suaeb Kav. A6, Kemayoran, Jakarta Pusat</td>
				  </tr>
				</table>
				<p style="text-align: justify;">Untuk tindak lanjut penyelesaian dapat menghubungi petugas collection kami, sdr Hangga di no. telp. 021-6198177 ext.742</p>
				';
        ...
        $tpl10 = '<p style="text-align: justify;">Apabila lewat dari tanggal tersebut diatas Bapak/Ibu masih belum melunasinya, maka dengan sangat menyesal kami menganggap Bapak/Ibu membatalkan <b>pemesanan unit office tersebut</b>. Keseluruhan uang yang telah Bapak/Ibu bayarkan <b>tidak dapat dikembalikan</b>. Dengan demikian kami <b>berhak menjual kembali unit office</b> tersebut kepada pihak lain.</p>
        ...
        $tpl11 .= '</div>
                ...
                Hormat Kami,</br>
                <b>CITRA PEMBINA SUKSES JO</b></br>
                <br/>
                <br/>
                <br/>
                <br/>
                ...
                <p class="spstyle_p_small" style="text-align: justify;font-family: Arial Narrow;font-size: 11pt; font-style: normal;"><b>Note</b> : <i>Apabila pada saat surat ini diterima Bapak/Ibu telah melakukan transfer ke rekening kami, mohon untuk segera menghubungi kami, sehingga kami dapat melakukan pengecekan lebih lanjut.</i></p>
                </body>
                ';
        ...
        $tpl12 .= '</div>
                <p class="spstyle_p" ' . $style . '>
                Hormat Kami,</br>
                <b>PT CITRA MITRA RESPATI</b></br>
                <br/>
                <br/>
                <br/>
                <br/>
                <b><u>	NARARYA C SASTRAWINATA</u></b><br/>
				<!-- --------------------------------------<br/> -->
				Kuasa Direksi
				<br/><br/>
				Tembusan :
