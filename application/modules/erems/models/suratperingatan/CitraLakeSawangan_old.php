...
class Erems_Models_Suratperingatan_CitraLakeSawangan {
    ...
    public function getHTML($spke=null){
        ...
        '<style>
            ...
            $tpl3 = 
                'Bersama surat ini kami beritahukan kepada Bapak/Ibu selaku pembeli rumah <b>Blok  {{unit_number}} Citra Lake Sawangan</b>, bahwa berdasarkan catatan kami, Bapak/Ibu sampai dengan tanggal <b>{{tanggal_print_w}}</b> belum melaksanakan pembayaran atas angsuran yang telah jatuh tempo. Atas hal tersebut, total tunggakan yang harus diselesaikan menjadi sebagai berikut (dalam rupiah):
                </div>
                <br/>
                ...
                <table style="border:none;">
                    <tr style="border:none;">
                        ...
                        <td align="justify" style="border:none;">
                            Transfer ke : CITRA BANGUN CEMERLANG KSO a/c. 5445.555.999 BCA Cab.Citra Garden 2 Ext kalideres. Jakarta Barat. Mohon mencantumkan blok, no. rumah, dan nama pemesan pada kolom berita di slip transfer (bukti transfer mohon difax ke 6198213 Up. Ervinna/Regino dan segera ditukar dengan kwitansi Citra Lake Sawangan). atau
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" style="border:none;" width="1" align="left">b.</td>
                        <td align="justify" style="border:none;">
                            Membayar langsung ke kasir penerimaan City Management Office. Citra 2 Ext. Blok BG. 2A No. 01. Citra Garden City. Jakarta Barat dengan  cash. giro/cek jatuh tempo atau debit BCA. 
                        </td>

                    </tr>
                </table>
                <br/>
                Kami memberikan waktu sampai dengan tanggal <b>{{max_date_w}}</b> untuk penyelesaian pembayaran diatas. untuk penyelesaian pembayaran diatas. Untuk tindak lanjut penyelesaian dapat menghubungi petugas collection kami. sdri. <b>Ervinna/Regino</b> di no. telp. <b>(021) 6198177 ext. 712/713.</b>
                 <br/><br/>
