...
class Erems_Models_Suratperingatan_CitraPlazaNagoya {
	...
	public function getHTML($spke=null){
		$tgl_print = $this->tgl_indo(date('Y-m-d', strtotime("-2 day"))); //default 0 day
        ...
        '<style>
            ...
            $tpl2 = 
                'Berdasarkan <b>Surat Pemberitahuan 1</b> kami tanggal {{tgl_sp1}} No.{{sp1}}. Bersama surat ini kami beritahukan kepada Bapak/Ibu selaku pemesan Unit Apartemen CitraPlaza Nagoya yang terletak di Lantai/No <b>{{unit_number}} {{cluster}}</b> , bahwa berdasarkan catatan kami, angsuran Unit Apartemen Bapak/Ibu telah jatuh tempo sebesar (dalam rupiah) :</p>        
                        <br/>';

            $tpl3 = 
                'Terima kasih atas kepercayaan Bapak/Ibu atas pemesanan Unit Apartment CitraPlaza Nagoya yang terletak di Lantai <b>{{unit_number}} {{cluster}}</b> bahwa berdasarkan catatan kami, angsuran Unit Apartemen Bapak/Ibu telah jatuh tempo sebesar (dalam rupiah) :
                        </p>        
                        ';
						
			$tpl4 = 
                'Berdasarkan <b>Surat Pemberitahuan 2</b> kami tanggal {{tgl_sp2}} No.{{sp2}}, Bersama surat ini kami beritahukan kepada Bapak/Ibu selaku pemesan Unit Apartemen CitraPlaza Nagoya yang terletak di Lantai/No <b>{{unit_number}} {{cluster}}</b>, bahwa berdasarkan catatan kami, angsuran Unit Apartemen Bapak/Ibu telah jatuh tempo sebesar (dalam rupiah) :</p>        
                        <br/>';
			
			$tpl5 ='Menindaklanjuti <b>Surat Pemberitahuan 3</b> kami tanggal {{tgl_sp3}} No.{{sp3}}, bersama ini kami beritahukan kepada Bapak/Ibu selaku pembeli unit <b>{{unit_number}} {{cluster}}</b> , cluster {{cluster}},bahwa pemesanan rumah tersebut menjadi <b>batal.</b>
			<br/><br/>
			...
			Sehubungan dengan hal diatas, mohon Bapak/Ibu dapat segera melakukan pembayaran paling lambat pada tanggal {{max_date_w}} dengan cara transfer ke virtual account mandiri atas nama : <b>CITRAPLAZA NAGOYA a/c. {{va_mandiri}} </b><br>Bukti transfer mohon :
				...
				<p>
				a.	Diinfokan melalui wa ke <b>081381070933 Up. Venesia.</b><br>
				...
				<p>Untuk tindak lanjut penyelesaian dapat menghubungi petugas collection kami, sdri. <b>Venesia</b> di no. telp. <b>021-6198177 ext. 742.</b></p>
							';
