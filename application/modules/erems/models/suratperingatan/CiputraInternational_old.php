...
class Erems_Models_Suratperingatan_CiputraInternational
{
    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tpl7 = '
        Berdasarkan hal tersebut diatas, maka kami mohon Bapak/Ibu untuk segera melakukan pelunasan atas total tunggakan , paling lambat tanggal 2 September 2021 ke rekening : <br/>
