 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Suratperingatan_CitraGardenCityMalang
{
    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tpl1 =
            '<style>
				...
				<br/>
				<br/>
                <p class="spstyle_p">Malang,' . $tgl_print . '</p>
        ...
        $tpl5 = 'Sesuai dengan Informasi pesan singkat (via WA) tertanggal ' . $tgl_print . ' yang kami <b>( Lusi Collection )</b> terima dari Sales Marketing 
            ...
            Untuk keterangan lebih jelas bisa menghubungi petugas Collection kami, <b>sdri Vera</b> di pesawat <b>(0341) 751501-03<b/>.<br/>
            <br>
			<br>
        ...
        $tpl8 = 'Untuk tindak lanjut penyelesaian dapat menghubungi petugas Collection kami, <b>sdri Vera</b> di pesawat <b>(0341) 751501-03.</b>
					<br/><br/>
        ...
        $tpl9 = '<style>
				...
				<br/>
				<br/>
                <p class="spstyle_p">Malang, <b>' . $tgl_print . '</b></p>
		...
		<br/>
		<br/>
			Untuk tindak lanjut penyelesaian dapat menghubungi petugas Collection kami, <b>sdri Vera</b> di pesawat <b>(0341) 751501-03</b>.
