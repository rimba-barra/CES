...
class Erems_Models_Suratperingatan_CitraWinagunManado {
	...
	public function getHTML($spke=null){
        ...
        elseif($spke==3){
            $tpl = $tpl1.$tpl4.$tpl6.$tpl8.$tpl10;
        }
        elseif($spke==4){
            $tpl = $tpl1.$tpl5.$tpl9.$tpl10;
        }else{
            $tpl = $tpl1.$tpl3.$tpl6.$tpl7.$tpl10;
        }
