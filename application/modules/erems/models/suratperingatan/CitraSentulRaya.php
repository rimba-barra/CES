    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tpl1 =
            '<style>
				...
				<br/>
				<br/>
                <p class="spstyle_p">Bogor,' . $tgl_print . '</p>
        ...
        $tpl5 = 'Sesuai dengan Informasi pesan singkat (via WA) tertanggal ' . $tgl_print . ' yang kami <b>( ' . $data['pic_collection'] . ' Collection )</b> terima dari Sales Marketing 
			...
			<br/>
            Untuk keterangan lebih jelas bisa menghubungi petugas Collection kami, <b>sdr ' . $data['pic_collection'] . '</b> di pesawat <b>22596888, 22596999 ext 240<b/>.<br/>
            <br/>
			<br/>
        ...
        $tpl6 = '
			...
			Sehubungan dengan hal diatas, mohon Bapak/Ibu dapat segera melakukan pembayaran paling lambat tanggal <b>{{max_date_w}}</b> dengan cara:	
				...
				• &nbsp;&nbsp;Untuk pembayaran langsung ke kasir penerimaan kantor pemasaran Citra Sentul Raya :</b><br/>
					&nbsp;&nbsp;&nbsp;a)Pembiayaan Inhouse/Cash dengan Giro/Cek jatuh tempo. Kartu Debit atau Kartu (dikenakan biaya administrasi sesuai ketentuan yang berlaku).</b><br/>
					&nbsp;&nbsp;&nbsp;b) Pembiayaan KPR dengan Giro/Cek jatuh tempo, atau Kartu Debit atas nama pemesan atau suami/istri (dikenakan biaya administrasi sesuai ketentuan yang berlaku).<br/></br>
        ...
        $tpl8 = 'Untuk tindak lanjut penyelesaian dapat menghubungi petugas Collection kami, <b>sdr ' . $data['pic_collection'] . '</b> di 021-84202323 <b>(ext 114).Atau WA 0813-2385-2992</b>
					<br/><br/>
            Demikian hal ini kami sampaikan, atas perhatian dan kerjasama yang baik dari Bapak/Ibu kami ucapkan terima kasih. ';
        ...
        $tpl11 = '</div>
                ...
                <br/>
                <br/>
                <b><u>Murtri Dadi</u></b><br/>
				<!-- --------------------------------------<br/> -->
				Deputy GM Fin. & Acc
				<!--{{salesman_name}} (Sales)<br/>-->
                </p>

                <p class="spstyle_p_small"><b>Note</b> : <i>Apabila pada saat surat ini diterima ternyata Bapak/Ibu telah melakukan penyetoran ke rekening kami, mohon untuk diabaikan surat kami atau konfirmasi ke petugas collection kami <b>' . $data['pic_collection'] . '</b>., sehingga kami dapat melakukan pengecekan lebih lanjut.</i></p>
                </body>
                ';
        $tpl12 .= '</div>
                <!--<br/>--><br/>
