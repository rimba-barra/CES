 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Suratperingatan_TheNewton2
{
    ...
    public function getListTagihanHTML($params)
    {
		...
		// if($schedule[0]['duedate'] == '2021-04-10 00:00:00.000'){
			$duedate_awal = date('Y-m-d', strtotime("+200 day", strtotime($schedule[0]['duedate'])));
		// }else{
    ...
    public function getHTML($spke = null, $data)
    {
		...
		$tgl_print_max2 = $this->tgl_indo(date('Y-m-d', strtotime("+35 day", strtotime($tgl_print_duedate))));
        ...
        $tpl1 =
            '<style>
                ...
                <!--<p align="right" class="spstyle_p" style="width: 310px;">Kepada Yth, <br>
                    ...
                    {{customer_address}}</p>-->
                <p align="right" class="spstyle_p">Jakarta, <b>' . $tgl_print_duedate . '</b></p>
        ...
        $tpl3 =
            ...
            <table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="15">1.</td>
                        <td align="left" style="border:none;">Bahwa, sebelumnya Bapak/Ibu telah melakukan pemesanan atas Unit {{unit_number}} di Apartemen (The Newton 2) berdasarkan Formulir Pesanan Satuan Rumah Susun No. {{purchaseletter_no}} tertanggal {{tanda_tangan}} antara Bapak/Ibu {{customer_name}} dengan PT {{pt_initial}};</td>
                    </tr>
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="15">2.</td>
                        <td align="left" style="border:none;">Bahwa, bersama ini Kami/PT {{pt_initial}} memberitahukan kepada Bapak/Ibu selaku pemesan unit {{unit_number}}, bahwa berdasarkan catatan kami, Bapak/Ibu sampai dengan tanggal ' . $tgl_print_duedate . ' belum melaksanakan pembayaran angsuran yang telah jatuh tempo. Atas hal tersebut, total tunggakan yang harus diselesaikan menjadi sebagai berikut (dalam rupiah):</td>
                    </tr>
                </table><br/>
            ';        
        ...
        <table style="border:none;">
                ...
                <table style="border:none;">
                  ...
                  <tr style="border:none;">
                    ...
                    <td style="border:none;">: {{pt_rekening}}</td>
                  </tr>
                  <tr style="border:none;">
                    <td style="border:none;">&nbsp;&nbsp;&nbsp;</td>
				  ...
				  <tr style="border:none;">
                    <td style="border:none;">&nbsp;&nbsp;&nbsp;</td>
                    <td style="border:none;">&nbsp;&nbsp;Nomor Virtual Account</td>
                    <td style="border:none;">: {{va_bca}}</td>
                  </tr>
                </table><br/>
                Apabila Bapak/Ibu telah melakukan pembayaran sejumlah total  tunggakan tersebut di atas, maka kami mohon bantuan Bapak/Ibu untuk menginformasikan pembayaran tersebut kepada kami dengan mengirimkan bukti transfer bank melalui email collection.newton2@ciputra.com<br/>
        ...
        $tpl8 = '<table style="border:none;">
                ...
                Apabila Bapak/Ibu telah melakukan pembayaran atas total tunggakan di atas mohon mengabaikan Surat Peringatan ini dan menginformasikan pembayaran tersebut kepada kami dengan mengirimkan bukti transfer bank melalui e-mail: collection.newton2@ciputra.com<br/>
		...
		'<br/>
            ...
            <table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="15">1. </td>
                        <td align="left" style="border:none;" colspan=2>Bahwa, sebelumnya Kami/PT {{pt_initial}} telah mengirimkan kepada Bapak/Ibu Surat-Surat Peringatan sebagai berikut:</td>
                    </tr>
					
					<tr style="border:none;">
					<td valign="top" style="border:none;" width="15"></td>
						<td valign="top" style="border:none;" width="15">1.1.  </td>
                        <td align="left" style="border:none;">Surat No. (*) tertanggal (*) dengan perihal : Surat Peringatan-1;</td>
                    </tr>
					
					<tr style="border:none;">
					<td valign="top" style="border:none;" width="15"></td>
                        <td valign="top" style="border:none;" width="15">1.2.  </td>
                        <td align="left" style="border:none;">Surat No. (*) tertanggal (*) dengan perihal : Surat Peringatan-2.</td>
                    </tr>
                </table><br/>
				<table style="border:none;">
                     <tr style="border:none;">
                        <td valign="top" style="border:none;" width="15">2. </td>
                        <td align="left" style="border:none;" colspan=2>Bahwa, bersama ini Kami/PT {{pt_initial}} memberitahukan kepada Bapak/Ibu selaku pemesan unit {{unit_number}}, {{cluster}} The Newton 2, hingga surat ini diterbitkan masih terdapat tunggakan angsuran pembayaran atas Unit {{unit_number}} di Apartemen THE NEWTON 2 yang masih harus dibayar oleh Bapak/Ibu kepada Kami/PT {{pt_initial}} sebagai berikut: <br/></td>
                    </tr>
                </table><br/>
            ';        
	...
	$tpl15 = 
		'<br/>
            ...
            <table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="15">1. </td>
                        <td align="left" style="border:none;" colspan=2>Bahwa, sebelumnya Kami/PT {{pt_initial}} telah mengirimkan kepada Bapak/Ibu Surat No. {{purchaseletter_no}} tertanggal {{tanda_tangan}} dengan perihal : Surat Peringatan-1;</td>
                    </tr>
					 <tr style="border:none;">
                        <td valign="top" style="border:none;" width="15">2. </td>
                        <td align="left" style="border:none;" colspan=2>Bahwa, bersama ini Kami/PT {{pt_initial}} memberitahukan kepada Bapak/Ibu selaku pemesan unit {{unit_number}}, {{cluster}} The Newton 2, hingga surat ini diterbitkan masih terdapat tunggakan angsuran pembayaran atas unit {{unit_number}} di Apartemen The Newton 2 yang masih harus dibayarkan oleh Bapak/Ibu kepada Kami/PT {{pt_initial}}, sebagai berikut: <br/></td>
                    </tr>
                </table><br/>
            ';    
	$tpl81 = '<table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">3. </td>
                        <td align="justify" style="border:none;" >
                            Bahwa, pada poin nomor 10 dalam syarat dan ketentuan Keterlambatan Pembayaran dalam Formulir Pesanan Satuan Rumah Susun Tower {{cluster}} @ Citra Landmark Southeast Jakarta disebutkan sebagai berikut:<br/>
				...
				<table style="border:none;">
                    <tr style="border:none;">
                        ...
                        <td align="justify" style="border:none;" >
                            Apabila Bapak/Ibu telah melakukan pembayaran atas total tunggakan di atas mohon mengabaikan Surat Peringatan ini dan menginformasikan pembayaran tersebut kepada kami dengan mengirimkan bukti transfer bank melalui e-mail: collection.newton2@ciputra.com
                        </td>
                    </tr>
                </table>
				<br/>
				<table style="border:none;">
                    <tr style="border:none;">
                        ...
                        <td align="justify" style="border:none;" >
							Bahwa, apabila selambat-lambatnya pada tanggal ( ' . $tgl_print_max2 . ' ) Bapak/Ibu belum juga melakukan pembayaran kepada Kami/ PT CAB sebesar sebagaimana Kami/PT {{pt_initial}} sebutkan pada poin nomor 2, 3 dan 4 tersebut diatas, <b>maka Form Pemesanan No. {{purchaseletter_no}} tertanggal {{tanda_tangan}} dapat Kami/PT {{pt_initial}} batalkan sepihak dan seluruh pembayaran yang telah Bapak/Ibu bayarkan kepada Kami/PT {{pt_initial}} tidak dapat dikembalikan, serta Unit {{unit_number}} di Apartemen The Newton 2 sepenuhnya mutlak menjadi hak Kami/PT {{pt_initial}}, serta Kami/PT {{pt_initial}} dibebaskan dari upaya hukum perdata/pidana/upaya hukum apapun maupun upaya lainnya</b>
                        </td>
                    </tr>
                </table>
				<br/>
				<table style="border:none;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">   </td>
                        <td align="justify" style="border:none;" >
                            Adapun hal tersebut telah sesuai dengan ketentuan poin nomor (13) syarat dan ketentuan <i>(*tentang pembatalan sepihak*)</i> dalam Formulir pesanan disebutkan sebagai berikut:
                        </td>
                    </tr>
                </table>
				<br/>
                <table style="border:none;">
					<tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">   </td>
                        <td align="justify" style="border:none;" >
                            <i>Apabila PEMESAN membatalkan Formulir Pesanan ini dengan sebab dan alasan apapun juga, maka seluruh pembayaran yang telah diterima oleh PENERIMA PESANAN dari PEMESAN tidak dapat ditarik kembali (dikembalikan) dan menjadi hak sepenuhnya PENERIMA PESANAN.</i>
                        </td>
                    </tr>
                </table></br>
                Demikian Surat Peringatan-{{sp_surat_ke}} ini disampaikan. Atas perhatian dan kerjasamanya Kami ucapkan terima kasih.';
		...
		$tpl16 .= '</div>
                ...
                <!--<img src="https://ces.ciputragroup.com:73/webapps/Ciputra/public/app/main/images/ttd_romy_citralandmark.png" width="120" height="60">
                <img src="https://ces.ciputragroup.com:73/webapps/Ciputra/public/app/main/images/ttd_pak_ronny.jpeg" width="500" height="60">-->
                <br/>
                <b><u>ROMY LAWANDI</u></b>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <b><u>BENNY SURYAWIGUNA</u></b>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<b><u>PRABHAM WULUNG</u></b>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<b><u>ISABELLA CIPUTRA</u></b>
				</br>
                <!-- --------------------------------------<br/> -->
                Finance Controller
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        if ($spke == 1 && $sppjb_stts == 0) {
            ...
            $tpl = $tpl1 . $tpl15 . $tpl6 . $tpl8 . $tpl17;
        } elseif ($spke == 2 && $sppjb_stts == 1) {
            $tpl = $tpl1 . $tpl15 . $tpl6 . $tpl8 . $tpl17;
        } elseif ($spke == 3 && $sppjb_stts == 0) {
            $tpl = $tpl1 . $tpl14 . $tpl6 . $tpl81 . $tpl16;
