        ...
        $tpl3 =
            ...
            <table style="border:none;">
                    ...
                    <tr style="border:none;">
                        ...
                        <td align="left" style="border:none;">Bahwa, bersama ini Kami/PT {{pt_initial}} memberitahukan kepada Bapak/Ibu selaku pemesan unit {{unit_number}}, bahwa berdasarkan catatan kami, Bapak/Ibu sampai dengan tanggal ' . $tgl_ori . ' belum melaksanakan pembayaran angsuran yang telah jatuh tempo. Atas hal tersebut, total tunggakan yang harus diselesaikan menjadi sebagai berikut (dalam rupiah):</td>
                    </tr>
                </table><br/>
            ';        
        ...
        <table style="border:none;">
                ...
                <table style="border:none;">
                  ...
                  <tr style="border:none;">
                    ...
                    <td style="border:none;">: 5020.6655.66</td>
                  </tr>
                  <tr style="border:none;">
                    <td style="border:none;">&nbsp;&nbsp;&nbsp;</td>
