 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Suratperingatan_CitraRaya
{
    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $tpl5 = 'Sesuai dengan Informasi pesan singkat (via WA) tertanggal ' . $tgl_print . ' yang kami <b>( ' . $data['pic_collection'] . ' Collection )</b> terima dari Sales Marketing 
            ...
            Untuk keterangan lebih jelas bisa menghubungi petugas Collection kami, <b>sdr ' . $data['pic_collection'] . '</b> di pesawat <b>22596888, 22596999 ext ' . $data['sp_ext_pic'] . '<b/>.<br/>
            <br>
			<br>
        ...
        $tpl7 = 'Kami memberikan waktu sampai dengan tanggal <b>{{max_date_w}}</b> untuk penyelesaian pembayaran tunggakan diatas bersamaan dengan angsuran bulan berjalan. Untuk tindak lanjut penyelesaian dapat menghubungi petugas Collection kami, <b>sdr ' . $data['pic_collection'] . '</b> di pesawat <b>22596888, 22596999 ext 237.</b>
					<br/>
