 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Suratperingatan_CitraGardenBintaro
{
    ...
    public function getHTML($spke = null, $data)
    {
		...
		$tpl1 =
            '<style>
                ...
                <p class="spstyle_p">No.Ref	: ' . $nomor_sp_teratas . '<br/>
        ...
        $tpl6 = '
			...
			Sehubungan dengan hal diatas, mohon Bapak/Ibu dapat segera melakukan pembayaran dengan cara:	
				...
				<p>
				a. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Transfer melalui <b>Virtual Account {{va_bca}}</b> .Bukti transfer mohon difax ke (021) 6198213 Up. Sesilia (WA) 082310938358 /Eny (WA) 08128915293.dan segera ditukar dengan kuitansi di Citra Garden Bintaro, Marketing Office, Jl. Boulevard Citra Garden Bintaro D6, 001, Sawah Baru, Ciputat, Kota Tangerang Selatan, Banten, 15413<br/>
                b. Bukti Transfer/Pembayaran dapat ditukar Kwitansi 2 Minggu dari Tanggal Transaksi ke kasir CitraGarden Bintaro, Marketing Office, Jl. Boulevard D6, 001, Sawah Baru, Ciputat, Kota Tangerang Selatan di No. Telp 021-39718880.
				</p>
							';
        ...
        $tpl8 = 'Kami memberikan waktu sampai dengan tanggal <b>{{max_date_w}}</b> untuk penyelesaian pembayaran tunggakan diatas. Untuk tindak lanjut penyelesaian dapat menghubungi petugas collection kami, sdri.<b>Sesilia/Eny di No.Telp (021) 6198177 ext 115.</b>
					<br/><br/>
            Demikian hal ini kami sampaikan, atas perhatian dan kerjasama yang baik dari Bapak/Ibu kami ucapkan terima kasih. ';
        ...
        $tpl10 = 'Kami memberikan waktu sampai dengan tanggal <b>{{max_date_w}}</b> untuk penyelesaian pembayaran diatas. Apabila sampai dengan tanggal tersebut diatas Bapak/Ibu masih belum melunasinya, maka dengan sangat menyesal kami mengganggap Bapak/Ibu membatalkan pemesanan unit tersebut. <b>Keseluruhan uang</b> yang telah Bapak/Ibu bayarkan <b>tidak dapat dikembalikan.</b> Dengan demikian kami <b>berhak</b> menjual kembali unit tersebut kepada pihak lain.
			<br>
			Untuk tindak lanjut penyelesaian dapat menghubungi petugas Collection kami, di no. telp. <b>6198177 ext. 712/710 Ervinna/Yuriene.</b>
		...
		$tpl13 .= ', kami tegaskan kepada Bapak/Ibu selaku pembeli rumah: <br></br>
					...
					Lokasi: Citra Garden Bintaro Tangerang, Blok {{unit_number}}
