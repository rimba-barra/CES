...
class Erems_Models_Suratperingatan_CiputraInternational
{
    ...
    public function getHTML($spke = null, $data)
    {
        ...
        $b = (int)($a[0]);
        if (substr($b, 0, 1) == "0") {
            $nomor_sp_teratas = str_replace("SP-T2",$data["cluster_code"],$data["nomor_terakhir"]);
        }
		// echo $data["cluster_code"]," X ","SP-T2"," X ",$data["nomor_terakhir"];
            ...
            '<style>
                ...
                <table style="border:none;font-family: Arial;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="350" align="right"></td>
				...
				<p align="left" class="spstyle_p"><b>No. Ref : ' . $nomor_sp_teratas . '</b><br/>
                <b>Perilhal : Surat  Peringatan {{sp_surat_ke}} ({{sp_surat_ke_new}})</b></p>
		...
		$tpl111 =
            '<style>
                ...
                <p align="left" class="spstyle_p">Jakarta, <b>' . $tgl_print_sp4 . '</b></p><br><br><br>
				<p align="left" class="spstyle_p"><b>No. Ref : ' . $nomor_sp_teratas . '</b><br/><br/>
				<b>Perilhal : Pembatalan Perjanjian Pengikatan Jual Beli No. {{sppjb_no}} tanggal {{sppjb_date}} unit {{unit_number}} {{cluster_desc}} - Ciputra International atas nama {{customer_name}}</b></p><br/><br/>
		...
		$tpl1111 =
            '<style>
                ...
                <p align="left" class="spstyle_p">Jakarta, <b>' . $tgl_print_sp4 . '</b><br>
				No. Ref : <b>' . $nomor_sp_teratas . '</b><br/></p><br/>
				<b>Perilhal : Pembatalan Formulir Pesanan No. {{purchaseletter_no}} tanggal {{tanda_tangan}} unit {{unit_number}} {{cluster_desc}} - Ciputra International atas nama {{customer_name}}</b></p><br/><br/>
        ...
        Berdasarkan hal tersebut diatas, maka kami mohon Bapak/Ibu untuk segera melakukan pelunasan atas total tunggakan , paling lambat tanggal ' . $tgl_print_tempo . ' ke rekening : <br/>
                ...
                <table style="border:none;font-family: Arial;width=100%">
                  <tr style="border:none;">
                  ...
                  <tr style="border:none;">
                    ...
                    <td style="border:none;">&nbsp</b></td>
                  </tr>
                  <tr style="border:none;">
                    <td style="border:none;">&nbsp;&nbsp;&nbsp;</td>
                    <td style="border:none;">&nbsp;&nbsp;<b>No Rekening</b></td>
                    <td style="border:none;">: <b>'.$data['va_mandiri'].'</b></td>
                  </tr>
                  <tr style="border:none;">
                    <td style="border:none;">&nbsp;&nbsp;&nbsp;</td>
                    <td style="border:none;">&nbsp;&nbsp;<b>Bank</b></td>
                    <td style="border:none;">: <b>Bank Mandiri</b></td>
                  </tr>
                  <tr style="border:none;">
                    <td style="border:none;">&nbsp;</td>
                    <td style="border:none;">&nbsp;</b></td>
                  ...
                  <tr style="border:none;">
                    <td style="border:none;">&nbsp;&nbsp;&nbsp;</td>
                    <td style="border:none;">&nbsp;&nbsp;<b>No Rekening</b></td>
                    <td style="border:none;">: <b>'.$data['va_permata'].'</b></td>
                  </tr>
                  <tr style="border:none;">
                    <td style="border:none;">&nbsp;&nbsp;&nbsp;</td>
                    <td style="border:none;">&nbsp;&nbsp;<b>Bank</b></td>
                    <td style="border:none;">: <b>Bank Permata</b></td>
                  </tr>
                </table><br/>
                Apabila Bapak/Ibu telah melakukan pembayaran sejumlah total  tunggakan tersebut di atas, maka kami mohon bantuan Bapak/Ibu untuk menginformasikan pembayaran tersebut kepada kami dengan mengirimkan bukti transfer bank melalui email vina.pardede@ciputra.com<br/>
		...
		$tpl71 = '<table style="border:none;font-family: Arial;">
                  ...
                  <tr style="border:none;">
					...
					<tr style="border:none;">
                        ...
                        <td align="justify" style="border:none;">
						Apabila Bapak/Ibu telah melakukan pembayaran/transfer, mohon Bapak/Ibu melakukan konfirmasi kepada Vina Pardede di nomor telepon 021 - 21500101 atau melalui email vina.pardede@ciputra.com, disertai dengan lampiran bukti pembayaran/transfer. <br/>
						</td>
                    </tr>
					<tr style="border:none;">
        ...
        $tpl9 = '<style>
                ...
                <p align="left" class="spstyle_p">Jakarta, <b>' . $tgl_print . '</b><br>
				No. Ref : <b>' . $nomor_sp_teratas . '</b><br/></p><br/>
				<b>Perilhal : Pembatalan Formulir Pesanan No. {{purchaseletter_no}} tanggal {{tanda_tangan}} unit {{unit_number}} {{cluster_desc}} -Ciputra International atas nama PT. VIGOUR INDO PROPERTI</b></p><br/><br/>
        ...
        $tpl10 = '<table style="border:none;font-family: Arial;">
                ...
                <table style="border:none;font-family: Arial;">
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">3. </td>
                        <td align="justify" style="border:none;">
                            Apabila Bapak/Ibu telah melakukan pembayaran/transfer , mohon Bapak/Ibu melakukan konfirmasi kepada Vina Pardede di nomor telepon 021-21500101 atau melalui email vina.pardede@ciputra.com, disertai dengan  lampiran bukti pembayaran/transfer.
                        </td>
                    </tr>
                    <tr style="border:none;">
                        <td valign="top" style="border:none;" width="1" align="left">4. </td>
