...
class Erems_Models_Suratperingatan_CitraLiving {
	...
	public function getHTML($spke=null,$data){
        ...
        '<style>
			...
			$tpl5 ='<p style="font-family: Arial Narrow;font-size: 11pt; font-style: normal; text-align: justify;">Menindaklanjuti <b>Surat Peringatan 3</b> kami tanggal {{tgl_sp3}} No.{{sp3}}, 
			...
			$tpl7 ='<p style="text-align: justify;">Untuk tindak lanjut penyelesaian dapat menghubungi petugas collection kami, sdri Devi di no. telp. 021-6198177 ext.740
					<br/>
			'.$page_break.'
