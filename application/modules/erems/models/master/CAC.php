 ...
 * @author TOMMY-MIS
 */
class Erems_Models_Master_CAC extends Erems_Box_Models_ObjectEmbedData implements Erems_Box_Kouti_Remora,Erems_Box_Models_Master_InterProjectPt {
    private $project;
    private $pt;
    private $code;
    private $name;
    ...
    public function setArrayTable($dataArray = NULL) {
        ...
        if(isset ($x['useradd'])){
           $this->setUseradd($x['useradd']); 
        }
        if(isset ($x['useredit'])){
           $this->setUseredit($x['useredit']); 
        }
    ...
    public function getAddon() {
        return date("d-m-Y",strtotime($this->Addon));
    }
    ...
    public function getModion() {
        return date("d-m-Y",strtotime($this->Modion));
    }
