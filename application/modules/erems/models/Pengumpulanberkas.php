...
class Erems_Models_Pengumpulanberkas extends Zend_Db_Table_Abstract {
    ...
    function pengumpulanberkasRead($param) {
	$return['success'] = false;
		...
		$result = $this->execSP3('sp_pengumpulanberkas_read', $data);
    ...
    function pengumpulanberkasCreate($param = array()) {
        if (is_array($param) && count($param)) {
            ...
            try {
                $result = $this->execSP3('sp_pengumpulanberkas_create', 
    ...
    function pengumpulanberkassprCreate($param = array()) {
//        var_dump($this->session->getCurrentProjectId()); die();
    //    var_dump($param);die();
        if (is_array($param) && count($param)) {
            ...
            try {
                $result = $this->execSP3('sp_pengumpulanberkasspr_create', 
					$param['purchaseletter_id'],
    ...
    function pengumpulanberkasUpdate($param = array()) {
...
//            var_dump($param['berkas_group_menu']); die();
            ...
            try {
                $result = $this->execSP3('sp_pengumpulanberkas_update',
                                        $param['berkas_surat_id'],
                                        $param['purchaseletter_id'],
                                        $param['berkas_no'],
					$param['berkas_date'],
    ...
    function pengumpulanberkasDelete($param) {
	$return['success'] = false;
        if (is_array($param) && count($param)) {
                ...
                try {
                        $affectedRow = $this->execSP('sp_pengumpulanberkas_destroy', $param[$key_name], $this->session->getUserId());
	...
	$return['success'] = false;
		...
		$result = $this->execSP3('sp_pengumpulanberkas_genmaster_read', $data);
                $return['total'] = $result[0][0]['RECORD_TOTAL'];
                $return['data'] = $result[1];
                $return['success'] = true;
            } catch (Exception $e) { /* var_dump($e->getMessage()); */
	...
	$return['success'] = false;
		...
		$result = $this->execSP3('sp_pengumpulanberkasspr_read', $data);
                $return['total'] = $result[0][0]['RECORD_TOTAL'];
                $return['data'] = $result[1];
                $return['success'] = true;
            } catch (Exception $e) { /* var_dump($e->getMessage()); */
	...
	$return['success'] = false;
		...
		$result = $this->execSP3('sp_pengumpulanberkasdetail_read', $data);
                $return['total'] = $result[0][0]['RECORD_TOTAL'];
                $return['data'] = $result[1];
                $return['success'] = true;
            } catch (Exception $e) { /* var_dump($e->getMessage()); */
	...
	$return['success'] = false;
		...
		$result = $this->execSP3('sp_pengumpulanberkas_sprdetail_read', $data);
                $return['total'] = $result[0][0]['RECORD_TOTAL'];
                $return['data'] = $result[1];
                $return['success'] = true;
            } catch (Exception $e) { /* var_dump($e->getMessage()); */
	...
	$return['success'] = false;
		...
		$result = $this->execSP3('sp_pengumpulanberkas_sprindex_read', $data);
//                $return['total'] = $result[0][0]['RECORD_TOTAL'];
                $return['data'] = $result;
                $return['success'] = true;
            } catch (Exception $e) { /* var_dump($e->getMessage()); */
	...
	$return['success'] = false;
		...
		$result = $this->execSP3('sp_pengumpulanberkas_sprdetailview_read', $data);
//                $return['total'] = $result[0][0]['RECORD_TOTAL'];
...
//        var_dump($param);die();
        if (is_array($param) && count($param)) {
                try {
                        $result = $this->execSP2('sp_pengumpulanberkas_printout_read',
                                        $param['berkas_surat_id'],
                                        $this->session->getUserId()
                        );
    ...
    function printspr1outRead($param) {
        ...
        if (is_array($param) && count($param)) {
                try {
                        $result = $this->execSP2('sp_pengumpulanberkasspr1_printout_read',
                                        $param['berkas_spr_id'],
                                        $this->session->getUserId()
                        );
                        $return['data'] = $result;
...
//        var_dump($param);die();
        if (is_array($param) && count($param)) {
                try {
                        $result = $this->execSP2('sp_pengumpulanberkasspr2_printout_read',
                                        $param['berkas_spr_id'],
                                        $this->session->getUserId()
                        );
...
//        var_dump($param);die();
        if (is_array($param) && count($param)) {
                try {
                        $result = $this->execSP2('sp_pengumpulanberkasspr3_printout_read',
                                        $param['berkas_spr_id'],
                                        $this->session->getUserId()
                        );
...
//        var_dump($param);die();
        if (is_array($param) && count($param)) {
                try {
                        $result = $this->execSP2('sp_pengumpulanberkas_pembatalan_read',
                                        $param['berkas_spr_id'],
                                        $this->session->getUserId()
                        );
//                        var_dump($result);die();
	...
	$return['success'] = false;
		...
		$result = $this->execSP3('sp_pengumpulanberkas_lastdateum_read', $data);
//                $return['total'] = $result[0][0]['RECORD_TOTAL'];
//                var_dump($result[0]); die();
                $return['data'] = $result[0];
                $return['success'] = true;
    ...
    function cekparametergenerate($param) {
        $return['success'] = false;
        if (is_array($param) && count($param)) {
            try {
                $data = array(
                ...
                $result = $this->execSP3('sp_pengumpulanberkas_cekparametergenerate', $data);
//                $return['total'] = $result[0][0]['RECORD_TOTAL'];
            //    var_dump($result); die();
                $return['data'] = $result;
                $return['success'] = true;
