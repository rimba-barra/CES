...
class Erems_Models_Masterdeletereason extends Zend_Db_Table_Abstract
{
	protected $_schema = 'erems';
	protected $_name = 'm_deletereason';
	protected $session;
	...
	function masterdeletereasonRead($param)
	{
		...
		{
			try {		
				$resultcount = $this->execSP('sp_deletereason_count');
				$resultdata = $this->execSP('sp_deletereason_read');
