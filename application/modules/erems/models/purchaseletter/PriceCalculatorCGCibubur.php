 ...
 * @author MIS
 */
class Erems_Models_Purchaseletter_PriceCalculatorCGCibubur {
    ...
    private function getTotal() {
        ...
        $total = ($hargaJual+$this->purchaseLetter->getPriceAdmin()->getPrice()+$this->purchaseLetter->getPriceAdmin()->getPaketTambahan() + $this->purchaseLetter->getPriceAdmin()->getAsuransi()) - ($adminDiscount + $this->purchaseLetter->getPriceAdmin()->getSubsidi());
