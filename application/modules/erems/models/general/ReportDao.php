 ...
 * @author TOMMY-MIS
 */
class Erems_Models_General_ReportDao extends Erems_Box_Models_App_AbDao {
...
// $hasil = $this->dbTable->SPExecute('sp_reportstockme_read',$project,$pt,$cluster);
	...
	public function escrow($project, $dataBot, $dateTop, $bank, $lunas, $jatuhTempo) {
		$hasil = array();

		$hasil = $this->dbTable->SPExecute('sp_reportescrowkpr_read', $project, $dataBot, $dateTop, $bank, $lunas, $jatuhTempo);
