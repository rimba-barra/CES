...
class Erems_PopupunitspkController extends Erems_Models_App_Template_AbstractMasterController {
...
//                    $clusterId,$blockId,$customerName,$unitNumber,$data["today_plus"],$params["page"],25);
        ...
        $ps = new Erems_Models_Popupunitspk_ExportExcel($this->getAppSession()->getProject()->getId(), $this->getAppSession()->getPt()->getId());
        $ps->process($hasil[1]);
