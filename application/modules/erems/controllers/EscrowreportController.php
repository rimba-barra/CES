...
class Erems_EscrowreportController extends Erems_Box_Models_App_Hermes_AbstractController {
	...
	public function excelRead() {
		...
		$escrow = $dao->escrow($projectId, $variables["periode_startdate"], $variables["periode_enddate"], $variables["bank_id"], $variables["Statuslunas"], $variables["periode_jatuh_tempo"]);
		...
		$jsonExcel->fileTemplate = APPLICATION_PATH . '/../public/app/erems/uploads/exceltemplate/ReportEscrow.xlsx';
