...
class Erems_MastertypeController extends Erems_Models_App_Controller {
    ...
    function readAction() {
       ...
       // $app = new Erems_Models_App_Models_ReadWorms($this,"read_all");
        ...
        switch ($mr){
            case "all":
                $typeDataList = new Erems_Models_App_DataListCreator('', 'typetran', array("clusterb","productcategory"),array("typeattribute","deletedRows"));
                ...
                break;
            case "detail":
                $typeDataList = new Erems_Models_App_DataListCreator('', 'typeattribute', array('attribute','attributevalue'));
               ...
               // $hasil = array();
                ...
                break;
            case "attribute":
                $typeDataList = new Erems_Models_App_DataListCreator('', 'attribute', array());
               ...
               // $hasil = array();
                ...
                break;
            case "attributevalue":
                $typeDataList = new Erems_Models_App_DataListCreator('', 'attributevalue', array('attribute'));
               ...
               // $hasil = array();
                ...
                break;
            case "cluster":
                $dl = new Erems_Models_App_DataListCreator('', 'clusterb', array());
            ...
            case "productcategory":
                $dl = new Erems_Models_App_DataListCreator('', 'productcategory', array());
                $app->registerDataList('attribute', $dl);
