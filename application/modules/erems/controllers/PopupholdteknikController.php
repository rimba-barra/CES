...
class Erems_PopupholdteknikController extends Erems_Models_App_Template_AbstractMasterController {
...
//                    $clusterId,$blockId,$customerName,$unitNumber,$data["today_plus"],$params["page"],25);
             ...
             $hasil = $dao->getPopupHoldTeknikPage(
                    $this->getAppRequest(),
                    $this->getAppSession()->getProject()->getId(),
                    $this->getAppSession()->getPt()->getId(),
                    $unitNumber,
        ...
        $ps = new Erems_Models_Popupholdteknik_ExportExcel($this->getAppSession()->getProject()->getId(), $this->getAppSession()->getPt()->getId());
        $ps->process($hasil[1]);
...
//                    $clusterId,$blockId,$customerName,$unitNumber,$data["today_plus"]);
            ...
            $hasil = $dao->getPopupHoldTeknikAll(
                    $this->getAppRequest(),
                    $this->getAppSession()->getProject()->getId(),
                    $this->getAppSession()->getPt()->getId(),
                    $unitNumber
