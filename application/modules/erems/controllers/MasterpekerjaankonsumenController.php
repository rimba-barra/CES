...
class Erems_MasterpekerjaankonsumenController extends Zend_Controller_Action
{
	protected $model;
	...
	function init()
	{
		...
		$this->model = new Erems_Models_Masterpekerjaankonsumen();
	}
	...
	{
		$report_fn = 'report_master_masterpekerjaankonsumen.mrt';
