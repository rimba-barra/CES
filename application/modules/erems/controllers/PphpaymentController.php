...
class Erems_PphpaymentController extends Zend_Controller_Action
{
	protected $model;
	...
	function init()
	{
		...
		$this->model = new Erems_Models_Pphpayment();
	}
	...
	function paymentlistreadAction()
	{
		$this->result = $this->model->dataPaymentListRead($this->getRequest()->getPost());
		echo Zend_Json::encode($this->result);
		$this->_helper->viewRenderer->setNoRender(true);
	}
	...
	{
		$report_fn = 'report_pphpayment.mrt';
