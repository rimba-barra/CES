...
class Erems_ReportescrowdetailController extends Zend_Controller_Action {
	...
	function exportAction() {
		...
		$model = new Erems_Models_Reportescrowdetail();
		...
		$post_data['radio_statuspencairan'] = $this->getRequest()->getPost('radio_statuspencairan');
		$post_data['radio_statuslunas'] = $this->getRequest()->getPost('radio_statuslunas');

		// added by rico 10082023
		$post_data['purchase_start_date'] = $this->getRequest()->getPost('purchase_start_date');
		$post_data['purchase_end_date'] = $this->getRequest()->getPost('purchase_end_date');
		$post_data['cair_start_date'] = $this->getRequest()->getPost('cair_start_date');
		$post_data['cair_end_date'] = $this->getRequest()->getPost('cair_end_date');

		$result = $model->reportescrowdetailRead($post_data);
		...
		if (count($result) > 0) {
			...
			$fileResult = 'Report Escrow Detail_' . time() . '.xlsx';
