...
class Erems_MastertargetsalesrevisiController extends Zend_Controller_Action {
	...
	function init() {
		...
		$this->model = new Erems_Models_Mastertargetsalesrevisi();
	...
	function printAction() {
		$report_fn = 'report_master_mastertargetsalesrevisi.mrt';
	...
	function exportAction() {
		...
		if (count($resultdata) > 0) {
			$objPHPExcel->setActiveSheetIndex(0)
					...
					->setCellValue('A3', 'TARGET SALES REVISI')
