...
class Erems_CancelreportController extends Erems_Models_App_Controller {
    ...
    //  $app= new Erems_Models_App_Models_ReadWorms($this,"read_type");
        ...
        switch ($mr){
            case "cluster":
                ...
                break;
            case "cancelreason":
                $app->getMasterData(new Erems_Models_App_Masterdata_Table_CancelReason());
                break;
            case "type":
