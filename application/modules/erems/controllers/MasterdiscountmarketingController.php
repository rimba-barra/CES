...
class Erems_MasterdiscountmarketingController extends Zend_Controller_Action
{
	protected $model;
	...
	function init()
	{
		...
		$this->model = new Erems_Models_Masterdiscountmarketing();
	}
	...
	{
		$report_fn = 'report_master_masterdiscountmarketing.mrt';
