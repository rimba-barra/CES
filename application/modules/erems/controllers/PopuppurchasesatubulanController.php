...
class Erems_PopuppurchasesatubulanController extends ApliController {
    ...
    public function allRead() {
        ...
        $hasil = $dao->getAllXHariKebelakang($eremsReq,$sesBox, $pl,$params);
    ...
    public function exportRead() {
        ...
        $hasilData = Apli::prosesDao($dm->getDataList());
        $ps = new Erems_Models_Purchaseletter_ExportExcelPurchaseSatuBulan($session->getCurrentProjectId(), $session->getCurrentPtId());
        $ps->process($hasil[1]);
