...
class Erems_SpkcancelController extends Erems_Models_App_Controller {
      ...
      //  $app = new Erems_Models_App_Models_Create($this, "update_cancel");
        ...
        if ($spkTrn->getId() > 0) {
            ...
            if (!strtotime($spkTrn->getStatus()->getDate())) {
                ...
                $spkTrn->getStatus()->setName($statusConfig->get("cancel")->getName());
                ...
                if ($row > 0) {
                    ...
                    $msgEr = "Error when saving your data";
                }
            }
        }
