...
class Erems_PopupbayarpersenblmstController extends ApliController { 
    ...
    public function allRead() {
        ...
        $hasil = $dao->getAllPersenBayarBelumST($eremsReq,$sesBox, $pl,$params);
    ...
    public function exportAction(){
        ...
        $hasil = $dao->getAllExportPersenBayarBelumST($eremsReq,$sesBox, $pl,$params);
        ...
        if (count($hasil[1]) > 0) {
            ...
            $objPHPExcel->getProperties()->setTitle("PROGRESS KONTRUKSI, BAYAR >= 20% BELUM ST EREMS");
            $objPHPExcel->getProperties()->setSubject("PROGRESS KONTRUKSI, BAYAR >= 20% BELUM ST EREMS");
            $objPHPExcel->getProperties()->setDescription("PROGRESS KONTRUKSI, BAYAR >= 20% BELUM ST EREMS");
            ...
            $fileResult = 'List_progress_konstruksi_' . time() . '.xlsx';
