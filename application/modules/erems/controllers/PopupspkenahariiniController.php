...
class Erems_PopupspkenahariiniController extends ApliController {
    ...
    public function allRead() {
        ...
        $dataList = new Erems_Box_Models_App_DataListCreator('', 'schedule', array('cluster','block','scheduletype', 'sourcemoney','unitb','customer','payment'));
