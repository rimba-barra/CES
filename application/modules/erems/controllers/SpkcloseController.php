...
class Erems_SpkcloseController extends Erems_Box_Models_App_Hermes_AbstractController {
    ...
    public function savestRead() {

        $data = $this->getAppData();
        
        $dao = new Erems_Models_Spk_SpkDao();
        $spkTrn = new Erems_Models_Spk_SpkTransaction();
        $spkTrn->setId($data["spk_id"]);
        
        $serahterima_date1 = ($data["serahterima_date1"] == '') ? NULL: $data["serahterima_date1"];
        $serahterima_date2 = ($data["serahterima_date2"] == '') ? NULL: $data["serahterima_date2"];
        $serahterima_date3 = ($data["serahterima_date3"] == '') ? NULL: $data["serahterima_date3"];

        $spkTrn->setSerahTerimaDate1($serahterima_date1);
        $spkTrn->setSerahTerimaDate2($serahterima_date2);
        $spkTrn->setSerahTerimaDate3($serahterima_date3);

        $spkTrn->setSerahTerimaNote1($data["serahterima_note1"]);
        $spkTrn->setSerahTerimaNote2($data["serahterima_note2"]);
        $spkTrn->setSerahTerimaNote3($data["serahterima_note3"]);
        
        $hasil = $dao->updateSpkClose($spkTrn);
    ...
    protected function getDefaultProcessor() {
        return new Erems_Models_App_Box_SpkProcessor($this->testingFlag(),"CLOSE");
    }
