...
class Erems_PenerimaancollectionreportController extends Zend_Controller_Action {
	...
	function exportAction() {
		...
		$model = new Erems_Models_Penerimaancollectionreport();
		...
		if (count($result) > 0) {
			...
			$fileResult = $jdl . ' Report_' . time() . '.xlsx';
