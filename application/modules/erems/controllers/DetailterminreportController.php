...
class Erems_DetailterminreportController extends Zend_Controller_Action {
	...
	function exportAction() {
        ...
        $model = new Erems_Models_Detailterminreport();
		...
		$result = $model->detailterminreportRead($post_data);
		...
		if(count($result) > 0){
			...
			$fileResult = 'Detail Termin Schedule Report_'.time().'_'.$user_id.'.xlsx';
