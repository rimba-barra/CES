...
abstract class Erems_Box_Kouti_AbApp {
    ...
    public function setHasil(Erems_Box_Kouti_InterHasil $interHasil) {
        $this->hasil = $interHasil;
    }

    public function setSession(Erems_Box_Kouti_InterSession $interSession) {
    ...
    protected final function prosesZendSession() {
        ...
        $ourSes = $this->session;
        if ($ourSes instanceof Erems_Box_Kouti_InterSession) {
            if ($ses != NULL) {
