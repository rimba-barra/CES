 ...
 * @author MIS
 */
class Erems_Box_Models_App_Hermes_Processor {
    ...
    public function doRead(Erems_Box_Models_App_Hermes_AbstractController $controller) {
        $app = new Erems_Box_Models_App_Models_ReadWorms($controller, $this->getSampleData());
    ...
    public function doDelete(Erems_Box_Models_App_Hermes_AbstractController $controller) {
        $dataModel = NULL;
        ...
        // mark on 20190907
        /*
          $app = new Erems_Box_Models_App_Models_Delete($controller);
        ...
        if ($dao instanceof Erems_Box_Models_App_BlackHole) {
            $app = new Erems_Box_Models_App_Models_Delete($controller);
            $app->setIdProperty($dataModel->getIdProperty());
            $app->execute($dao);
            $app->run();
        }else{
            $app = new Erems_Box_Models_App_Models_DeleteWm($controller);
            $app->setIdProperty($dataModel->getIdProperty());
            $app->execute($dao);
            $app->run();
        }
