 ...
 * @author MIS
 */
abstract class Erems_Box_Models_App_Hermes_AbstractController extends Erems_Box_Models_App_Controller {
    ...
    /* @return Erems_Box_Models_App_Hermes_Processor
     * 
     */

    protected function getDefaultProcessor() {
        return new Erems_Box_Models_App_Hermes_Processor();
    }

    public function setApp(Erems_Box_Models_App_AbModel $app) {
        $this->app = $app;
    }
    ...
    protected function setArrayTable(Erems_Box_Kouti_Remora $remora, $data) {
