 ...
 * @author MIS
 */
class Erems_Box_Models_App_Models_ReadReport extends Erems_Box_Models_App_Models_ReadWorms {
    private $addedParams;
    private $ctrl;
    private $xUrl;
    ...
    public function doStandartInit() {
        $appDao = new Erems_Box_Models_Master_AppDao();
    ...
    /*@added 24 Maret 2014*/
    protected function processParams(Erems_Box_Models_Master_Pt $pt,  Erems_Box_Models_Master_Project $project){
