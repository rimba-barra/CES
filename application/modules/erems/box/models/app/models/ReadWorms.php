 ...
 * @author MIS
 */
class Erems_Box_Models_App_Models_ReadWorms extends Erems_Box_Models_App_AbModel {
    ...
    public function __construct($controller, $debug = '') {
        ...
        $this->hasil = new Erems_Box_Models_App_HasilReadExtraModel();
        parent::__construct($controller, $debug);
        $this->request = new Erems_Box_Models_App_HasilRequestRead($this->getData());
    }
        ...
        if (key_exists($name, $this->dataList)) {
            ...
            if (count($dataDao) > 0) {
                ...
                foreach ($dl->getList() as $row) {
                    /* added 23 Mei */
                    if($row instanceof Erems_Box_Models_App_InterInsertable){
    ...
    public function registerDataList($nama, Erems_Box_Kouti_AbDataList $dataList) {
    ...
    public function getMasterData(Erems_Box_Models_App_Masterdata_Main $main){
