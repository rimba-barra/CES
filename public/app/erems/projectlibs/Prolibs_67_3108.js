var Prolibs_67_3108 = Object.create(Prolibs);

Prolibs_67_3108.getScheduleCountAwal=function(){
        return -1; // mulai dari -1
};

Prolibs_67_3108.getBiayaBBNSertifikat = function (params) {
    var bbn = 0;
...
Prolibs_67_3108.getBiayaBAJB = function (params) {
...
Prolibs_67_3108.getBiayaBPHTB = function (params) {
     var hrgNetto = params.hrgNetto;
