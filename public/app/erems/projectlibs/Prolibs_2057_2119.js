var Prolibs_2057_2119 = Object.create(Prolibs);

Prolibs_2057_2119.getScheduleCountAwal = function () {
...
Prolibs_2057_2119.getBiayaBBNSertifikat = function (params) {
    var bbn = 0;
...
Prolibs_2057_2119.getBiayaBAJB = function (params) {		
    /* var hrgNetto = params.hrgNetto;
    var bajb = 0;	
    var totBiayaSurat = 0;
    var bphtb = 0;
...
Prolibs_2057_2119.getBiayaBPHTB = function (params) {
    var hrgNetto = params.hrgNetto;
    var BBNSertifikat = 0;
	var landSize = params.landSize;
    var landOverSize = params.landOverSize;
