var Prolibs_5104_6248 = Object.create(Prolibs);

Prolibs_5104_6248.getScheduleCountAwal = function () {
...
Prolibs_5104_6248.getBiayaBPHTB = function (params) {
	...
	console.log('1',(hrgNetto * 0.06));
	console.log('2',(BBNSertifikat));
	console.log('3',(bajb));
	console.log('4',(accounting.unformat(landSize)));
	console.log('5',(accounting.unformat(landOverSize)));
