var Prolibs_2056_3203 = Object.create(Prolibs);

Prolibs_2056_3203.getScheduleCountAwal = function () {
...
Prolibs_2056_3203.getBiayaBBNSertifikat = function (params) {
    var bbn = 0;
...
Prolibs_2056_3203.getBiayaBAJB = function (params) {		
    /* var hrgNetto = params.hrgNetto;
    var bajb = 0;	
    var totBiayaSurat = 0;
    var bphtb = 0;
...
Prolibs_2056_3203.getBiayaBPHTB = function (params) {
    var hrgNetto = params.hrgNetto;
    var BBNSertifikat = 0;
	var landSize = params.landSize;
    var landOverSize = params.landOverSize;
