var Prolibs_81_17 = Object.create(Prolibs);

Prolibs_81_17.getScheduleCountAwal = function () {
...
Prolibs_81_17.getBiayaBBNSertifikat = function (params) {
    var bbn = 0;
...
Prolibs_81_17.getBiayaBAJB = function (params) {		
    /* var hrgNetto = params.hrgNetto;
    var bajb = 0;	
    var totBiayaSurat = 0;
    var bphtb = 0;
...
Prolibs_81_17.getBiayaBPHTB = function (params) {
    var hrgNetto = params.hrgNetto;
    var BBNSertifikat = 0;
	var landSize = params.landSize;
    var landOverSize = params.landOverSize;
