Ext.define('Erems.library.Calculator', {
    ...
    calculate: function (element) {
        ...
        if (discountCollectionDesVal > 0.5) {
     ...
     //   console.log(discountCollection);
        ...
        var floorValTaxLand = Math.floor(tax.land.amount);
        var desimalValTaxLand = tax.land.amount - floorValTaxLand;

        var floorValTaxBuilding = Math.floor(tax.building.amount);
        var desimalValTaxBuilding = tax.building.amount - floorValTaxBuilding;

        var totalDesimalPPN = desimalValTaxLand + desimalValTaxBuilding;
        ...
        fee.total = discountCollection.total + floorValTaxLand + floorValTaxBuilding +
       ...
       // var diskonSalesAmount = Math.floor(discountSales.amount);
      //  discountSales.amount = diskonSalesAmount;
        
       // console.log(discountSales.amount);
        ...
        me.sv(me.fields._tot_ppn_tanah, floorValTaxLand);
        me.sv(me.fields._tot_ppn_bangunan, floorValTaxBuilding);
