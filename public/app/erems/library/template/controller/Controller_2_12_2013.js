Ext.define('Erems.library.template.controller.Controller', {
    ...
    panelAfterRender: function(el) {
        /*
         ...
         me.rights.create = !me.getGrid().down('#btnNew').isHidden();
         me.rights.update = !me.getGrid().down('#btnEdit').isHidden();
         me.rights.destroy = !me.getGrid().down('#btnDelete').isHidden();
         me.rights.print = !me.getGrid().down('#btnPrint').isHidden();
         el.down('actioncolumn').setVisible(me.rights.update || me.rights.destroy);
    ...
    gridItemDblClick: function(el) {
        ...
        var me = this, btnEdit = el.up('panel').down('#btnEdit'), state = (btnEdit.isVisible() && !btnEdit.isDisabled() ? btnEdit.bindAction : 'show');
