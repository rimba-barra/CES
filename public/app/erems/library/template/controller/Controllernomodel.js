Ext.define('Erems.library.template.controller.Controllernomodel', {
    ...
    getFormProperties: function(el, act, action) {
        ...
        if (typeof action !== 'undefined') {
            ...
            var founded = false;
            if (grid) {
                if(grid.down('actioncolumn') != null){
    ...
    formDataShow: function(el, act, action) {
        ...
        if(me.checkFileExist(file)){
            ...
            var width = winId == 'win-mastertypewinId' ? 800 : me.formWidth;
