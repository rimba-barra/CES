...
Ext.define('Erems.library.box.view.Grid', {
    extend: 'Ext.grid.Panel',
    loadStore: [],
    bindPrefixName: 'Controllername',
    requires:['Erems.library.box.StoredElement'],
    loadedStore: {},
    columnLines: true,
    // store: 'Holiday',
    ...
    generateContextMenu: function() {
        console.log('generateContextMenu box view')
    ...
    doInit:function(){
        var me = this;
        if(!me.storedElement){
            me.storedElement = new Erems.library.box.StoredElement({
                el:this
            });
        }
