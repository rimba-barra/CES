Ext.define('Erems.library.box.tools.Date', {
    date:null,
    date_old:null,
    lebih:null,
    ...
    addMonth:function(jumlah){
        ...
        month = month+jumlah;
            var lebih = Erems.library.box.tools.Date.lebih;
            ...
            if(Erems.library.box.tools.Date.lebih) {
                var me = this;
                var date = new Date(me.date);
                var today = date.getDate(); 
                var month = date.getMonth();
                var year = date.getFullYear();
                var lebihhari = today + Erems.library.box.tools.Date.lebih;
                ...
                Erems.library.box.tools.Date.lebih = null;
            }
            else {
                ...
                if(today == 29 || today == 30) {
                    if(month == 01 || month == 1) {
                        if (kabisatGa(year) == true) {
                            ...
                            Erems.library.box.tools.Date.lebih =  today - harikabisat;
                        }
                        else {
                            var lebih;
                            var harikabisat = 28;
        ...
        date.setMonth(month);
                    ...
                    if(month == 01 || month == 1) {
                        ...
                        if(month > 11){
                            ...
                            Erems.library.box.tools.Date.lebih =  31 - today_newdate;
                        }
                        else {
                            date.setFullYear(year,month+1, 0);
                            var newdate = new Date(year,month+1, 0);
