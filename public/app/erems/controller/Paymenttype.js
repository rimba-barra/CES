Ext.define('Erems.controller.Paymenttype', {
    extend: 'Erems.library.template.controller.Controller',
    alias: 'controller.Paymenttype',
    views: ['paymenttype.Panel', 'paymenttype.Grid', 'paymenttype.FormSearch', 'paymenttype.FormData'],
    stores: ['Paymenttype'],
    models: ['Paymenttype'],
    refs: [
        {
            ref: 'grid',
            selector: 'paymenttypegrid'
        },
        {
            ref: 'formsearch',
            selector: 'paymenttypeformsearch'
        },
        {
            ref: 'formdata',
            selector: 'paymenttypeformdata'
        }
    ],
    controllerName: 'paymenttype',
    ...
    init: function(application) {
        ...
        this.control({
            ...
            'paymenttypegrid toolbar button[action=create]': {
                click: function() {
                    this.formDataShow('create');
                }
            },
            'paymenttypegrid toolbar button[action=update]': {
                click: function() {
                    this.formDataShow('update');
                }
            },
            'paymenttypegrid toolbar button[action=destroy]': {
                click: this.dataDestroy
            },
            'paymenttypegrid toolbar button[action=print]': {
                click: this.dataPrint
            },
            'paymenttypegrid actioncolumn': {
                afterrender: this.gridActionColumnAfterRender,
                click: this.gridActionColumnClick
            },
            'paymenttypeformsearch button[action=search]': {
                click: this.dataSearch
            },
            'paymenttypeformsearch button[action=reset]': {
                click: this.dataReset
            },
            'paymenttypeformdata': {
                afterrender: this.formDataAfterRender
            },
            'paymenttypeformdata button[action=save]': {
                click: this.dataSave
            },
            'paymenttypeformdata button[action=cancel]': {
    ...
    dataSave: function() {
        ...
        if(form.getValues().code == '' || form.getValues().paymenttype == ''){
            Ext.Msg.show({
                title: 'Warning',
                msg: 'Code or Payment Type is empty.',
                icon: Ext.Msg.ERROR,
                buttons: Ext.Msg.OK
            });
        }else{
