Ext.define('Erems.controller.Masterdiscountmarketing', {
    extend : 'Main.library.Controller',
    alias  : 'controller.Masterdiscountmarketing',
    models : ['Masterdiscountmarketing'],
    stores : ['Masterdiscountmarketing'],
    views  : [
        'masterdiscountmarketing.Panel',
        'masterdiscountmarketing.FormSearch',
        'masterdiscountmarketing.Grid',
        'masterdiscountmarketing.FormData'
    ],
