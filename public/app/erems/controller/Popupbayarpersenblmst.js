Ext.define('Erems.controller.Popupbayarpersenblmst', {
    extend: 'Erems.library.template.controller.Controller2',
    alias: 'controller.Popupbayarpersenblmst',
    requires: [
    ...
    views: ['popupbayarpersenblmst.Panel', 'popupbayarpersenblmst.Grid', 'popupbayarpersenblmst.FormSearch'],
    refs: [
        {
            ref: 'grid',
            selector: 'popupbayarpersenblmstgrid'
        },

        {
            ref: 'panel',
            selector: 'popupbayarpersenblmstpanel'
        },
        {
            ref: 'formsearch',
            selector: 'popupbayarpersenblmstformsearch'
        }

    ],
    controllerName: 'popupbayarpersenblmst',
    ...
    init: function (application) {
        ...
        this.control({
            'popupbayarpersenblmstpanel': {
                beforerender: me.mainPanelBeforeRender,
                afterrender: this.panelAfterRender

            },
            'popupbayarpersenblmstgrid': {
            ...
            'popupbayarpersenblmstformsearch button[action=search]': {
                click: this.dataSearch
            },
            'popupbayarpersenblmstformsearch button[action=reset]': {
                click: this.dataReset
            },
            'popupbayarpersenblmstgrid toolbar button[action=export_excel]':{
                click: function(el) {
                    this.dataExport(el);
                }
            }
    ...
    dataExport: function(el) {
        ...
        Ext.Ajax.request({
            url: 'erems/popupbayarpersenblmst/export',
            params:params,
