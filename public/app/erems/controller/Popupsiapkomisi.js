Ext.define('Erems.controller.Popupsiapkomisi', {
    extend: 'Erems.library.template.controller.Controller2',
    alias: 'controller.Popupsiapkomisi',
    requires: [
    ...
    views: ['popupsiapkomisi.Panel', 'popupsiapkomisi.Grid', 'popupsiapkomisi.FormSearch'],
    refs: [
        {
            ref: 'grid',
            selector: 'popupsiapkomisigrid'
        },

        {
            ref: 'panel',
            selector: 'popupsiapkomisipanel'
        },
        {
            ref: 'formsearch',
            selector: 'popupsiapkomisiformsearch'
        }

    ],
    controllerName: 'popupsiapkomisi',
    ...
    pt_id: 0,
    stData: {},
    bindPrefixName: 'Popupsiapkomisi',
    localStore: {
        selectedUnit: null,
        customer: null,
        price: null,
    ...
    init: function (application) {
        ...
        this.control({
            ...
            'popupsiapkomisiformsearch button[action=search]': {
                click: this.dataSearch
            },
            'popupsiapkomisiformsearch button[action=reset]': {
                click: this.dataReset
            },
            'popupsiapkomisigrid toolbar button[action=export_excel]': {
                click: function(el) {
                    me.showExcel();
                }
            }
