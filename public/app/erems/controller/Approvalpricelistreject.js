Ext.define('Erems.controller.Approvalpricelistreject', {
	extend : 'Erems.library.template.controller.Controllerpopup',
	alias  : 'controller.Approvalpricelistreject',
	views  : ['approvalpricelistreject.Panel', 'approvalpricelistreject.Grid', 'approvalpricelistreject.FormData'],
	stores : ['Approvalpricelistreject'],
	models : ['Approvalpricelist'],
	refs   : [
		{
			ref      : 'grid',
			selector : 'approvalpricelistrejectgrid'
		},
		{
			ref      : 'formdata',
			selector : 'approvalpricelistrejectformdata'
		}
	],
	controllerName : 'approvalpricelistreject',
	fieldName      : '',
	bindPrefixName : 'Approvalpricelistreject',
	formWidth      : 650,
	init           : function (application) {
		var me = this;
		this.control({
			'approvalpricelistrejectpanel': {
				beforerender : me.mainPanelBeforeRender,
				afterrender  : this.panelAfterRender
			},
			'approvalpricelistrejectgrid': {
				afterrender  : this.gridAfterRender,
				itemdblclick : this.gridItemDblClick,
			},
			'approvalpricelistrejectgrid actioncolumn': {
				afterrender : this.gridActionColumnAfterRender,
				click       : this.gridActionColumnClick,
			},
			'approvalpricelistrejectformdata': {
