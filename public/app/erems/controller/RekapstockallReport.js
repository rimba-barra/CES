Ext.define('Erems.controller.RekapstockallReport', {
	...
	alias: 'controller.Rekapstockallreport',
	views: ['rekapstockallreport.Panel', 'rekapstockallreport.FormData', 'masterreport.Panel'],
	refs: [
		{
			ref: 'panel',
			selector: 'rekapstockallreportpanel'
		},
		{
			ref: 'formdata',
			selector: 'rekapstockallreportformdata'
		}
	],
	stores: [
	],
	controllerName: 'rekapstockallreport',
	bindPrefixName: 'Rekapstockallreport',
	xyReport: null,
	printOutData: null,
	myConfig: null,
	...
	init: function (application) {
		...
		this.control({
			'rekapstockallreportpanel': {
				beforerender: me.mainPanelBeforeRender,
				afterrender: this.panelAfterRender
			},
			'rekapstockallreportformdata': {
				afterrender: this.formDataAfterRender,
			},
			'rekapstockallreportformdata button[action=save]': {
				click: this.mainDataSave
			},
			'rekapstockallreportformdata button[action=cancel]': {
				click: this.formDataClose
			},
			'rekapstockallreportformdata button[action=process]': {
				click: function () {
					me.mainPrint();
				}
			}
