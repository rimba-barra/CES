Ext.define('Erems.controller.PurchaseletterSH2', {
    extend: 'Erems.library.template.controller.Controller2',
    alias: 'controller.PurchaseletterSH2',
    requires: ['Erems.library.Unitformula', 'Erems.library.Schedulegenerator', 'Erems.library.Browse', 'Erems.library.Purchaseletter', 'Erems.library.PurchaseletterCGCibubur','Erems.library.box.Config', 'Erems.library.box.tools.Tools', 'Erems.template.ComboBoxFields', 'Erems.library.box.tools.EventSelector', 'Erems.library.Calculator', 'Erems.library.CalculatorFields', 'Erems.library.box.tools.CryptoJs', 'Erems.library.box.tools.Date', 'Erems.library.box.tools.DateX'],
    views: ['purchaseletterSH2.Panel', 'purchaseletterSH2.Grid', 'purchaseletterSH2.FormSearch', 'purchaseletterSH2.FormData'],
    stores: ['Sourcemoney'],
    models: ['Sourcemoney'],
    refs: [
        {
            ref: 'grid',
            selector: 'purchaseletterSH2grid'
        },
        {
            ref: 'formsearch',
            selector: 'purchaseletterSH2formsearch'
        },
        {
            ref: 'formdata',
            selector: 'purchaseletterSH2formdata'
        },
        {
            ref: 'formauth',
            selector: 'purchaseletterSH2authrozieform'
        },
        {
            ref: 'formrschlist',
            selector: 'purchaseletterSH2rschlistform'
        },
        {
            ref: 'formrschform',
            selector: 'purchaseletterSH2rschformdata'
        },
        {
            ref: 'unitgrid',
            selector: 'purchaseletterSH2unitgrid'
        },
        {
            ref: 'rschlistgrid',
            selector: 'purchaseletterSH2reschedulegrid'
        },
        {
            ref: 'rschmaingrid',
            selector: 'purchaseletterSH2reschmaingrid'
        },
        //
        {
            ref: 'schedulegrid',
            selector: 'purchaseletterSH2schedulegrid'
        },
        {
            ref: 'panel',
            selector: 'purchaseletterSH2panel'
        },
        {
            ref: 'formprintout',
            selector: 'purchaseletterSH2formprintout'
        },
        {
            ref: 'formprintoutpayscheme',
            selector: 'purchaseletterSH2formprintoutpayscheme'
        },
        {
            ref: 'formdataadv',
            selector: 'purchaseletterSH2formdataaddschedule'
        },
        {
            ref: 'formsplittagihan',
            selector: 'purchaseletterSH2formsplittagihan'
        },
        {
            ref: 'komisigrid',
            selector: 'purchaseletterSH2komisigrid'
        }

    ],
    controllerName: 'purchaseletterSH2',
    ...
    init: function (application) {
        ...
        this.control({
            'purchaseletterSH2panel': {
                beforerender: me.mainPanelBeforeRender,
                afterrender: this.panelAfterRender

            },
            'purchaseletterSH2grid': {
            ...
            'purchaseletterSH2reschedulegrid': {
                itemdblclick: this.rschgridItemDblClick,
            },
            'purchaseletterSH2formsearch': {
                afterrender: this.formSearchAfterRender

            },
            'purchaseletterSH2schedulegrid': {
            ...
            'purchaseletterSH2reschmaingrid': {
                afterrender: function () {
            ...
            'purchaseletterSH2schedulegrid #sourceMoneyColumnID': {
                beforerender: function (el) {
                    //   me.schGridColumnCBBeforRender(el);
                }
            },
            'purchaseletterSH2schedulegrid #colms_sourcemoney': {
                //  click: this.schedulegridItemClick
            },
            'purchaseletterSH2grid toolbar button[action=create]': {
                click: function () {
                    //this.formDataShow('create');
                }
            },
            'purchaseletterSH2grid toolbar button[action=update]': {
                click: function () {
                    // this.formDataShow('update');
                }
            },
            'purchaseletterSH2grid toolbar button[action=editdraft]': {
                click: function(){
                    this.formDataShow('editdraftFunction','editdraft');
                }
            },
            'purchaseletterSH2schedulegrid toolbar button[action=create]': {
                click: function () {
                    me.addNewSchedule(me.getFormdata(), me.getSchedulegrid());
                }
            },
            'purchaseletterSH2schedulegrid toolbar button[action=destroy]': {
                click: function () {
                    me.removeSchedule(me.getFormdata(), me.getSchedulegrid(), me.getGrid());
                }
            },
            'purchaseletterSH2reschmaingrid toolbar button[action=create]': {
                click: function () {
                    me.addNewSchedule(me.getFormrschform(), me.getRschmaingrid());
                }
            },
            'purchaseletterSH2reschmaingrid toolbar button[action=destroy]': {
                click: function () {
                    me.removeScheduleRsch(me.getFormrschform(), me.getRschmaingrid(), me.getRschlistgrid());
                }
            },
            'purchaseletterSH2reschmaingrid toolbar button[action=split]': {
                click: function () {
                    // me.splitScheduleRsch(me.getFormrschform(), me.getRschmaingrid(), me.getRschlistgrid());
                    me.splitSchedulePromptRsch();
                }
            },
            'purchaseletterSH2reschmaingrid toolbar button[action=add_advance]': {
                click: function () {
                    me.addAdvancRschForm();
                }
            },
            'purchaseletterSH2reschmaingrid toolbar button[action=reset]': {
                click: function () {
                    me.getRschmaingrid().getStore().load();
                }
            },
            'purchaseletterSH2schedulegrid toolbar button[action=reschedule]': {
                click: function () {
                    me.showRescheduleList();
                }
            },
            'purchaseletterSH2reschedulegrid toolbar button[action=create]': {
                click: function () {
                    me.showRescheduleFormData();
                }
            },
            'purchaseletterSH2reschedulegrid toolbar button[action=edit]': {
                click: function () {
                    // me.showRescheduleFormData();
                    me.rschgridItemDblClick();
                }
            },
            'purchaseletterSH2grid toolbar button[action=destroy]': {
                // click: this.dataDestroy
                click: this.dataDestroyMyPurchase
            },
            'purchaseletterSH2reschedulegrid toolbar button[action=destroy]': {
                click: this.dataDestroyRsch
            },
            'purchaseletterSH2reschedulegrid toolbar button[action=approve]': {
                click: this.dataApproveRsch
            },
            'purchaseletterSH2grid toolbar button[action=print]': {
                click: this.dataPrint
            },
            'purchaseletterSH2grid actioncolumn': {
                afterrender: this.gridActionColumnAfterRender,
                click: this.gridActionColumnClick
            },
            'purchaseletterSH2formsearch button[action=search]': {
                click: this.dataSearch
            },
            'purchaseletterSH2formsearch button[action=reset]': {
                click: this.dataReset
            },
            'purchaseletterSH2formdata button[action=create_new_customer]': {
                click: this.addCustomer
            },
            //add by semy 8:48 21/6/17
            'purchaseletterSH2formdata button[action=setaci]': {
                click: function () {
                    var me;
                    me = this;
                    me.apiAci();
            ...
            //end semy
            'purchaseletterSH2rschlistform': {
                afterrender: this.fdarReschList
            },
            'purchaseletterSH2rschformdata': {
                afterrender: this.fdarReschForm
            },
            'purchaseletterSH2formdata': {
                afterrender: this.formDataAfterRender
            },
            'purchaseletterSH2formdata combobox': {
                change: function (el, val) {
                    me.comboBoxOnChange(el, val);
                }
            },
            'purchaseletterSH2rschformdata button[action=save]': {
                click: this.mainDataSaveRsch
            },
            'purchaseletterSH2formdata button[action=save]': {
                click: this.mainDataSave
            },
            'purchaseletterSH2formdata button[action=saveDraft]': {
                click: this.mainDataSaveDraft
            },
            'purchaseletterSH2formdata button[action=cancel]': {
                click: this.formDataClose
            },
            'purchaseletterSH2formdata button[action=printout]': {
                click: this.printoutdoc
            },
            'purchaseletterSH2formdata button[action=printsch]': {
                click: this.printPaymentScheme
            },
            'purchaseletterSH2formdata button[action=browse_unit]': {
                //click: this.browseStockedUnit
                click: function () {
                    ApliJs.showHtml(me, "browse_unit_modal", {}, 'browse_action');
                }
            },
            'purchaseletterSH2unitgrid button[action=select]': {
                click: this.unitSelect
            },
            'purchaseletterSH2formdata button[action=browse_customer]': {
                click: this.browseCustomer
            },
            'purchaseletterSH2customergrid button[action=select]': {
                click: this.customerSelect
            },
            'purchaseletterSH2formdata textfield[name=pricetype_pricetype_id]': {
                select: this.priceTypeOnSelect
            },
            'purchaseletterSH2formdata textfield[name=billingrules_billingrules_id]': {
                select: this.billingRulesOnSelect
            },
            'purchaseletterSH2formdata [name=upline_upline_id]': {
                select: function () {
                    me.uplineOnSelect();
                }
            },
            'purchaseletterSH2formdata [name=cac_cac_id]': {
                select: function () {
                    me.cacOnSelect();
                }
            },
            'purchaseletterSH2formdata textfield[name=persen_salesdisc]': {
                keyup: function (el) {
                    me.processor.calculate();
                }
            },
            'purchaseletterSH2rschformdata textfield[name=rencanaserahterima_month]': {
                keyup: function () {
                    me.rencanaSerahTerimaOnKeyUpRsch();
                }
            },
            // added 1/3/2015
            'purchaseletterSH2formdata textfield[name=rencana_serahterima]': {
                keyup: function () {
                    me.rencanaSerahTerimaOnKeyUp();
                }
            },
            'purchaseletterSH2formdata [name=rencana_serahterima_date]': {
                select: function () {
                    me.rencanaSerahTerimaDateOnSelect();
                }
            },
            'purchaseletterSH2formdata button[action=genschedule]': {
                click: function () {
            ...
            'purchaseletterSH2formdata button[action=authorize]': {
                click: function () {
                    me.showAuthorizeForm();
                }
            },
            'purchaseletterSH2authrozieform button[action=login]': {
                click: function () {
                    me.authLogin();
                }
            },
            'purchaseletterSH2formprintout button[action=print]': {
                click: function () {
                    me.formTemplatePrint();
                }
            },
            'purchaseletterSH2formprintoutpayscheme button[action=print]': {
                click: function () {
                    me.formTemplatePrintPayScheme();
                }
            },
            'purchaseletterSH2formdataaddschedule button[action=save]': {
                click: function () {
                    me.plsaveFormAdvanceOnClick();
                }
            },
            'purchaseletterSH2formsplittagihan button[action=process]': {
                click: function () {
                    me.plProcessSplitTagihan();
                }
            },
            /*
             'purchaseletterSH2formdata button[action=browse_unit2]': {
             click: function () {
             // me.browseUnitDua();
             ApliJs.showHtml(me, "browse_unit_modal",{}, 'browse_action');
             }
             ...
             */
            'purchaseletterSH2formdata combobox[name=rewardsales_reward_id]': {
                select: function () {
            ...
            'purchaseletterSH2formdata combobox[name=rewardcustomer_reward_id]': {
                select: function () {
            ...
            'purchaseletterSH2formdata combobox[name=rewardtambahan_reward_id]': {
                select: function () {
            ...
            'purchaseletterSH2formdata button[action=flashprint]': {
                click: function () {
                    me.purchaseFlashprint();
                }
            },
            'purchaseletterSH2reschedulegrid button[action=approvenow]': {
                click: function () {
                    me.purcApproveNowReschedule();
                }
            },
            'purchaseletterSH2formdata combobox[name=distribution_channel_id]': {
                select: function () {
                    me.reloadKomisiPencairan();
                }
            },
            'purchaseletterSH2formdata combobox[name=komisi_pencairan_id]': {
                select: function () {
                    me.reloadGridKomisiPencairan();
                }
            },
            'purchaseletterSH2komisigrid': {
                afterrender: function () {
                    // me.getKomisigrid().getStore().loadData([], false);
                    // me.getSchedulegrid().on('edit', function (editor, e) {
                    //     // commit the changes right after editing finished
                    //     me.schedulGridOnEdit(editor, e, me.getFormdata(), me.getSchedulegrid());
                    //     e.record.commit();
        ...
        for (var x in cc) {
            this.control('purchaseletterSH2formdata textfield[name=' + cc[x] + ']', {
                keyup: function () {
                    me.processor.calculate();
        ...
        for (var i in arF) {
            this.control('purchaseletterSH2formdata textfield[name=' + arF[i] + ']', {
                blur: function (el) {
        ...
        this.control(events.comboBox('purchaseletterSH2formdata', me.tools.inputComboCode('salesman_' + me.cbf.employee.v, me.cbf.employee, 'salesman', 'purchaseletterSH2formdata')));
    },
...
//        }).read('checkrealisasicashier');
    ...
    mainDataSaveRsch: function () {
        ...
        me.tools.insSave({
            form: f,
            urlCreate: 'erems/purchaseletterSH2/create',
    ...
    mainDataSave: function () {
        ...
        var f = me.getFormdata();
        console.log('coba');
        console.log(me.tools.gridHelper(me.getKomisigrid()).getJson());
        console.log(me.getFormdata());
        console.log('me.localStore.detail');
        console.log(me.localStore.detail);
        console.log(f.down("[name=distribution_channel_id]").getValue());
        me.insSave({
            form: me.getFormdata(),
            grid: me.getGrid(),
            store: me.localStore.detail,
            finalData: function (data) {
                data['distribution_channel_id'] = f.down("[name=distribution_channel_id]").getValue();
                data["detail"] = me.tools.gridHelper(me.getKomisigrid()).getJson();
                console.log('data 123213123');
                console.log(data);
                return data;
            },
            sync: true,
...
//            console.log("balloon "+rec.get("is_balloon"));
        ...
        me.tools.interAjax({
            ...
            success: function (data) {
                if (data.length !== undefined) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "erems/purchaseletterSH2/read/",
    ...
    fdar: function () {
        ...
        var x = {
            init: function () {
                ...
                // me.processor.setKomisiGrid(me.getKomisigrid());
                // komg.doInit();
            ...
            //     me.tools.ajax({
            //         params: {
            //             komisi_pencairan_detail_id: 1
            //         },
            //         success: function (data) {
            //             console.log(data);
            //             var dStore = null;
            //             dStore = komg.getStore();
            //             // dStore.removeAll();
            //             for(var i =0;i<data.length;i++){
            //                 var dataToStore = {
            //                     komisi_pencairan_detail_id: data[i].komisi_pencairan_detail_id,
            //                     penerima_komisi           : data[i].penerima_komisi,
            //                     employee_name             : data[i].reff_name,
            //                     persentase                : data[i].persentase
            //                     }
            //                     console.log('dataToStore');
            //                     console.log(dataToStore);
            //                 dStore.add(dataToStore);
            //             }
            //             console.log(dStore);
            //                     komg.getView().refresh();
            // // me.getFormdatadetail().getView().refresh();
            //             // f.setLoading(false);
            //             // f.setLoading(false);
            //         }
            //     }).read('komisiPencairan');
    ...
    ,reloadKomisiPencairan: function () {
        ...
        var komg = me.getKomisigrid();
        // console.log(komisidistributionchannel_id);
        ...
        me.tools.ajax({
            ...
            success: function (data, model) {
                // console.log(data);
                me.tools.wesea(data.komisipencairan, form.down("[name=komisi_pencairan_id]")).comboBox();
                // komisiPencairanIdCb.setValue(data.komisipencairan[0].komisi_pencairan_id);
                komisiPencairanIdCb.setValue('');
                // komisiPencairanIdCb.select('', true);
                // console.log('di listener');
                // console.log(data.komisipencairan[0]);
        ...
        // me.tools.wesea(params.data.rewardtambahan, params.form.down("[name=distribution_channel_id]")).comboBox();
    }
    ,reloadGridKomisiPencairan: function () {
        var me = this;
        var komisi_pencairan_id = me.getFormdata().down("[name=komisi_pencairan_id]").value;
        console.log('komisi_pencairan_id');
        console.log(komisi_pencairan_id);
        // var form = me.getFormdata();
        ...
        //     success: function (data, model) {
        //         console.log(data);
        //         // me.tools.wesea(data.scheduletype, me.getFormdataadv().down("[name=distribution_channel_id]")).comboBox();
        //         me.tools.wesea(data.komisipencairan, form.down("[name=komisi_pencairan_id]")).comboBox();
