Ext.define('Erems.controller.Popupholdbook', {
    extend: 'Erems.library.template.controller.Controller2',
    alias: 'controller.Popupholdbook',
    requires: [
    ...
    views: ['popupholdbook.Panel', 'popupholdbook.Grid', 'popupholdbook.FormSearch'],
    refs: [
        {
            ref: 'grid',
            selector: 'popupholdbookgrid'
        },

        {
            ref: 'panel',
            selector: 'popupholdbookpanel'
        },
        {
            ref: 'formsearch',
            selector: 'popupholdbookformsearch'
        }

    ],
    controllerName: 'popupholdbook',
    ...
    init: function (application) {
        ...
        this.control({
            ...
            'popupholdbookformsearch button[action=search]': {
                click: this.dataSearch
            },
            'popupholdbookformsearch button[action=reset]': {
                click: this.dataReset
            },
            'popupholdbookgrid toolbar button[action=export_excel]': {
                click: function(el) {
                    me.showExcel();
                }
            }
