Ext.define('Erems.controller.Otherspayment', {
	...
	requires: ['Erems.library.Unitformula',
		...
		'Erems.library.XyReport', 'Erems.library.Browse'],
	views: ['otherspayment.Panel', 'otherspayment.Grid', 'otherspayment.FormSearch', 'otherspayment.FormData', 'otherspayment.PaymentDetailGrid', 'masterreport.Panel', 'otherspayment.UnitGrid'],
	comboBoxIdEl: [],
	...
	refs: [
		...
		{
			ref: 'unitgrid',
			selector: 'otherspaymentunitgrid'
		},
	],
	//unitFormula: null,
	...
	init: function () {
		...
		this.control({
			...
			'otherspaymentgrid toolbar button[action=view]': {
				click: function () {
			...
			/* add by hadi 21/07/2020*/
			'otherspaymentformsearch [name=unit_number]': {
			...
			'otherspaymentformsearch [name=customer_name]': {
				keypress: function (e, el) {
					var me = this;
					if (el.getCharCode() === 13) {
						me.dataSearch();
			...
			'otherspaymentformsearch [name=receipt_no]': {
				keypress: function (e, el) {
					var me = this;
					if (el.getCharCode() === 13) {
						me.dataSearch();
