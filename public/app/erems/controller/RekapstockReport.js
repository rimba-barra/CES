Ext.define('Erems.controller.RekapstockReport', {
    ...
    alias: 'controller.Rekapstockreport',
    views: ['rekapstockreport.Panel', 'rekapstockreport.FormData', 'masterreport.Panel'],
    refs: [
        {
            ref: 'panel',
            selector: 'rekapstockreportpanel'
        },
        {
            ref: 'formdata',
            selector: 'rekapstockreportformdata'
        }
    ...
    controllerName: 'rekapstockreport',
    bindPrefixName: 'Rekapstockreport',
    xyReport: null,
    printOutData: null,
    myConfig: null,
    ...
    init: function(application) {
        ...
        this.control({
            'rekapstockreportpanel': {
                beforerender: me.mainPanelBeforeRender,
                afterrender: this.panelAfterRender
            },
            'rekapstockreportformdata': {
                afterrender: this.formDataAfterRender,              
            },
            'rekapstockreportformdata button[action=save]': {
                click: this.mainDataSave
            },
            'rekapstockreportformdata button[action=cancel]': {
                click: this.formDataClose
            },
            'rekapstockreportformdata button[action=process]': {
                click: function() {
                    me.mainPrint();
                }
            },
            'rekapstockreportformdata button[action=reset]': {
                click: function (){
                    var me = this;
