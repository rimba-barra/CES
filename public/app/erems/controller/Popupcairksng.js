Ext.define('Erems.controller.Popupcairksng', {
    extend: 'Erems.library.template.controller.Controller2',
    alias: 'controller.Popupcairksng',
    requires: [
    ...
    views: ['popupcairksng.Panel', 'popupcairksng.Grid', 'popupcairksng.FormSearch'],
    refs: [
        {
            ref: 'grid',
            selector: 'popupcairksnggrid'
        },

        {
            ref: 'panel',
            selector: 'popupcairksngpanel'
        },
        {
            ref: 'formsearch',
            selector: 'popupcairksngformsearch'
        }

    ],
    controllerName: 'popupcairksng',
    ...
    init: function (application) {
        ...
        this.control({
            ...
            'popupcairksngformsearch button[action=search]': {
                click: this.dataSearch
            },
            'popupcairksngformsearch button[action=reset]': {
                click: this.dataReset
            },
            'popupcairksnggrid toolbar button[action=export_excel]': {
                click: function(el) {
                    me.showExcel();
                }
            }
