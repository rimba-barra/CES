Ext.define('Erems.controller.Popupchgkavlingsatubulan', {
    extend: 'Erems.library.template.controller.Controller2',
    alias: 'controller.Popupchgkavlingsatubulan',
    requires: [
    ...
    views: ['popupchgkavlingsatubulan.Panel', 'popupchgkavlingsatubulan.Grid', 'popupchgkavlingsatubulan.FormSearch'],
    refs: [
        {
            ref: 'grid',
            selector: 'popupchgkavlingsatubulangrid'
        },

        {
            ref: 'panel',
            selector: 'popupchgkavlingsatubulanpanel'
        },
        {
            ref: 'formsearch',
            selector: 'popupchgkavlingsatubulanformsearch'
        }

    ],
    controllerName: 'popupchgkavlingsatubulan',
    ...
    init: function (application) {
        ...
        this.control({
            'popupchgkavlingsatubulanpanel': {
                beforerender: me.mainPanelBeforeRender,
                afterrender: this.panelAfterRender

            },
            'popupchgkavlingsatubulangrid': {
            ...
            'popupchgkavlingsatubulanformsearch button[action=search]': {
                click: this.dataSearch
            },
            'popupchgkavlingsatubulanformsearch button[action=reset]': {
                click: this.dataReset
            },
            'popupchgkavlingsatubulangrid toolbar button[action=export_excel]': {
                click: function(el) {
                    me.showExcel();
                }
            }
