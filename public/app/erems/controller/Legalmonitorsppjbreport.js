Ext.define('Erems.controller.Legalmonitorsppjbreport', {
    extend: 'Erems.library.template.controller.Controllerreporttb', 
    alias: 'controller.Legalmonitorsppjbreport',
    views: ['legalmonitorsppjbreport.Panel', 'legalmonitorsppjbreport.FormData', 'masterreport.Panel'],
	requires:[
    ...
    refs: [
        {
            ref: 'panel',
            selector: 'legalmonitorsppjbreportpanel'
        },
        {
            ref: 'formdata',
            selector: 'legalmonitorsppjbreportformdata'
        }

    ],
    controllerName: 'legalmonitorsppjbreport',
    formWidth: 750,
    fieldName: 'name',
    comboBoxIdEl: [],
    bindPrefixName: 'Legalmonitorsppjbreport',
    localStore: {
        detail: null
    },
	project_name: null,
    ...
    init: function(application) {
        var me = this;
        this.control({
            'legalmonitorsppjbreportpanel': {
                beforerender: me.mainPanelBeforeRender,
                afterrender: this.panelAfterRender

            },
            'legalmonitorsppjbreportformdata': {
                afterrender: this.formDataAfterRender
            },
            'legalmonitorsppjbreportformdata button[action=save]': {
                click: this.mainDataSave
            },
            'legalmonitorsppjbreportformdata button[action=cancel]': {
                click: this.formDataClose
            },
            'legalmonitorsppjbreportformdata button[action=process]': {
                click: function() {
                    me.processReport();
                }
            },
			'legalmonitorsppjbreportformdata button[action=reset]': {
				click: this.dataReset
            },
			'legalmonitorsppjbreportformdata [name=cbf_buildingclass]': {
                change: me.checkboxChange
            },
			'legalmonitorsppjbreportformdata [name=buildingclass]': {
                select: me.comboboxChange
            },
			'legalmonitorsppjbreportformdata [name=cbf_cluster_id]': {
                change: me.checkboxChange
            },
			'legalmonitorsppjbreportformdata [name=cluster_id]': {
                select: me.comboboxChange
            },
			'legalmonitorsppjbreportformdata [name=cbf_productcategory_id]': {
                change: me.checkboxChange
            },
			'legalmonitorsppjbreportformdata [name=productcategory_id]': {
                select: me.comboboxChange
            },
			'legalmonitorsppjbreportformdata [name=cbf_pricetype_id]': {
                change: me.checkboxChange
            },
			'legalmonitorsppjbreportformdata [name=pricetype_id]': {
                select: me.comboboxChange
            }
        });
    },
    ...
    processReport: function() {
        ...
        if (win) {
			...
			var reportFile = "Legalmonitorsppjb";
    ...
    panelAfterRender: function(el) {	
        ...
        Ext.Ajax.request({
            url: 'erems/legalmonitorsppjbreport/read',
        ...
        //   me.loadReport(el, 'erems/legalmonitorsppjbreport/all');
    }
