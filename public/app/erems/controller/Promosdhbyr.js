Ext.define('Erems.controller.Promosdhbyr', {
    extend: 'Erems.library.template.controller.Controller2',
    alias: 'controller.Promosdhbyr',
    requires: [
    ...
    views: ['promosdhbyr.Panel', 'promosdhbyr.Grid', 'promosdhbyr.FormSearch'],
    refs: [
        {
            ref: 'grid',
            selector: 'promosdhbyrgrid'
        },

        {
            ref: 'panel',
            selector: 'promosdhbyrpanel'
        },
        {
            ref: 'formsearch',
            selector: 'promosdhbyrformsearch'
        }

    ],
    controllerName: 'promosdhbyr',
    ...
    init: function (application) {
        ...
        this.control({
            ...
            'promosdhbyrformsearch button[action=search]': {
                click: this.dataSearch
            },
            'promosdhbyrformsearch button[action=reset]': {
                click: this.dataReset
            },
            'promosdhbyrgrid toolbar button[action=export_excel]':{
                click: function(el) {
                    this.dataExport(el);
                }
            }
