Ext.define('Erems.controller.Generalsudahsp3kreport', {
    extend: 'Erems.library.template.controller.Controllerreporttb', 
    alias: 'controller.Generalsudahsp3kreport',
    views: ['generalsudahsp3kreport.Panel', 'generalsudahsp3kreport.FormData', 'masterreport.Panel'],
	stores: ['Masterdata.store.Bank'],
	models: ['Masterdata.model.Bank'],
    refs: [
        {
            ref: 'panel',
            selector: 'generalsudahsp3kreportpanel'
        },
        {
            ref: 'formdata',
            selector: 'generalsudahsp3kreportformdata'
        }

    ],
    controllerName: 'generalsudahsp3kreport',
    formWidth: 750,
    fieldName: 'name',
    comboBoxIdEl: [],
    bindPrefixName: 'Generalsudahsp3kreport',
    localStore: {
        detail: null
    },
	project_name: null,
    ...
    init: function(application) {
        var me = this;
        this.control({
            'generalsudahsp3kreportpanel': {
                beforerender: me.mainPanelBeforeRender,
                afterrender: this.panelAfterRender

            },
            'generalsudahsp3kreportformdata': {
                afterrender: this.formDataAfterRender
            },
            'generalsudahsp3kreportformdata button[action=save]': {
                click: this.mainDataSave
            },
            'generalsudahsp3kreportformdata button[action=cancel]': {
                click: this.formDataClose
            },
            'generalsudahsp3kreportformdata button[action=process]': {
                click: function() {
                    me.processReport();
                }
            },
			'generalsudahsp3kreportformdata button[action=reset]': {
				click: this.dataReset
            },
			'generalsudahsp3kreportformdata [name=cbf_bank_id]': {
                change: me.checkboxChange
            },
			'generalsudahsp3kreportformdata [name=bank_id]': {
                select: me.comboboxChange
            },
			'generalsudahsp3kreportformdata [name=cbf_kprstatusum_id]': {
                change: me.checkboxChange
            },
			'generalsudahsp3kreportformdata [name=kprstatusum_id]': {
                select: me.comboboxChange
            },
        });
    },
    ...
    processReport: function() {
        ...
        if (win) {
			...
			var reportFile = "Generalsudahsp3k";
    ...
    panelAfterRender: function(el) {	
        ...
        Ext.Ajax.request({
            url: 'erems/generalsudahsp3kreport/read',
        ...
        //   me.loadReport(el, 'erems/generalsudahsp3kreport/all');
    }
