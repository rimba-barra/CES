Ext.define('Erems.controller.Expenserequest', {
    ...
    requires: ['Erems.library.DetailtoolExReq', 'Erems.library.miniapp.App', 'Erems.library.StoreCreator',
        'Erems.library.box.Config', 'Erems.library.box.tools.Tools', 'Erems.template.ComboBoxFields', 'Erems.library.box.tools.EventSelector', 'Erems.library.Browse'],
    ...
    init: function() {
        ...
        var listControl = {
            ...
            'expenserequestgrid toolbar button[action=print]': {
    ...
    insertToFormdata: function() {
        ...
        if (me.tools.intval(vs["unit_unit_id"]) == 0 ||
                me.tools.intval(vs["paymenttype_paymenttype_id"]) == 0 ||
                me.tools.intval(vs["expensetype_expensetype_id"]) == 0 ||
                me.tools.intval(vs["amount"]) == 0) {
            return false;
        }
