Ext.define('Erems.controller.Masterwhatsnew', {
    ...
    //langsung dirender di view PanelFrame.js
    ...
    //             html = html + '<img style="width:100%;height:200px;" src="https://ces.ciputragroup.com/webapps/Ciputra/public/app/main/images/whatsnewheader.png"><br><br>';
    ...
    uploadImage: function(){
        ...
        var form = me.getMainFormData();
        form.submit({
            url: 'erems/masterwhatsnew/create',
