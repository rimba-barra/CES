Ext.define('Erems.controller.Popupfollowup', {
   extend: 'Erems.library.template.controller.Controller2',
    ...
    alias: 'controller.Popupfollowup',
    views: ['popupfollowup.Panel', 'popupfollowup.Grid', 'popupfollowup.FormSearch', 'popupfollowup.FormData'],
    refs: [
        {
            ref: 'grid',
            selector: 'popupfollowupgrid'
        },
        {
            ref: 'formsearch',
            selector: 'popupfollowupformsearch'
        },
        {
            ref: 'formdata',
            selector: 'popupfollowupformdata'
        }
    ],
    controllerName: 'popupfollowup',
    ...
    init: function(application) {
        ...
        this.control({
            ...
            'popupfollowupgrid toolbar button[action=create]': {
                click: function() {
                    this.formDataShow('create');
                }
            },
            'popupfollowupgrid toolbar button[action=update]': {
                click: function() {
                    this.formDataShow('update');
                }
            },
            'popupfollowupgrid toolbar button[action=destroy]': {
                click: this.dataDestroy
            },
            'popupfollowupgrid toolbar button[action=print]': {
                click: this.dataPrint
            },
            'popupfollowupgrid actioncolumn': {
                afterrender: this.gridActionColumnAfterRender,
                click: this.gridActionColumnClick
            },
            'popupfollowupformsearch button[action=search]': {
                click: this.dataSearch
            },
            'popupfollowupformsearch button[action=reset]': {
                click: this.dataReset
            },
            'popupfollowupformdata': {
                afterrender: this.formDataAfterRender,
                beforerender:function(el){
                   
                }
            },
            'popupfollowupformdata button[action=save]': {
                click: this.mainDataSave
            },
            'popupfollowupformdata button[action=cancel]': {
                click: this.formDataClose
            },
             //added by semy 21-6-2017
             'popupfollowupgrid toolbar button[action=excel_page]': {
                click: function(){
                   me.saveExcelPage();
                },
            },
             //added by semy 21-6-2017
             'popupfollowupgrid toolbar button[action=excel_selected]': {
                click: function(){
                   me.saveExcelSelected();
                },
            },
             'popupfollowupgrid toolbar button[action=excel_all]': {
                click: function(){
                   me.saveExcelAll();
                },
            },
