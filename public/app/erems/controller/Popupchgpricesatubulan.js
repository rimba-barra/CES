Ext.define('Erems.controller.Popupchgpricesatubulan', {
    extend: 'Erems.library.template.controller.Controller2',
    alias: 'controller.Popupchgpricesatubulan',
    requires: [
    ...
    views: ['popupchgpricesatubulan.Panel', 'popupchgpricesatubulan.Grid', 'popupchgpricesatubulan.FormSearch'],
    stores: ['Masterblock', 'Mastercluster'],
    models: ['Masterblock', 'Mastercluster'],
    refs: [
        {
            ref: 'grid',
            selector: 'popupchgpricesatubulangrid'
        },

        {
            ref: 'panel',
            selector: 'popupchgpricesatubulanpanel'
        },
        {
            ref: 'formsearch',
            selector: 'popupchgpricesatubulanformsearch'
        }

    ],
    comboBoxIdEl: ['fs_cluster_id', 'fs_block_id'],
    controllerName: 'popupchgpricesatubulan',
    ...
    init: function (application) {
        ...
        this.control({
            'popupchgpricesatubulanpanel': {
                beforerender: me.mainPanelBeforeRender,
                afterrender: this.panelAfterRender

            },
            'popupchgpricesatubulangrid': {
                afterrender: this.gridAfterRender,
                itemdblclick: this.gridItemDblClick,
                itemcontextmenu: this.gridItemContextMenu,
                selectionchange: this.gridSelectionChange
            },
            'popupchgpricesatubulanformsearch' : {
                afterrender : this.formSearchAfterRender,
            },
            'popupchgpricesatubulanformsearch button[action=search]': {
                click: this.dataSearch
            },
            'popupchgpricesatubulanformsearch button[action=reset]': {
                click: this.dataReset
            },
            'popupchgpricesatubulangrid toolbar button[action=export_excel]': {
                click: function(el) {
                    me.showExcel();
                }
            }
