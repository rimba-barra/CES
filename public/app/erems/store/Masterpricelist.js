Ext.define('Erems.store.Masterpricelist', {
    extend: 'Ext.data.Store',
    alias: 'store.masterpriceliststore',
    requires: [
        'Erems.model.Masterpricelist'
    ],
    constructor: function(cfg) {
        var me = this;
        cfg = cfg || {};
        me.callParent([Ext.apply({
                storeId: 'MasterpricelistStore',
                model: 'Erems.model.Masterpricelist',
                proxy: {
                    type: 'ajax',
                    actionMethods: {
                        read: 'POST',
