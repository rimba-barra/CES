Ext.define('Erems.store.Popuplogkomunikasicustomer', {
	extend      : 'Ext.data.Store',
	alias       : 'store.popuplogkomunikasicustomerstore',
	requires    : [ 'Erems.model.Popupmaster' ],
	constructor : function(cfg) {
		var me = this;
		cfg = cfg || {};
		me.callParent([Ext.apply({
			storeId : 'PopuplogkomunikasicustomerStore',
			...
			proxy   : {
				...
				extraParams : {
					popup_type : 'logkomunikasicustomer'
				},
				writer : {
					type   : 'json',
					encode : true,
