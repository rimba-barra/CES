Ext.define('Erems.store.Popupdocumenthistoryunit', {
	extend      : 'Ext.data.Store',
	alias       : 'store.popupdocumenthistoryunitstore',
	requires    : [ 'Erems.model.Popupmaster' ],
	constructor : function(cfg) {
		var me = this;
		cfg = cfg || {};
		me.callParent([Ext.apply({
			storeId : 'PopupdocumenthistoryunitStore',
			...
			proxy   : {
				...
				extraParams : {
					popup_type : 'documenthistoryunit'
				},
				writer : {
					type   : 'json',
					encode : true,
