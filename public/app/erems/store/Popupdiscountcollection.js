Ext.define('Erems.store.Popupdiscountcollection', {
	extend      : 'Ext.data.Store',
	alias       : 'store.popupdiscountcollectionstore',
	requires    : [ 'Erems.model.Popupmaster' ],
	constructor : function(cfg) {
		var me = this;
		cfg = cfg || {};
		me.callParent([Ext.apply({
			storeId : 'PopupdiscountcollectionStore',
