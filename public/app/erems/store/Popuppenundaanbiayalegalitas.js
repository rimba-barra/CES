Ext.define('Erems.store.Popuppenundaanbiayalegalitas', {
	extend      : 'Ext.data.Store',
	alias       : 'store.popuppenundaanbiayalegalitasstore',
	requires    : [ 'Erems.model.Popupmaster' ],
	constructor : function(cfg) {
		var me = this;
		cfg = cfg || {};
		me.callParent([Ext.apply({
			storeId : 'PopuppenundaanbiayalegalitasStore',
			...
			proxy   : {
				...
				extraParams : {
					popup_type : 'popuppenundaanbiayalegalitas'
				},
				writer : {
					type   : 'json',
					encode : true,
