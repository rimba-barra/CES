Ext.define('Erems.store.Popupdocumenthistorycustomer', {
	extend      : 'Ext.data.Store',
	alias       : 'store.popupdocumenthistorycustomerstore',
	requires    : [ 'Erems.model.Popupmaster' ],
	constructor : function(cfg) {
		var me = this;
		cfg = cfg || {};
		me.callParent([Ext.apply({
			storeId : 'PopupdocumenthistorycustomerStore',
			...
			proxy   : {
				...
				extraParams : {
					popup_type : 'documenthistorycustomer'
				},
				writer : {
					type   : 'json',
					encode : true,
