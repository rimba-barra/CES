Ext.define('Erems.view.purchaseletterNew.RescheduleFormData', {
    extend: 'Erems.library.template.view.FormData',
    requires: ['Erems.view.purchaseletterNew.RescheduleMainGrid'],
    alias: 'widget.purchaseletterNewrschformdata',
    frame: true,
    autoScroll: true,
    anchorSize: 100,
    height: 600,
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                {
                    xtype: 'purchaseletterNewreschmaingrid',
                    height: 250
                },
                {
                    xtype: 'textfield',
