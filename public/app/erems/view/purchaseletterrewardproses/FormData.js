Ext.define('Erems.view.purchaseletterrewardproses.FormData', {
	...
	requires: ['Erems.library.template.view.combobox.Cluster2',
		...
		'Erems.view.purchaseletterrewardproses.RewardGrid',
	],
	alias: 'widget.purchaseletterrewardprosesformdata',
	frame: true,
	autoScroll: true,
	anchorSize: 100,
	height: 600,
	...
	initComponent: function () {
		...
		Ext.applyIf(me, {
			...
			{
				xtype: 'panel', bodyPadding: 10, title: 'DETAIL REWARD', collapsible: true,
				items: [
					{
						//  bodyPadding: 10,
						padding: '10px 0 0 0',
						...
						width: '100%',
						items: [{
							xtype: 'purchaseletterrewardprosesgriddetail',
							width: '100%',
							itemId: 'RewardGrid',
							// hidden: true,
