...
Ext.define('Erems.view.popuppinjampakailunas.Grid', {
    extend         : 'Erems.library.template.view.Grid',
    alias          : 'widget.popuppinjampakailunasgrid',
    store          : 'Popuppinjampakailunas',
    bindPrefixName : '',
    newButtonLabel : 'New',
    initComponent  : function () {
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                {
                    itemId    : 'colms_pinjampakai_date',
                    dataIndex : 'pinjampakai_date',
                    text      : 'Pinjam<br/>Pakai Date',
                    width     : 80,
                    renderer  : Ext.util.Format.dateRenderer('d-m-Y'),
                    align     : 'center'
                },
