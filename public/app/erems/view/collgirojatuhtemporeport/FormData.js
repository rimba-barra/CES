Ext.define('Erems.view.collgirojatuhtemporeport.FormData', {
    extend: 'Erems.library.template.view.FormData',
    alias: 'widget.collgirojatuhtemporeportformdata',
    requires: [
							...
							items: [
								{
									...
									name: 'radiogroup_jenis_laporan',
									items: [
										{
											xtype: 'radiofield',
											boxLabel: 'Bulanan',
											name: 'radio_jenis_laporan',
											inputValue: 'bulanan',
											itemId: 'bulanan',
											checked: true
										},
