Ext.define('Erems.view.cancellation.FormData', {
	extend: 'Erems.library.template.view.FormData',
	alias: 'widget.cancellationformdata',
	frame: true,
	autoScroll: true,
	anchorSize: 100,
	height: 600,
	...
	initComponent: function () {
		...
		Ext.applyIf(me, {
			items: [
				...
				{
					xtype: 'hiddenfield',
					itemId: 'fdms_tanggal_akta_subrogasi',
					name: 'tanggal_akta_subrogasi'
				},
				{
					xtype: 'hiddenfield',
					itemId: 'fdms_no_akta_subrogasi',
					name: 'no_akta_subrogasi'
				},
				{
					xtype: 'hiddenfield',
					itemId: 'fdms_notaris_id',
					name: 'notaris_id'
				},
							...
							items: [
								{
									...
									items: [
										...
										// added by rico 01122022
										{
											...
											items     : [
												{
													xtype  : 'cancellationschedulegrid',
													width  : '100%',
				...
				/* DOCUMENT PEMBATALAN */
				{
					xtype: 'panel', bodyPadding: 10, title: 'DOCUMENT PEMBATALAN', collapsible: true,
					width: '100%',
					items: [
						{
							xtype: 'panel',
							...
							items: [
								{
									...
									items     : [
										{
											xtype  : 'cancellationdocumentpembatalangrid',
											width  : '100%',
											itemId : 'DocumentpembatalanGrid'
										}
									]
								}
							]
