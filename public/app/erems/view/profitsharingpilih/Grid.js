Ext.define('Erems.view.profitsharingpilih.Grid', {
	extend: 'Erems.library.template.view.Grid',
	alias: 'widget.profitsharingpilihgrid',
	store: 'Profitsharingpilih',
	...
	initComponent: function () {
		...
		Ext.applyIf(me, {
			...
			columns: [
				...
				{
					xtype: 'gridcolumn',
					itemId: 'colms_profitsharing_name',
					width: '10%',
					dataIndex: 'profitsharing_name',
					hideable: false,
					text: 'Profit Sharing Name'
				},
				{
					xtype: 'actioncolumn',
					hidden: true,
