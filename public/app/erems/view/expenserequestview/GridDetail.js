Ext.define('Erems.view.expenserequestview.GridDetail', {
    extend:'Erems.library.template.view.GridDS2',
    storeConfig:{
        id:'ExpenseRequestViewDetailGridStore',
        idProperty:'expensedetail_id',
        extraParams:{}
    },
    alias: 'widget.expenserequestviewgriddetail',
    bindPrefixName: 'Expenserequestview',
    height: 200,
    columnLines: true,
    useActionCol:false,
    useAddNewButton:false,
    itemId:'ExpenseRequestViewgriddetail',
