Ext.define('Erems.view.skl.FormData', {
	extend: 'Erems.library.template.view.FormData',
	alias: 'widget.sklformdata',
	frame: true,
	autoScroll: true,
	anchorSize: 100,
	height: 600,
	...
	initComponent: function () {
		...
		Ext.applyIf(me, {
			items: [
				...
				{xtype: 'panel', bodyPadding: 10, title: 'DETAIL SKL', collapsible: true,
					width: '100%',
					items: [
						{
							xtype: 'panel',
							...
							items: [
								{
									...
									items: [
										...
										},
										{
											...
											items: [{
													xtype: 'datefield',
													fieldLabel: 'Serah terima SKL Date',
													labelWidth: 130,
													anchor: '-5',
