Ext.define('Erems.view.popupindikatorpercepatanst.Grid', {
    extend: 'Erems.library.template.view.GridDS2',
    alias: 'widget.popupindikatorpercepatanstgrid',
    storeConfig: {
        id: 'PopupindikatorpercepatanstGridStore',
