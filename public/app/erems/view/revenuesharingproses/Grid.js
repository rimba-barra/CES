Ext.define('Erems.view.revenuesharingproses.Grid', {
	extend: 'Erems.library.template.view.Grid',
	alias: 'widget.revenuesharingprosesgrid',
	store: 'Revenuesharingproses',
...
//				},
				...
				{
					xtype: 'numbercolumn',
					itemId: 'colms_total_pengurang_rs',
					width: 150,
					dataIndex: 'total_pengurang_rs',
					align: 'right',
					hideable: false,
					text: 'Total Pengurang RS<br/>(Komisi Marketing)',
					cls: 'text-center'
				},
				{
					xtype: 'numbercolumn',
					...
					align: 'right',
					hideable: false,
					text: 'Total Revenue Sharing<br/>(Netto+PPN-Komisi)',
					cls: 'text-center'
				},
				{
					xtype: 'numbercolumn',
				...
				{
					xtype: 'numbercolumn',
					itemId: 'colms_rs_bangunan_ciputra',
					width: 150,
					dataIndex: 'rs_bangunan_ciputra',
					align: 'right',
					hideable: false,
					text: 'RS-Bangunan Ciputra'
				},
...
//						bindAction: 'RevenuesharingprosesCreate',
