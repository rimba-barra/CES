Ext.define('Erems.view.purchaseletter.RescheduleMaingrid', {
    //extend: 'Ext.grid.Panel',
    alias: 'widget.purchaseletterreschmaingrid',
    extend: 'Erems.library.template.view.GridDS2',
    storeConfig: {
        id: 'RescheduleMainGridStore',
        idProperty: 'schedule_id',
        extraParams: {
            mode_read: 'reschedulesch'
        }
    },
    //  store: 'Schedule',
    requires: [
        ...
        Ext.applyIf(me, {
            ...
            viewConfig: {
                ...
                getRowClass: function(record, index) {
                    ...
                    if ( (record.get('amount') > record.get('remaining_balance')) && (record.get('remaining_balance') <= 0) )return 'disabled-row';
                }
            },
