Ext.define('Erems.view.discountcollection.FormData', {
	extend: 'Erems.library.template.view.FormData',
	alias: 'widget.discountcollectionformdata',
	requires: [
//		'Erems.library.template.component.Clustercombobox',
//		'Erems.library.template.component.Citycombobox',
//		'Erems.library.template.component.Citraclubcombobox',
		'Erems.view.discountcollection.DetailGrid'
	],
	frame: true,
	autoScroll: true,
	anchorSize: 100,
							...
							items: [
								{
									...
									bodyStyle: 'border:0px',
									items: [{
											xtype: 'discountcollectiondetailgrid',
											width: '100%',
											itemId: 'MyDetailGrid'
										}]
								}
