Ext.define('Erems.view.popuppembatalan.Grid', {
    extend: 'Erems.library.template.view.Grid',
    alias: 'widget.popuppembatalangrid',
    store: 'Popuppembatalan',
    bindPrefixName: '',
    newButtonLabel: 'New',
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            columns: [
				...
				{
                    xtype: 'gridcolumn',
                    itemId: 'colms_cancellation_approve_date',
                    width: 150,
                    dataIndex: 'cancellation_approve_date',
                    hideable: false,
                    text: 'Approve Date',
					renderer: Ext.util.Format.dateRenderer('d-m-Y')
                },
