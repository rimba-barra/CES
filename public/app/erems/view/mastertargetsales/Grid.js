Ext.define('Erems.view.mastertargetsales.Grid', {
	extend: 'Ext.grid.Panel',

	alias: 'widget.MastertargetsalesGrid',
	itemId: 'MastertargetsalesGrid',
			...
			dockedItems: [
				{
					...
					items: [
						...
						},
						{
							...
							itemId: 'btnPrint',
							iconCls: 'icon-print',
							bindAction: 'MastertargetsalesPrint'
						},
						{
							xtype: 'button',
							action: 'export_excel',
