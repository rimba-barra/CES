Ext.define('Erems.view.popupblokirpurchaseletter.Grid', {
    extend         : 'Erems.library.template.view.Grid',
    alias          : 'widget.popupblokirpurchaselettergrid',
    store          : 'Popupblokirpurchaseletter',
    bindPrefixName : '',
    newButtonLabel : 'New',
    initComponent  : function () {
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                {
                    itemId    : 'colms_alasan_blokir',
                    dataIndex : 'alasan_blokir',
                    text      : 'Alasan Blokir',
                    width     : 150,
                },
                {
