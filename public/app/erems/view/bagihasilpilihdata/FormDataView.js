Ext.define('Erems.view.bagihasilpilihdata.FormDataView', {
	extend   : 'Erems.library.template.view.FormData',
	alias    : 'widget.bagihasilpilihdataformdataview',
	requires : [
