Ext.define('Master.library.template.controller.Controllernomodel', {
    extend: 'Master.library.template.controller.Controller0',
    nomModels: false,
    ...
    nomAcquireModels: function (callback) {
        ...
        Ext.Ajax.request({
            url: 'master/' + me.controllerName + '/read',
            params: {
    ...
    instantStore: function (data) {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                ...
                api: {
                    read: 'master/' + usedUrl + '/read',
                    create: 'master/' + usedUrl + '/create',
                    update: 'master/' + usedUrl + '/update',
                    destroy: 'master/' + usedUrl + '/delete'
                },
                reader: {
                    type: 'json',
    ...
    formDataShow: function (el, act, action) {
        ...
        if (!win) {
            win = desktop.createWindow({
                ...
                shadowOffset: 10,
                border: false,
                //items: Ext.create('Master.view.' + me.controllerName + '.FormData'),
                state: state,
                listeners: {
                    boxready: function () {
                        // win.setHeight(200);
