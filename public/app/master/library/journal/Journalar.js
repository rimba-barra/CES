Ext.define('Master.library.journal.Journalar', {
    config: null,
    ...
    GridAr: function (c, param) {
        ...
        g.on({
            ...
            edit: function (roweditor, event) {
                ...
                if (accounting.unformat(event.value) > accounting.unformat(event.record.get("remaining_balance"))) {
                    c.tools.alert.warning("Payment harus lebih kecil dari : " + accounting.formatMoney(event.record.get('remaining_balance')));
