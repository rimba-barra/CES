Ext.define('Cashier.library.journaleliminasi.Journaldetail', {
    config: null,
                ...
                if(substore.getCount()<=0){
                    ...
                    substore.each(function (rec) {
                         ...
                         if(kelsub_id == kelsub_id_h && loop == 1){
                            ...
                            value.subgl_subgl_id = rec.get('subgl_subgl_id');
                            loop = 0;
                         }
                    });
    ...
    */
    ...
    disableSave: function (c, param) {
        ...
        g.down('[action=saveasdraft]').setDisabled(true);
   ...
   sumDetailOld: function (c) {
    ...
    createcopy: function(c, param) {
        ...
        sb.each(function (record) {
            sb.removeAt(sb.find('journaldetail_indexdata', newidx));
        });
