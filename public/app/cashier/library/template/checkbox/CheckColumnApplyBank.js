 ...
 *             { xtype : 'checkcolumnapplybank', text : 'Active', dataIndex : 'active' }
 *         ]
 *     });
 *
 * The check column can be at any index in the columns array.
 */
Ext.define('Cashier.library.template.checkbox.CheckColumnApplyBank', {
extend: 'Ext.grid.column.Column',
        alternateClassName: 'Ext.ux.CheckColumn',
        alias: 'widget.checkcolumnapplybank',
        /**
         * @cfg
         * @hide
         ...
         */
        stopSelection: true,
        tdCls: Ext.baseCSSPrefix + 'grid-cell-checkcolumnapplybank',
        innerCls: Ext.baseCSSPrefix + 'grid-cell-inner-checkcolumnapplybank',
        clickTargetName: 'el',
        ...
        var cssPrefix = Ext.baseCSSPrefix,
                cls = [cssPrefix + 'grid-checkcolumnapplybank'];
                if (this.disabled) {
        meta.tdCls += ' ' + this.disabledCls;
        }
        if (value) {
        cls.push(cssPrefix + 'grid-checkcolumnapplybank-checked');
        }
