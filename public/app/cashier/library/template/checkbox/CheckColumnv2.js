 ...
 *             { xtype : 'checkcolumnv2', text : 'Active', dataIndex : 'active' }
 *         ]
 *     });
 *
 * The check column can be at any index in the columns array.
 */
Ext.define('Cashier.library.template.checkbox.CheckColumnv2', {
extend: 'Ext.grid.column.Column',
        alternateClassName: 'Ext.ux.CheckColumn',
        alias: 'widget.checkcolumnv2',
        /**
         * @cfg
         * @hide
         ...
         */
        stopSelection: true,
        tdCls: Ext.baseCSSPrefix + 'grid-cell-checkcolumnv2',
        innerCls: Ext.baseCSSPrefix + 'grid-cell-inner-checkcolumnv2',
        clickTargetName: 'el',
        ...
        renderer : function(value, meta, record) {
            ...
            row = record['data'];
            checkbox = "<center>";
            checkbox = checkbox + "<input type='checkbox' " + (value ? "checked" : '') + " name='" + me.name + "' />";
