Ext.define('Cashier.library.template.combobox.Usermodulecashierallcombobox', {
    extend: 'Cashier.library.component.Combobox',    
    alias: 'widget.usermodulecashierallcombobox',
    store: 'Usermodulecashierall', //masuk dalam store
