Ext.define('Cashier.library.template.combobox.Prefixcashierpostingcombobox', {
    extend: 'Cashier.library.component.Combobox',
    alias: 'widget.prefixcashierpostingcombobox',
    //store: 'Masterdata.store.Project', //masuk dalam store
    store: 'Prefixonglposting', //masuk dalam store
    fieldLabel: 'Prefix',
