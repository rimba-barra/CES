Ext.define('Cashier.library.template.combobox.Typecashboncombobox', {
    extend: 'Cashier.library.component.Combobox',
    alias: 'widget.typecashboncombobox',
    store: 'Typecashbon', //masuk dalam store
    dynamicdata: 0, //jika 1 maka store tidak akan di load otomatis sebaliknya jika 0 akan di load otomatis ketika from render
    fieldLabel: 'Type Trans',
    displayField: 'description', //mengambil data dari store
    valueField: 'kasbongiro', //mengambil data dari store  
