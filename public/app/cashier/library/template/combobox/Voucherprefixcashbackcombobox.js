Ext.define('Cashier.library.template.combobox.Voucherprefixcashbackcombobox', {
    extend: 'Cashier.library.component.Combobox',
    alias: 'widget.voucherprefixcashbackcombobox',
    //store: 'Masterdata.store.Project', //masuk dalam store
    store: 'Voucherprefixcashbackcombo', //masuk dalam store
    fieldLabel: 'Prefix',
    ...
    tpl: Ext.create('Ext.XTemplate',
          '<table class="x-grid-table" width="500px" >',
            '<tr class="x-grid-row">',                
                ...
                '<th width="100px"><div class="x-column-header x-column-header-inner">No.Acc</div></th>',
