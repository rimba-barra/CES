Ext.define('Cashier.library.template.combobox.VoucherprefixsetupcomboboxV2', {
    extend: 'Cashier.library.component.Combobox',
    alias: 'widget.voucherprefixsetupcomboboxV2',
    //store: 'Masterdata.store.Project', //masuk dalam store
    store: 'VoucherprefixsetupcomboV2', //masuk dalam store
    fieldLabel: 'Prefix',
    dynamicdata: 0, //jika 1 maka store tidak akan di load otomatis sebaliknya jika 0 akan di load otomatis ketika from render
    displayField: 'prefix', //mengambil data dari store
    //displayField: 'project_name', //mengambil data dari store
    valueField: 'voucherprefix_id', //mengambil data dari store   
    ...
    tpl: Ext.create('Ext.XTemplate',
          '<table class="x-grid-table" width="500px" >',
            '<tr class="x-grid-row">',
                ...
                '<th width="90px"><div class="x-column-header x-column-header-inner">In/Out</div></th>',
                '<th width="90px"><div class="x-column-header x-column-header-inner">Cash/Bank</div></th>',
            ...
            '<tpl for=".">',
                '<tr class="x-boundlist-item">',
                    ...
                    '<td><div class="x-grid-cell x-grid-cell-inner">{cash_bank}</div></td>',
                '</tr>',
            '</tpl>',
         '</table>'
     ),    
