Ext.define('Cashier.library.template.combobox.Vendornotecombobox', {
    extend: 'Cashier.library.component.Combobox',
    alias: 'widget.vendornotecombobox',
    store: 'Vendornoteb', //masuk dalam store
    fieldLabel: 'Vendor Note',
    dynamicdata: 0, //jika 1 maka store tidak akan di load otomatis sebaliknya jika 0 akan di load otomatis ketika from render
    displayField: 'note', //mengambil data dari store
    valueField: 'note', //mengambil data dari store   
