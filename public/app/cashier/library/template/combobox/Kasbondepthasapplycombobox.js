Ext.define('Cashier.library.template.combobox.Kasbondepthasapplycombobox', {
    ...
    tpl: Ext.create('Ext.XTemplate',
          '<table class="x-grid-table" width="500px" >',
            '<tr class="x-grid-row">',
                ...
                '<th width="130px"><div class="x-column-header x-column-header-inner">Department</div></th>',
            ...
            '<tpl for=".">',
                '<tr class="x-boundlist-item">',
                    ...
                    '<td><div class="x-grid-cell x-grid-cell-inner">{voucher_date_f}</div></td>',
                    '<td><div class="x-grid-cell x-grid-cell-inner">{voucher_no}</div></td>',
                    '<td ><div class="x-grid-cell x-grid-cell-inner">{department}</div></td>',                   
                    '<td ><div class="x-grid-cell x-grid-cell-inner" style="text-align:right">{amount_f}</div></td>',                   
                    '<td ><div class="x-grid-cell x-grid-cell-inner" style="text-align:right">{amount_bayar_f}</div></td>',                   
                    '<td ><div class="x-grid-cell x-grid-cell-inner" style="text-align:right">{amount_selisih_f}</div></td>', 
                    '<td ><div class="x-grid-cell x-grid-cell-inner" style="text-align:right">{remainingkasbon_f}</div></td>',                   
                    '<td ><div class="x-grid-cell x-grid-cell-inner" style="text-align:right;">{amount_kembali_f}</div></td>',                   
                    '<td ><div class="x-grid-cell x-grid-cell-inner" style="white-space:normal !important;">{description}</div></td>',                   
