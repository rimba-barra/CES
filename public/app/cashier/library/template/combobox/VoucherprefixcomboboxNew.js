Ext.define('Cashier.library.template.combobox.VoucherprefixcomboboxNew', {
    extend: 'Cashier.library.component.Combobox',
    alias: 'widget.voucherprefixcomboboxNew',
    //store: 'Masterdata.store.Project', //masuk dalam store
    store: 'VoucherprefixsetupcomboNew', //masuk dalam store
    fieldLabel: 'Prefix',
