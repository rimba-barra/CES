 ...
 *     }  
 */
Ext.define('Cashier.library.template.view.MaskField', {
    ...
    setValue: function(value) {
        ...
        if (value) {
            ...
            for (i = 0; i < length; i++) {
                ...
                if ((maskCharacter === '#' && !numericRegex.test(character)) || (maskCharacter === 'A' && !alphaRegex.test(character)) || (maskCharacter === 'A' && !alphaNumericRegex.test(character))) {
                    value = '';
                    break;
                }
            }
    ...
    processEvent: function(event) {
        ...
        if (me.readOnly) {
            ...
            if (!((code === Ext.EventObject.TAB && type === down) || (code === Ext.EventObject.ENTER && type === up) || (code === Ext.EventObject.F5 && type === down) || (event.ctrlKey && code === Ext.EventObject.C && type === down))) {
