Ext.define('Cashier.store.VDRequestdetail', {
    extend: 'Ext.data.Store',
    alias: 'store.vdrequestdetailstore',
    requires: [
        'Cashier.model.VDRequestdetail'
    ],
    constructor: function (cfg) {
        var me = this;
        cfg = cfg || {};
        me.callParent([Ext.apply({
                storeId: 'VDRequestdetailStore',
                model: 'Cashier.model.VDRequestdetail',
                proxy: {
                    type: 'ajax',
                     timeout:45000000,
                    actionMethods: {
