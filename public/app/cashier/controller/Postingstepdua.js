Ext.define('Cashier.controller.Postingstepdua', {
    ...
    requires: [
        ...
        'Cashier.library.template.checkbox.CheckColumnpostingtogl',
    ],
    views: [
    ...
    urlrequest: 'cashier/postingstepdua/create', senddata: null, info: null, message: null,
