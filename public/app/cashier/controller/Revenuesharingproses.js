Ext.define('Cashier.controller.Revenuesharingproses', {
    ...
    views: [
        'revenuesharingproses.Panel',
        'revenuesharingproses.Grid',
        'revenuesharingproses.GridMainDetail',
        'revenuesharingproses.GridMainProsesDate',
        'revenuesharingproses.FormSearch',
        'revenuesharingproses.FormData',
        'revenuesharingproses.FormPrintout',
    ],
    stores: [
        'Revenuesharingproses',
        'Revenuesharingprosesdate',
        'Revenuesharingprosesdetail',
        'Mastercluster',
        'Block',
    ],
    models: [
    ...
    refs: [
        { ref: 'panel', selector: 'revenuesharingprosespanel' },
        { ref: 'grid', selector: 'revenuesharingprosesgrid' },
        { ref: 'detailgrid', selector: 'revenuesharingprosesdetailgrid' },
        { ref: 'detailgridprosesdate', selector: 'revenuesharingprosesdategrid' },
        { ref: 'formsearch', selector: 'revenuesharingprosesformsearch' },
        { ref: 'formdata', selector: 'revenuesharingprosesformdata' },
        { ref: 'formprintout', selector: 'revenuesharingprosesformprintout' },
    ],
    ...
    docPrintExcel: function (el) {
        ...
        Ext.Ajax.request({
            url   : 'cashier/revenuesharingproses/read/?action=schema',
            params: {
            ...
            win = desktop.createWindow({
                ...
                listeners      : {
                    boxready: function () {
                        win.body.mask('Loading...');
                        var tm = setTimeout(function () {
                            win.add(Ext.create('Cashier.view.' + me.controllerName + '.FormPrintout'));
                            win.center();
                            win.body.unmask();
                            clearTimeout(tm);
                        }, 1000);
