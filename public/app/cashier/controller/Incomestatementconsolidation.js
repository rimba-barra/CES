Ext.define('Cashier.controller.Incomestatementconsolidation', {
    extend: 'Cashier.library.template.controller.Controllergl',
    alias: 'controller.Incomestatementconsolidation',
    requires: [
    ...
    views: [
        'incomestatementconsolidation.Panel',
        'incomestatementconsolidation.FormData'
    ],

    stores: [
        'Incomestatementconsolidation',
        'Coacombo',
        'Pt',
		'Levelcombox',
        'Monthdata',
    ...
    refs: [
        {
            ref: 'formdata',
            selector: 'incomestatementconsolidationformdata'
        },
        {
            ref: 'paneldata',
            selector: 'incomestatementconsolidationpanel'
        }
    ],
    controllerName: 'incomestatementconsolidation',
    fieldName: '',
    bindPrefixName: 'Incomestatementconsolidation',
    reportfile: 'Incomestatementconsolidation',
    urlprocess: 'cashier/incomestatementconsolidation/create',
    ...
    init: function (application) {
        var me = this;
        this.control({
            'incomestatementconsolidationpanel': {
            ...
            'incomestatementconsolidationformdata': {
                afterrender: function (panel) {
                    this.formDataAfterRenderCustome();

                }
            },
            'incomestatementconsolidationformdata [name=from_coa_id] ': {
                'keyup': function () {
                    var me, value;
                    me = this;
            ...
            'incomestatementconsolidationformdata [name=until_coa_id] ': {
                'keyup': function () {
                    var me, value;
                    me = this;
            ...
            'incomestatementconsolidationformdata button[action=submit]': {
                click: function () {
                   this.processReport();
                }
            },
            'incomestatementconsolidationformdata [name=pt_id]': {
                change: function (el) {
					me.setprojectpt(el.name, el.ownerCt);
                    this.loadCoabypt(el.value);                    
                }
            },
            'incomestatementconsolidationformdata [name=consolidation_id]': {
                change: function (el) {
    ...
    submitReport: function () {
        var me = this;
        me.report = 'Incomestatementconsolidation';       
    ...
    generateReportexcelthismonth: function(params){       
         ...
         me.senddata = params,
         me.urlrequest = 'cashier/incomestatementconsolidation/create';
         Ext.getBody().mask("Please wait...");
         me.AjaxRequest();       
    }, 
