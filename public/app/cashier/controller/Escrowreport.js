Ext.define('Cashier.controller.Escrowreport', {
		...
		this.control({
			'escrowreportpanel': {
                ...
                afterrender: function(panel) {
                    Ext.get('WINDOW-mnu' + me.bindPrefixName).setHeight(227);
                    Ext.get('WINDOW-mnu' + me.bindPrefixName).setWidth(630);
                    me.panelAfterRender();
                }
			},
