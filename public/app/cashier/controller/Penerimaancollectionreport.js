Ext.define('Cashier.controller.Penerimaancollectionreport', {
	extend  : 'Cashier.library.template.controller.Controllergl',
	alias   : 'controller.Penerimaancollectionreport',
	requires: [
        'Cashier.template.ComboBoxFields',
		'Cashier.library.template.combobox.ClusterV2combobox'
	],
	views    : [
        'penerimaancollectionreport.Panel', 
        'penerimaancollectionreport.FormData'],
	stores : [
        'ClusterV2'
    ],
    models: [
		...
		this.control({
			'penerimaancollectionreportpanel': {
                ...
                afterrender: function(panel) {
                    Ext.get('WINDOW-mnu' + me.bindPrefixName).setHeight(272);
	...
	exportData: function (params) {
		...
		Ext.Ajax.request({
			url     : 'cashier/penerimaancollectionreport/export/?action=schema',
			params  : params,
				...
				try {
					...
					if (resp) {
						...
						if (info.success == true) {
							...
							Ext.Msg.show({
								title: 'Failure',
								msg: 'Error 1: Create Report Penerimaan Collection Failed.',
								icon: Ext.Msg.ERROR,
								buttons: Ext.Msg.OK
							});
						}
					...
					Ext.Msg.show({
						title: 'Failure',
						msg: 'Error 2: Create Report Penerimaan Collection Failed.',
						icon: Ext.Msg.ERROR,
						buttons: Ext.Msg.OK
					});
				}
			...
			failure: function (e) {
				...
				Ext.Msg.show({
					title: 'Failure',
					msg: 'Error 3: Create Report Penerimaan Collection Failed.',
					icon: Ext.Msg.ERROR,
					buttons: Ext.Msg.OK
				});
			}
