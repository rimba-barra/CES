Ext.define('Cashier.controller.Cashflowreportdept', {
    extend: 'Cashier.library.template.controller.Controller2',
    alias: 'controller.Cashflowreportdept',
    requires: [
        'Cashier.library.template.combobox.Monthcombobox',
        'Cashier.library.template.combobox.Yearcombobox'
    ],
    views: [
        'cashflowreportdept.Panel',
        'cashflowreportdept.FormData',
        'masterreport.Panel'
    ],
    refs: [
        {
            ref: 'formdata',
            selector: 'cashflowreportdeptformdata'
        },
        {
            ref: 'paneldata',
            selector: 'cashflowreportdeptpanel'
        }
    ],
    controllerName: 'cashflowreportdept',
    fieldName: '',
    bindPrefixName: 'CashflowReportDepartment',
    ...
    init: function (application) {
        ...
        this.control({
            ...
            'cashflowreportdeptformdata': {
                afterrender: function (panel) {
                    this.formDataAfterRenderCustome();

                }
            },
            'cashflowreportdeptformdata button[action=submit]': {
                click: function () {
            ...
            'cashflowreportdeptformdata [name=alldept]': {
                change: function (el) {
                    var me = this
            ...
            'cashflowreportdeptformdata [name=projectpt_id]': {
            ...
            if (me.getFormdata().getForm().isValid()) {
                ...
                if (reporttype=='DEFAULT') {
                    if (detail == false) {
                        ...
                        reportFile = 'CashflowreportdeptNoDetail';
    ...
    panelAfterRender: function (el) {
     ...
     generateReportexcelthismonth: function(params){   
         ...
         me.senddata = params,
         me.urlrequest = 'cashier/cashflowreportdept/create';
