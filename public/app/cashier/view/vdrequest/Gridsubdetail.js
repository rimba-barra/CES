Ext.define('Cashier.view.vdrequest.Gridsubdetail', {
    extend        : 'Cashier.library.template.view.Grid',
    alias         : 'widget.vdrequestgridsubdetail',
    store         : 'VDRequestsubdetail',
    bindPrefixName: 'VDRequestSubDetail',
    itemId        : 'VDRequestsubdetail',
    title         : 'COA',
    ...
    generateDockedItemscustome: function () {
        ...
        var dockedItems = [
                ...
                items : [
                    {
                        ...
                        id        : 'btnAddNewSubDetailVdrequest'
                    },
                    {
                        xtype     : 'button',
                        action    : 'update',
            ...
            },
            {
                xtype      : 'pagingtoolbar',
                dock       : 'bottom',
                id         : 'pagingvoucherrequestsubdetail',
                width      : 360,
                displayInfo: true,
                store      : 'VDRequestsubdetail',
                hideRefresh: true,
