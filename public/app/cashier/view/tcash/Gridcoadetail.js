Ext.define('Cashier.view.tcash.Gridcoadetail', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.tcashcoadetailgrid',
    store: 'Tcashcoadetail',
    bindPrefixName: 'Tcashcoadetail',
    ...
    generateActionColumn: function () {
        ...
        var ac = {
            ...
            items: [                
                {
                    defaultIcon: 'icon-print',
                    iconCls: ' ux-actioncolumn icon-print act-print',
                    action: 'view',
                    altText: 'View',
                    tooltip: 'View'
                },
