Ext.define('Cashier.view.revenuesharingproses.Panel', {
    extend  : 'Cashier.library.template.view.Panel',
    requires: ['Cashier.view.revenuesharingproses.Grid',
        'Cashier.view.revenuesharingproses.GridMainDetail',
        'Cashier.view.revenuesharingproses.GridMainProsesDate',
        'Cashier.view.revenuesharingproses.FormSearch'],
