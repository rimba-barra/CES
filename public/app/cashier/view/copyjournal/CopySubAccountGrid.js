Ext.define('Cashier.view.copyjournal.CopySubAccountGrid', {
    extend: 'Cashier.library.template.view.Grid',
    alias: 'widget.copysubaccountgrid',
    itemId: 'CopySubAccountGrid',
    store: 'CopySubAccountJournal',
    cls: 'subaccountjournal',
    bindPrefixName: 'CopyJournalSubAccountJournal',
