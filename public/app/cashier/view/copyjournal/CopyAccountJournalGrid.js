Ext.define('Cashier.view.copyjournal.CopyAccountJournalGrid', {
    extend: 'Cashier.library.template.view.Grid',
    store: 'CopyAccountJournal',
    alias: 'widget.copyaccountjournalgrid',
    itemId: 'CopyAccountJournalGrid',
    bindPrefixName: 'CopyJournalAccountJournal',
