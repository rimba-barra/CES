Ext.define('Cashier.view.writeofflimit.FormSearch', {
    extend: 'Cashier.library.template.view.FormSearch',
    alias: 'widget.writeofflimitformsearch',
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                {
                    xtype: 'textfield',
                    itemId: 'fsms_limit_type',
                    name: 'writeofflimit_limit_type',
