Ext.define('Cashier.view.schemaescrow.PencairanFormDataDetail', {
    extend: 'Cashier.library.template.view.FormData',
    alias: 'widget.schemaescrowpencairanformdatadetail',
    requires:[
		'Cashier.library.template.component.Plafoncombobox'
	],
    frame: true,
    autoScroll: true,
    anchorSize: 100,
        ...
        Ext.applyIf(me, {
            items: [
                ...
                },
				{
               	...
               	{xtype: 'panel', bodyPadding: 10, title: 'PENCAIRAN ESCROW', collapsible: true,
                    width: '100%',
                    items: [
						{
							xtype: 'panel',
