Ext.define('Cashier.view.journaleliminasi.Grid', {
    extend: 'Cashier.library.template.view.GridDS2',
    alias: 'widget.journaleliminasigrid',
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                },
                {
                    xtype: 'gridcolumn',
                    width: 130,
                    dataIndex: 'multiproject_group_consolidation',
                    hideable: false,
                    text: 'Group Consol',
                },
                {
                ...
                items: [
                    {
                        ...
                        margin: '0 5 0 0',
                        iconCls: 'icon-new',
                        text: 'Add new journal elimination',
