Ext.define('Cashier.view.kasbondeptapprove.Griddetail', {
    extend: 'Cashier.library.template.view.Grid',
    alias: 'widget.kasbondeptapprovegriddetail',
    store: 'Kasbondeptapprovedetail',
    bindPrefixName: 'KasbondeptApprove',
    itemId: 'Kasbondeptapprovedetail',
    title: 'COA',
    ...
    generateDockedItemscustome: function () {
        ...
        var dockedItems = [
            ...
            },
            {
                xtype: 'pagingtoolbar',
                dock: 'bottom',
                id: 'pagingkasbondeptapprovedetail',
                width: 360,
                displayInfo: true,
                store: 'Kasbondeptapprovedetail',
                hideRefresh: true,
