Ext.define('Cashier.view.kasbondeptapprove.Gridsubdetail', {
    extend: 'Cashier.library.template.view.Grid',
    alias: 'widget.kasbondeptapprovegridsubdetail',
    store: 'Kasbondeptapprovesubdetail',
    bindPrefixName:'KasbondeptApprove',
    itemId: 'Kasbondeptapprovesubdetail',
    title: 'SUB COA',
    newButtonLabel: 'Add New',
    uniquename: '_kasbondeptapprovegridsubdetail',
    ...
    generateDockedItemscustome: function () {
        ...
        var dockedItems = [
            ...
            },
            {
                xtype: 'pagingtoolbar',
                dock: 'bottom',
                id: 'pagingkasbondeptapprovesubdetail',
                width: 360,
                displayInfo: true,
                store: 'Kasbondeptapprovesubdetail',
                hideRefresh: true,
