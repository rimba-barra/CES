Ext.define('Cashier.view.kasbondeptapprove.Gridattachmentdetail', {
    extend: 'Cashier.library.template.view.Grid',
    alias: 'widget.kasbondeptapprovegridattachmentdetail',
    store: 'Kasbondeptattachmentdetail',
    bindPrefixName: 'KasbondeptapproveattachmentDetail',
    itemId: 'Kasbondeptapproveattachmentdetail',
    title: 'COA',
