Ext.define('Cashier.view.writeoff.Writeoffdendagrid', {
    extend: 'Cashier.library.template.view.GridDS2',
    alias: 'widget.writeoffdendagrid',
    storeConfig: {
        id: 'writeoffdendaStore',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            columns: [
				...
				{
                    xtype: 'gridcolumn',
                    itemId: 'colms_persentase_writeoff',
                    width: 120,
                    dataIndex: 'persentase_writeoff',
                    text: 'Persentase Writeoff'
                },
