Ext.define('Cashier.view.vdapprove.Gridsubdetail', {
    extend: 'Cashier.library.template.view.Grid',
    alias: 'widget.vdapprovegridsubdetail',
    store: 'VDApprovesubdetail',
    bindPrefixName: 'VDApproveSubDetail',
    itemId: 'VDApprovesubdetail',
    title: 'COA',
