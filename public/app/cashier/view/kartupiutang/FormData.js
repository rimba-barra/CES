Ext.define('Cashier.view.kartupiutang.FormData', {
    extend: 'Cashier.library.template.view.FormData',
    alias: 'widget.kartupiutangformdata',
    requires: ['Cashier.view.kartupiutang.GridBillingSchedule',
        'Cashier.view.kartupiutang.GridListPayment',
                ...
                {xtype: 'panel', bodyPadding: 10, title: 'PURCHASE LETTER REVISION HISTORY', collapsible: true,
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [{
                                    xtype: 'kartupiutangbillingschedulegrid',
                                    width: '100%',
                                    height: 300
                                },
                                {
                            ...
                            items: [
                                {
                                    ...
                                    xtype: 'kartupiutanglistpaymentgrid',
                                    width: '100%',
                                    height: 300
                                },
                                {
