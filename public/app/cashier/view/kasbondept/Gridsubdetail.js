Ext.define('Cashier.view.kasbondept.Gridsubdetail', {
    extend: 'Cashier.library.template.view.Grid',
    alias: 'widget.kasbondeptgridsubdetail',
    store: 'Kasbondeptsubdetail',
    bindPrefixName:'Kasbondept',
    itemId: 'Kasbondeptsubdetail',
    title: 'SUB COA',
    newButtonLabel: 'Add New',
    uniquename: '_kasbondeptgridsubdetail',
