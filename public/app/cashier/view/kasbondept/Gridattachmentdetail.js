Ext.define('Cashier.view.kasbondept.Gridattachmentdetail', {
    extend: 'Cashier.library.template.view.Grid',
    alias: 'widget.kasbondeptgridattachmentdetail',
    store: 'Kasbondeptattachmentdetail',
    bindPrefixName: 'KasbondeptattachmentDetail',
    itemId: 'Kasbondeptattachmentdetail',
    title: 'COA',
