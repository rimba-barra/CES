Ext.define('Cashier.view.kasbondeptposting.Griddetail', {
    extend: 'Cashier.library.template.view.Grid',
    alias: 'widget.kasbondeptpostinggriddetail',
    store: 'Kasbondeptpostingdetail',
    bindPrefixName: 'KasbondeptPosting',
    itemId: 'Kasbondeptpostingdetail',
    title: 'COA',
    ...
    generateDockedItemscustome: function () {
        ...
        var dockedItems = [
            ...
            },
            {
                xtype: 'pagingtoolbar',
                dock: 'bottom',
                id: 'pagingkasbondeptpostingdetail',
                width: 360,
                displayInfo: true,
                store: 'Kasbondeptpostingdetail',
                hideRefresh: true,
