                ...
                defaults: {
                    ...
                    },
                    {
                        ...
                        },
                        {
                            ...
                            defaults: {anchor: '100%'},
                            layout: 'vbox',
                            padding: '0 30 35 10', //(top, right, bottom, left).
                            items: [
                            {
                                xtype: 'fieldcontainer',
                                fieldLabel: '',
                            ...
                            defaults: {anchor: '100%'},
                            layout: 'vbox',
                            padding: '10 20 8 20', //(top, right, bottom, left).
                            items: [
                            {
                                xtype: 'datefield',
                                fieldLabel: '',
                    ...
                    items: [
                    {
                        ...
                        },
                        {
                            ...
                            defaults: {anchor: '100%'},
                            layout: 'vbox',
                            padding: '0 20 55 10', //(top, right, bottom, left).
                            items: [
                            {
                                xtype: 'splitter',
                                width: '50'
                        ...
                        },
                        {
                            ...
                            width:190,
                            layout: 'vbox',
                            padding: '0 10 2 20', //(top, right, bottom, left).
                            items: [
                            {
                                xtype: 'splitter',
                                width: '20'
                            ...
                            },
                            {
                                xtype: 'xmoneyfield',
                                fieldLabel: '',
                                itemId: 'fd_amount_start',
                                id: 'fd_amount_start',
                                name: 'fd_amount_start',
                                maskRe: /[^\`\"\']/,
                                maxLength: 50,
                                allowBlank: false,
                                enforceMaxLength: true,
