Ext.define('Cashier.view.vdposting.Grid', {
    extend: 'Cashier.library.template.view.Grid',
    alias: 'widget.vdpostinggrid',
    store: 'VDPosting',
    ...
    initComponent: function () {
                ...
                },
		{
                ...
                {
                    xtype: 'gridcolumn',
                    itemId: 'colms_kasbondept_no',
                    dataIndex: 'kasbondept_no',
                    width: 150,
                    titleAlign: 'left',
                    align: 'left',
                    hideable: false,
                    text: 'Cashbon Dept No'
                },
                {
                    xtype: 'gridcolumn',
                    itemId: 'colms_kasbondept_date',
                    dataIndex: 'kasbondept_date',
                    width: 150,
                    titleAlign: 'left',
                    align: 'left',
                    hideable: false,
                    text: 'Cashbon Dept Date',
                    renderer: Ext.util.Format.dateRenderer('d-m-Y')
                },
                 {
                    xtype: 'gridcolumn',
                ...
                {
                    xtype: 'gridcolumn',
                    itemId: 'colms_kasbondept_amount',
                    dataIndex: 'kasbondept_amount',
                    width: 150,
                    titleAlign: 'left',
                    align: 'left',
                    hideable: false,
                    text: 'Cashbon Request Amount',
                    renderer: Ext.util.Format.numberRenderer('0,000.00'),
                },
                {
                    xtype: 'gridcolumn',
                    itemId: 'colms_kasbondept_description',
                    dataIndex: 'kasbondept_description',
                    width: 250,
                    titleAlign: 'left',
                    align: 'left',
                    hideable: false,
                    text: 'Cashbon Dept Description'
                },
                {
                    xtype: 'gridcolumn',
