            ...
            columns: [
                ...
                },
                {
                ...
                },
                  {
                    ...
                    renderer: function (value, metaData, record, row, col, store, gridView) {
                        var pengajuan_berkas_date = moment(record.get('pengajuan_berkas_date')).format("DD-MM-YYYY");
                        var now = moment(new Date()).format("DD-MM-YYYY");
                        if (pengajuan_berkas_date === "01-01-1900") {
                            return now;
                        }
                        else {
                            var dt = new Date(pengajuan_berkas_date);
                            return pengajuan_berkas_date;
                        }
