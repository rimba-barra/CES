Ext.define('Cashier.view.voucher.AngsuranGrid', {
    extend     : 'Cashier.library.template.view.GridDS2Browse',
    alias      : 'widget.voucherangsurangrid',
    storeConfig: {
        id         : 'IDselectedAngsuranStore',
  ...
  //                        hidden:true
                    ...
                    {
                        xtype     : 'checkboxfield',
                        itemId    : 'isdendacheckboxf7',
                        id        : 'isdendacheckboxf7',
                        name      : 'isdendacheckboxf7',
                        readOnly  : false,
                        fieldLabel: 'untuk Denda?',
                        width     : 250,
  //                        hidden:true
                    },
                ]
  ...
  //            },
            ...
            },
            {
                ...
                fieldLabel      : 'Virtual Account No',
                enforceMaxLength: true,
                maskRe          : /[^\`\"\']/,
                maxLength       : 50,
                width           : 100,
                id              : 'virtualaccountNoId',
            },
            {
                xtype       : 'combobox',
                name        : 'block_id',
