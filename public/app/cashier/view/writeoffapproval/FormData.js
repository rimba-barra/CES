Ext.define('Cashier.view.writeoffapproval.FormData', {
    extend: 'Cashier.library.template.view.FormData',
    alias: 'widget.writeoffapprovalformdata',
    frame: true,
    autoScroll: true,
    anchorSize: 100,
    bodyBorder: true,
    ...
    id: 'formdatawriteoffapprovalID',
    itemId:'formdatawriteoffapprovalID',
    rowData: null,
    width: 1000,
    height: 650,
                    ...
                    items: [
                                                        {
                                                                ...
                                                                bodyStyle: 'border:0px',
                                                                items: [{
                                                                                xtype: 'writeoffapprovaldendagrid',
                                                                                width: '100%',
                                                                                itemId: 'MyDendaGrid'
                                                                }]
                                                        }
