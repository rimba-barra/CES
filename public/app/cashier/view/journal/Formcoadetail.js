Ext.define('Cashier.view.journal.Formcoadetail', {
    extend: 'Cashier.library.template.view.FormData',
    alias: 'widget.journalformcoadetail',
    requires: ['Cashier.view.journal.Gridsubcoadetail'],
    frame: true,
    minimizable: false,
    autoScroll: true,
    anchorSize: 100,
...
//                },
               
            {
                ...
                {xtype: 'journalsubcoadetailgrid',
                    itemId:'journalsubcoadetail_grid',
                    name:'journalsubcoadetailgrid',
                    hidden:true
                }
