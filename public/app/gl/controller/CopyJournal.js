Ext.define('Gl.controller.Copyjournal', {
    extend: 'Gl.library.template.controller.Controllergl',
    alias: 'controller.Copyjournal',
    requires: [
        'Gl.library.template.combobox.Yeardbcombobox',
        'Gl.library.template.combobox.Prefixcombobox',
        'Gl.library.template.combobox.Vouchernocomboboxcopy',
    ],
    views: [
        'copyjournal.Panel',
    ...
    urlprocess: 'gl/copyjournal/create',
        ...
        this.control({
            ...
            'copyjournalformdata button[action=view]': {
                click: function () {
                    ...
                    locationform = 'Gl.view.copyjournal.FormDataCopyJournal';
    ...
    processData: function () {
        ...
        if (form.isValid()) {
            ...
            untilvoucherno = me.getValue(me, "untilvoucherno", "raw");
