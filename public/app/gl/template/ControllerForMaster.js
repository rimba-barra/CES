Ext.define('Erems.template.ControllerForMaster', {
    ...
    requires: ['Erems.library.Browse', 'Erems.library.box.Config','Erems.library.box.tools.DefaultConfig','Erems.library.box.tools.StoreProcessor', 'Erems.library.box.tools.EventSelector','Erems.library.box.tools.Tools'],
    views: [],
    comboBoxIdEl: [],
    fillForm: null,
    formWidth: 500,
