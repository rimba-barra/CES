Ext.define('Gl.view.journal.FormData', {
    extend: 'Gl.library.template.view.FormData',
    alias: 'widget.journalformdata',
    requires:[
        'Gl.view.journal.AccountJournalGrid',
        'Gl.view.journal.SubAccountGrid'
     ],
    frame: true,
    autoScroll: true,
    anchorSize: 100,
