Ext.define('Gl.view.accountvssub.FormData', {
    extend: 'Gl.library.template.view.FormData',
    alias: 'widget.accountvssubformdata',
    requires:[
        'Gl.view.accountvssub.AccountvsSubAccountJournalGrid',
        'Gl.view.accountvssub.AccountvsSubSubAccountGrid'
     ],
    frame: true,
    autoScroll: true,
    anchorSize: 100,
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'accountvssubaccountjournalgrid',
                        ...
                        {
                            xtype: 'accountvssubsubaccountgrid',
