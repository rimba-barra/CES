Ext.define('Gl.view.subvsaccount.SubvsAccountSubAccountGrid', {
    extend: 'Gl.library.template.view.Grid',
    alias: 'widget.subvsaccountsubaccountgrid',
    itemId: 'SubvsAccountSubAccountGrid',
    store: 'SubvsAccountSubAccountJournal',
