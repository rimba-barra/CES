Ext.define('Gl.view.subvsaccount.FormData', {
    extend: 'Gl.library.template.view.FormData',
    alias: 'widget.subvsaccountformdata',
    requires:[
        'Gl.view.subvsaccount.SubvsAccountAccountJournalGrid',
        'Gl.view.subvsaccount.SubvsAccountSubAccountGrid'
     ],
    frame: true,
    autoScroll: true,
    anchorSize: 100,
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'subvsaccountaccountjournalgrid',
                        ...
                        {
                            xtype: 'subvsaccountsubaccountgrid',
