Ext.define('Gl.view.changenumberordatevoucher.ChangeAccountJournalGrid', {
    extend: 'Gl.library.template.view.Grid',
    store: 'ChangeAccountJournal',
    alias: 'widget.changeaccountjournalgrid',
    itemId: 'ChangeAccountJournalGrid',
    bindPrefixName: 'ChangeAccountJournal',
