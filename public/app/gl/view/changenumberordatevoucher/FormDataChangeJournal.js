Ext.define('Gl.view.changenumberordatevoucher.FormDataChangeJournal', {
    extend: 'Gl.library.template.view.FormData',
    alias: 'widget.changejournalformdata',
    requires: [
        'Gl.view.changenumberordatevoucher.ChangeAccountJournalGrid',
        'Gl.view.changenumberordatevoucher.ChangeSubAccountGrid'
    ],
    frame: true,
    autoScroll: true,
    anchorSize: 100,
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'changeaccountjournalgrid',
