Ext.define('Gl.view.koreksisetelahposting.FormData', {
    extend: 'Gl.library.template.view.FormData',
    alias: 'widget.koreksisetelahpostingformdata',
    requires:[
        'Gl.view.koreksisetelahposting.AccountJournalGrid',
