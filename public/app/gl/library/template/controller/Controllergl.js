Ext.define('Gl.library.template.controller.Controllergl', {//mendefine terhadap alamat file Controllergl.js
    extend: 'Gl.library.template.controller.Controller', //mengextends dari file Controller.js sebagai induknya
    ...
    instantWindow: function (panel, width, title, state, id, controller) {
        ...
        if (!win) {
            win = desktop.createWindow({
                ...
                shadowOffset: 10,
                border: false,
                items: Ext.create('Gl.view.' + controllerFolder + '.' + panel),
                state: state
            });
        }
        win.show();
    ...
    downloadCSV: function(args, csvData) {  
