Ext.define('Gl.library.template.controller.Controller', {
    ...
    panelAfterRender: function (el) {
        this.initGeneralShortcut(el);
    },
    initGeneralShortcut: function(el, controller=null){
        var me = this;
        ...
        document.onkeyup=function(e){
          ...
          if(event.altKey && event.keyCode == 81){  //SHIFT+Q = close window
          ...
          if(event.altKey && event.keyCode === 70){  //SHIFT+F search
            if(typeof el !== 'undefined' ){
            ...
            win = desktop.createWindow({
                ...
                listeners: {
                    boxready: function () {
                        win.body.mask('Loading...');
                        var tm = setTimeout(function () {
                            win.add(Ext.create('Gl.view.' + me.controllerName + '.FormImport'));
                            win.center();
                            win.body.unmask();
                            clearTimeout(tm);
                        }, 1000);
