...
Ext.define('Gl.library.box.tools.Tools', {
    config: null,
    ...
    comboHelper: function(comboBox) {
        var x = {
            ...
            getField: function(fieldId, field) {
                return comboBox.getStore().getAt(comboBox.getStore().findExact(fieldId, comboBox.getValue())).get(field);
            },
