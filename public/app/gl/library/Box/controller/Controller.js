...
Ext.define('Gl.library.box.controller.Controller', {
    extend: 'Ext.app.Controller',
    /* ORI*/
    requires: ['Gl.library.box.Config', 'Gl.library.box.tools.TextCombo'],
    rights: {
        create: false,
        update: false,
        destroy: false,
    ...
    constructor: function(configs) {
        ...
        var me = this;
        this.myConfig = new Gl.library.box.Config({
            _controllerName: me.controllerName
        });
        this.textCombo = new Gl.library.box.tools.TextCombo();
    ...
    instantWindow: function(panel, width, title, state, id, folder, panelConfig) {
        ...
        if (!win) {
            ...
            win = desktop.createWindow({
                ...
                shadowOffset: 10,
                border: false,
                items: Ext.create('Gl.view.' + fd + '.' + panel, pc),
                state: state
            });
        }
        win.show();
    ...
    instantStore: function(data) {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                ...
                api: {
                    read: 'gl/' + usedUrl + '/read',
                    create: 'gl/' + usedUrl + '/create',
                    update: 'gl/' + usedUrl + '/update',
                    destroy: 'gl/' + usedUrl + '/delete'
                },
                reader: {
                    type: 'json',
    ...
    uploadImage: function(params) {
        ...
        form.submit({
            url: 'gl/' + me.controllerName + '/upload',
