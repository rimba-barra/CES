Ext.define('Gl.library.box.controller.template.Masterdata', {
    extend: 'Gl.library.box.controller.Controller',
    alias: 'controller.tmasterdata',
    requires: ['Gl.library.box.tools.DefaultConfig', 'Gl.library.box.tools.EventSelector',
        'Gl.library.box.tools.Tools', 'Gl.library.box.Config', 'Gl.minic.lookup.Employee',
        'Gl.library.box.tools.CRUDButtonHandlerFmd'],
    views: [],
    tools: null,
    myConfig: null,
            ...
            destroy: function() {
                ...
                if (rec) {
                    Ext.Msg.show({
                        ...
                        fn: function(clicked) {
                            if (clicked === "yes") {
                                var useFunc = me.crudbrFuncdestroy();
                                if (useFunc.use) {
                                    useFunc.fn(rec);
                                } else {
    ...
    panelAfterRender: function(el) {
        ...
        var me = this;
        me.crudh = new Gl.library.box.tools.CRUDButtonHandlerFmd({
