Ext.define('Hrd.library.box.tools.EventSelector2', {
    id: '',
    ...
    getEvents: function(me, controllerName) {
        ...
        events[grid + ' toolbar button[action=cancel]'] = {
            click: function(fld, a) {
                me.cancelOnClick();
            }

        };
        events[grid + ' toolbar button[action=save]'] = {
            click: function(fld, a) {
                me.saveOnClick();
            }

        };
        events[grid + ' toolbar button[action=edit]'] = {
            click: function(fld, a) {
                me.editOnClick();
            }

        };
        events[grid + ' toolbar button[action=delete]'] = {
            click: function(fld, a) {
                me.deleteOnClick();
            }
