...
Ext.define('Hrd.library.box.controller.Controller', {
            ...
            dataDestroy: function() {
                ...
                if (rows.length < 1) {
                    ...
                    if (rows.length == 1) {
                        ...
                        // add by wulan sari 20200806
                        var fieldname = me.fieldNameForDeleted == ''? me.fieldName : me.fieldNameForDeleted;
    ...
    syncParams: function(form, store, msg, mode, otherStoreUsed) {
        ...
        var x = {
            ...
            failure: function(batch, op) {
                ...
                // added by wulan 20200806
                // karena ada bugs saat validasi save nyangkut di action sebelumnya
                store.reload();
    ...
    uploadImage: function(params) {
        ...
        var paramsAjax = typeof params.params === 'undefined' ? {} : params.params;
        var showAlert = typeof params.showalert === 'undefined' ? true : params.showalert;
        form.submit({
    ...
    uploadFile: function(params) {
        ...
        form.submit({
            ...
            failure: function(f, a) {
                ...
                // console.log(f);
                //  console.log(a);
                var respon = a.response.responseText;
                if (respon) {
                    var info = Ext.JSON.decode(respon);
                    console.log(info);
                    var success = info['data']['others'][0][0]['HASIL'];
                    //fileExtensionFalse
                    var msg = info['data']['others'][0][0]['MSG'];
                    if (success) {
                        Ext.MessageBox.show({
                            title: "",
                            msg: "File UPLOADED",
    ...
    attachModel: function(operation, store, eraseOld) {
        var me = this;
		// check jika formantnya json
		if(operation.response.responseText.length < 5){
			console.log("[CTRLERR] Data respon bukan format json.");
			return false;
		}
    ...
    registerMiniCtrlAlt: function(name, miniController) {
        ...
        console.log(me.miniControllers);
    ...
    // added by wulan sari 20190626 : untuk menampilkan xxx saat group tidak ada
    limitedAccessGroup: function(f, data) {
        var fcombo_group_id, fgroup_name, sf_group_id, vgroup_id, fcombo_group_id_display, cb, cb_display, text_name;
        ...
        var groupStore = f.down("[name=" + fcombo_group_id_display + "]").getStore();
