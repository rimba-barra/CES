Ext.define('Hrd.controller.Promosireport', {
    extend: 'Hrd.library.box.controller.ControllerReport',
    alias: 'controller.promosireport',
    controllerName: 'promosireport',
    bindPrefixName: 'Promosireport',
    ...
    processParams: function(reportData) {
        ...
        switch (reportData['params']['report_type']) {
                 case 'promosi': reportData['file'] = 'HrdPromosi';break;
                 case 'mutasi': reportData['file'] = 'HrdMutasi';break;
