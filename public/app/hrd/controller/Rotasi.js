Ext.define('Hrd.controller.Rotasi', {
    ...
    init: function () {
        ...
        newEvs['#employeeTRotasiwindow lookuppersonalgrid button[action=select]'] = {
            click: function () {
                me.selectEmployee();
            }

        };
        newEvs['#employeeTRotasiwindow lookuppersonalgrid'] = {
    ...
    lookupEmployee: function () {
        ...
        me = this;
        window = me.instantWindow("Panel", 600, "Employe List", "create", "employeeTRotasiwindow", "lookup.personal", {
