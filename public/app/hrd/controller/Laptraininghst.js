Ext.define('Hrd.controller.Laptraininghst', {
    extend: 'Hrd.library.box.controller.ControllerReport',
    alias: 'controller.laptraininghst',
    controllerName: 'laptraininghst',
    bindPrefixName: 'Laptraininghst',
    ...
    //   reportData['params']['department_id'] = departmentId==="999"?"0":departmentId;
       console.log(reportData);
        switch (reportData['params']['report_type']) {
                 case 'detil': reportData['file'] = 'HrdTrainingHistorikal';break;
                     case 'rekap': reportData['file'] = reportData['params']['index_data']==='department'?'HrdTrainingHistorikalRekap':'HrdTrainingHistorikalRekap';break;
