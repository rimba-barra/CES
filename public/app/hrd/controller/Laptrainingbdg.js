Ext.define('Hrd.controller.Laptrainingbdg', {
    extend: 'Hrd.library.box.controller.ControllerReport',
    alias: 'controller.laptrainingbdg',
    controllerName: 'laptrainingbdg',
    bindPrefixName: 'Laptrainingbdg',
    ...
    processParams: function(reportData) {
        ...
        var year = 0;
        var date = new Date(reportData['params']['date']);
        if(date){
      ...
      //  reportData['params']['end_date_text'] = me.tools.dateFunc(reportData['params']['end_date']).toDMY('/');
       ...
       console.log(reportData);
        switch (reportData['params']['report_type']) {
                 case 'karyawan': reportData['file'] = 'HrdTrainingBudget';break;
