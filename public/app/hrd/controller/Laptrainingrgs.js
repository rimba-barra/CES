Ext.define('Hrd.controller.Laptrainingrgs', {
    extend: 'Hrd.library.box.controller.ControllerReport',
    alias: 'controller.laptrainingrgs',
    controllerName: 'laptrainingrgs',
    bindPrefixName: 'Laptrainingrgs',
     ...
     //   reportData['params']['start_date_text'] = me.tools.dateFunc(reportData['params']['start_date']).toDMY('/');
      //  reportData['params']['end_date_text'] = me.tools.dateFunc(reportData['params']['end_date']).toDMY('/');
        ...
        switch (reportData['params']['report_type']) {
                 case 'jenistraining': reportData['file'] = 'HrdTrainingRegistrasi';break;
                     case 'karyawan': reportData['file'] = 'HrdTrainingRegistrasiPerKaryawan';break;
