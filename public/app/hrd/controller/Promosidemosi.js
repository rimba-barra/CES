Ext.define('Hrd.controller.Promosidemosi', {
    ...
    init: function () {
        ...
        newEvs['#employeeTPromosiDewindow lookuppersonalgrid button[action=select]'] = {
            click: function () {
                me.selectEmployee();
            }

        };
        newEvs['#employeeTPromosiDewindow lookuppersonalgrid'] = {
    ...
    lookupEmployee: function () {
        ...
        me = this;
        window = me.instantWindow("Panel", 600, "Employe List", "create", "employeeTPromosiDewindow", "lookup.personal", {
