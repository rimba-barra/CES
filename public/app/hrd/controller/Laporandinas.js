Ext.define('Hrd.controller.Laporandinas', {
    extend: 'Hrd.library.box.controller.ControllerReport',
    alias: 'controller.laporandinas',
    controllerName: 'laporandinas',
    bindPrefixName: 'Laporandinas',
    ...
    processParams: function(reportData) {
        ...
        switch (reportData['params']['report_type']) {
            case 'detil': reportData['file'] = 'HrdDinasDetail';break;
            case 'rekap': reportData['file'] = 'HrdDinasRekap';break;
