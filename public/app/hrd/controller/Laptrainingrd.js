Ext.define('Hrd.controller.Laptrainingrd', {
    extend: 'Hrd.library.box.controller.ControllerReport',
    alias: 'controller.laptrainingrd',
    controllerName: 'laptrainingrd',
    bindPrefixName: 'Laptrainingrd',
      ...
      //  reportData['params']['end_date_text'] = me.tools.dateFunc(reportData['params']['end_date']).toDMY('/');
       ...
       console.log(reportData);
        switch (reportData['params']['report_type']) {
                 case 'laporan': reportData['file'] = 'HrdTrainingRekapDurasi';break;
