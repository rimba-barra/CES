Ext.define('Hrd.controller.Generalreport', {
    extend: 'Hrd.library.box.controller.ControllerReport',
    alias: 'controller.generalreport',
    controllerName: 'generalreport',
    bindPrefixName: 'Generalreport',
    otherParamsAT :{leave:0,sick:0,permission:0},
    init: function(application) {
        this.callParent(arguments);
        var newEvs = {};
        var me = this;
        newEvs['#GeneralreportFormID button[action=export]'] = {
