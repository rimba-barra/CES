Ext.define('Hrd.view.overtimetransaction.FormDataIntranetOvertime', {
    alias: 'widget.overtimeformdataintranetovertime',
    extend: 'Hrd.library.box.view.FormData',
    requires: ['Hrd.view.overtimetransaction.Griddetailpopup'],
    frame: true,
    autoScroll: true,
    uniquename: "_overtimeformdataintranetovertime",
    deletedData: {},
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'overtimetransactionGriddetailpopup',
                            height: 180,
                            flex: 2,
