Ext.define('Hrd.view.overtimetransaction.Formoptionsovertime', {
    alias: 'widget.overtimetransactionformoptionsovertime',
    extend: 'Hrd.library.box.view.FormData',
    frame: true,
    autoScroll: true,
    requires: ['Hrd.view.overtimetransaction.Gridbrowseintranetovertime'],
    uniquename: "_overtimetransactionformoptionsovertime",
    deletedData: {},
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                {
                    xtype: 'overtimetransactionGridbrowseintranetovertime',
                    height: 300,
