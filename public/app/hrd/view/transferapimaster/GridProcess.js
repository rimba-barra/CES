Ext.define('Hrd.view.transferapimaster.GridProcess', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.transferapimasterprocessgrid',
    storeConfig: {
        id: 'TransferapimasterGridProcessStore',
        idProperty: 'department_id',
        extraParams: {}
    },
    bindPrefixName: 'department',
    newButtonLabel: 'New',
    itemId:'TransferapimasterGridProcessID',
    layout: 'fit',
