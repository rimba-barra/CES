Ext.define('Hrd.view.transferapimaster.GridProcessEmployee', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.transferapimasterprocessemployeegrid',
    storeConfig: {
        id: 'TransferapimasterGridProcessEmployeeStore',
        idProperty: 'employee_id',
        extraParams: {}
    },
    bindPrefixName: 'employee_name',
    newButtonLabel: 'New',
    itemId:'TransferapimasterGridProcessEmployeeID',
    layout: 'fit',
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                {
                   dataIndex: 'statusinformation_consultant_start',
                   text: 'Consultant Start Date',
                   width:100,
                   // format:'Y-m-d',
                   // xtype:'datecolumn'
                },
                {
                   dataIndex: 'statusinformation_consultant_end',
                   text: 'Consultant End Date',
                   width:100,
                   // format:'Y-m-d',
                   // xtype:'datecolumn'
                },
                ...
                {
                   dataIndex: 'code_alokasibiaya',
                   text: 'Alokasi Biaya Code',
                   width:100
                }, 
                {
                   dataIndex: 'name_alokasibiaya',
                   text: 'Alokasi Biaya PT',
                   width:100
                }, 
                {
                   dataIndex: 'code_alokasibiaya2',
                   text: 'Alokasi Biaya Code 2',
                   width:120
                }, 
                {
                   dataIndex: 'name_alokasibiaya2',
                   text: 'Alokasi Biaya PT 2',
                   width:120
                }, 
                {
                   dataIndex: 'code_alokasibiaya3',
                   text: 'Alokasi Biaya Code 3',
                   width:120
                }, 
                {
                   dataIndex: 'name_alokasibiaya3',
                   text: 'Alokasi Biaya PT 3',
                   width:120
                }, 
                // {
