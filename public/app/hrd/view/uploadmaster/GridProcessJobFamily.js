Ext.define('Hrd.view.uploadmaster.GridProcessJobFamily', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.uploadmasterprocessjobfamilygrid',
    storeConfig: {
        id: 'UploadmasterGridProcessJobFamilyStore',
        idProperty: 'jobfamily_id',
        extraParams: {}
    },
    bindPrefixName: 'jobfamily',
    newButtonLabel: 'New',
    itemId:'UploadmasterGridProcessJobFamilyID',
    layout: 'fit',
