Ext.define('Hrd.view.uploadmaster.GridProcessGroup', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.uploadmasterprocessgroupgrid',
    storeConfig: {
        id: 'UploadmasterGridProcessGroupStore',
        idProperty: 'group_id',
        extraParams: {}
    },
    bindPrefixName: 'group',
    newButtonLabel: 'New',
    itemId:'UploadmasterGridProcessGroupID',
    layout: 'fit',
