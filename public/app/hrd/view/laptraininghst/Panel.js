Ext.define('Hrd.view.laptraininghst.Panel', {
    extend: 'Hrd.library.box.view.Panel',
    alias: 'widget.laptraininghstpanel',
                        ...
                        },
                        {
                            ...
                            items: [
                                
                                {
                                    ...
                                    flex: 3,
                                    items: [
                                        {boxLabel: 'Departemen', name: 'index_data', inputValue: "department", checked: true},
                                        {boxLabel: 'Karyawan', name: 'index_data', inputValue: "karyawan"},
                                        ,
                                    ]
                                },
