Ext.define('Hrd.view.trainingreport.Panel', {
    extend: 'Hrd.library.box.view.Panel',
    alias: 'widget.trainingreportpanel',
    requires: ['Hrd.template.ComboBoxFields'],
    itemId: 'TrainingReportPanel',
    layout: 'fit',
    autoScroll: true,
    height: '300px',
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                            ...
                                            {boxLabel: 'Report', name: 'report_type', inputValue: "training", checked: true},
                                            //added by anas 22062022
                                            {boxLabel: 'Report Survey', name: 'report_type', inputValue: "survey"}
                                        ,
                                    ]
                                }
                            ]
