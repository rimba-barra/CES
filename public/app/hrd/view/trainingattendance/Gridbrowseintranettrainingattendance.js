Ext.define('Hrd.view.trainingattendance.Gridbrowseintranettrainingattendance', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.gridbrowseintranettrainingattendance',
    storeConfig: {
        id: 'gridbrowseintranettrainingattendance',
        idProperty: 'trainingregister_id',
        extraParams: {
            mode_read: 'getdatatrainingattendanceintranet'
        }
    },
