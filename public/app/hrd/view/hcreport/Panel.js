Ext.define('Hrd.view.hcreport.Panel', {
    extend: 'Hrd.library.box.view.Panel',
    alias: 'widget.hcreportpanel',
    itemId: 'HcreportPanel',
    layout: 'fit',
    autoScroll: true,
    height: '200px',
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        {boxLabel: 'Annual Report', name: 'report_type', inputValue: "annual"},
