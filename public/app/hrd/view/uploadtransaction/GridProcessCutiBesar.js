Ext.define('Hrd.view.uploadtransaction.GridProcessCutiBesar', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.uploadtransactionprocesscutibesargrid',
    storeConfig: {
        id: 'UploadtransactionGridProcessCutiBesarStore',
        idProperty: 'department_id',
        extraParams: {}
    },
    bindPrefixName: 'department',
    newButtonLabel: 'New',
    itemId:'UploadtransactionGridProcessCutiBesarID',
    layout: 'fit',
