Ext.define('Hrd.view.uploadtransaction.GridProcessOvertime', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.uploadtransactionprocessovertimegrid',
    storeConfig: {
        id: 'UploadtransactionGridProcessOvertimeStore',
        idProperty: 'department_id',
        extraParams: {}
    },
    bindPrefixName: 'department',
    newButtonLabel: 'New',
    itemId:'UploadtransactionGridProcessOvertimeID',
    layout: 'fit',
