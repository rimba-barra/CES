Ext.define('Hrd.view.uploadtransaction.GridProcess', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.uploadtransactionprocessgrid',
    storeConfig: {
        id: 'UploadtransactionGridProcessStore',
        idProperty: 'department_id',
        extraParams: {}
    },
    bindPrefixName: 'department',
    newButtonLabel: 'New',
    itemId:'UploadtransactionGridProcessID',
    layout: 'fit',
