Ext.define('Hrd.view.uploadtransaction.GridProcessSaldoCutiMinus', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.uploadtransactionprocesssaldocutiminusgrid',
    storeConfig: {
        id: 'UploadtransactionGridProcessSaldoCutiMinusStore',
        idProperty: 'department_id',
        extraParams: {}
    },
    bindPrefixName: 'department',
    newButtonLabel: 'New',
    itemId:'UploadtransactionGridProcessSaldoCutiMinusID',
    layout: 'fit',
