Ext.define('Hrd.view.uploadtransaction.GridProcessUangMakan', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.uploadtransactionprocessuangmakangrid',
    storeConfig: {
        id: 'UploadtransactionGridProcessUangMakanStore',
        idProperty: 'department_id',
        extraParams: {}
    },
    bindPrefixName: 'department',
    newButtonLabel: 'New',
    itemId:'UploadtransactionGridProcessUangMakanID',
    layout: 'fit',
