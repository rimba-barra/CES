Ext.define('Hrd.view.promosireport.Panel', {
    extend: 'Hrd.library.box.view.Panel',
    alias: 'widget.promosireportpanel',
                            ...
                            items: [
                                {
                                    ...
                                    flex: 3,
                                    items: [
                                        {boxLabel: 'Promosi', name: 'report_type', inputValue: "promosi", checked: true},
                                        {boxLabel: 'Mutasi', name: 'report_type', inputValue: "mutasi"},
