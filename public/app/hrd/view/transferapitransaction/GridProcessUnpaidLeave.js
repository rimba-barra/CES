Ext.define('Hrd.view.transferapitransaction.GridProcessUnpaidLeave', {
    extend: 'Hrd.library.box.view.Grid',
    alias: 'widget.transferapitransactionprocessunpaidleavegrid',
    storeConfig: {
        id: 'TransferapitransactionGridProcessUnpaidLeaveStore',
        idProperty: 'department_id',
        extraParams: {}
    },
    bindPrefixName: 'department',
    newButtonLabel: 'New',
    itemId:'TransferapitransactionGridProcessUnpaidLeaveID',
    layout: 'fit',
