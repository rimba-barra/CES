Ext.define('Hrd.view.absentrecord.Formoptionssakit', {
    alias: 'widget.absentrecordformoptionssakit',
    extend: 'Hrd.library.box.view.FormData',
    frame: true,
    autoScroll: true,
    requires: ['Hrd.view.absentrecord.Gridbrowseintranetsakit'],
    uniquename: "_absentrecordformoptionssakit",
    deletedData: {},
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                {
                    xtype: 'absentrecordgridbrowseintranetsakit',
                    height: 300,
