Ext.define('Hrd.view.absentrecord.Formoptionsovertime', {
    alias: 'widget.absentrecordformoptionsovertime',
    extend: 'Hrd.library.box.view.FormData',
    frame: true,
    autoScroll: true,
    requires: ['Hrd.view.absentrecord.Gridbrowseintranetovertime'],
    uniquename: "_absentrecordformoptionsovertime",
    deletedData: {},
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                {
                    xtype: 'absentrecordGridbrowseintranetovertime',
                    height: 300,
