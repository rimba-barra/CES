Ext.define('Hrd.view.absentrecord.Formoptionspdlk', {
    alias: 'widget.absentrecordformoptionspdlk',
    extend: 'Hrd.library.box.view.FormData',
    frame: true,
    autoScroll: true,
    requires: ['Hrd.view.absentrecord.Gridbrowseintranetpdlk'],
    uniquename: "_absentrecordformoptionspdlk",
    deletedData: {},
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                {
                    xtype: 'absentrecordgridbrowseintranetpdlk',
                    height: 300,
