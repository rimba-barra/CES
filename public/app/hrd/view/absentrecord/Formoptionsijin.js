Ext.define('Hrd.view.absentrecord.Formoptionsijin', {
    alias: 'widget.absentrecordformoptionsijin',
    extend: 'Hrd.library.box.view.FormData',
    frame: true,
    autoScroll: true,
    requires: ['Hrd.view.absentrecord.Gridbrowseintranetijin'],
    uniquename: "_absentrecordformoptionsijin",
    deletedData: {},
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                {
                    xtype: 'absentrecordgridbrowseintranetijin',
                    height: 300,
