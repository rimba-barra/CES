Ext.define('Hrd.view.absentrecord.Formoptionsdinas', {
    alias: 'widget.absentrecordformoptionsdinas',
    extend: 'Hrd.library.box.view.FormData',
    frame: true,
    autoScroll: true,
    requires: ['Hrd.view.absentrecord.Gridbrowseintranetdinas'],
    uniquename: "_absentrecordformoptionsdinas",
    deletedData: {},
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                {
                    xtype: 'absentrecordgridbrowseintranetdinas',
                    height: 300,
