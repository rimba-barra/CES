Ext.define('Hrd.view.absentrecord.FormDataIntranetCuti', {
    alias: 'widget.absentrecordformdataintranetcuti',
    extend: 'Hrd.library.box.view.FormData',
    frame: true,
    autoScroll: true,
    uniquename: "_absentrecordformdataintranetcuti",
    requires: ['Hrd.template.combobox.AbsentType',
        'Hrd.view.absentrecord.GridCutidetail'
    ],
    deletedData: {},
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        //added by michael 16/11/2021
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    fieldLabel:' ',
                                    text:'View File',
                                    itemId: 'view_file_cuti',
                                    action:'view_file_cuti',
                                    margin: '10 0px',
                                }
                            ]
                        },
                        ...
                        {
                            xtype: 'absentrecordgridintranetcutidetail',
                            height: 200,
