Ext.define('Hrd.view.absentrecord.Formoptionstukarshift', {
    alias: 'widget.absentrecordformoptionstukarshift',
    extend: 'Hrd.library.box.view.FormData',
    frame: true,
    autoScroll: true,
    requires: ['Hrd.view.absentrecord.Gridbrowseintranettukarshift'],
    uniquename: "_absentrecordformoptionstukarshift",
    deletedData: {},
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                             ...
                             enforceMaxLength: true,
                             enableKeyEvents: true,
                             value:'APPROVE_BYREPORTTO',
                             store:['APPROVE_BYREPORTTO','APPROVE_BYEMP2','SUBMIT','REJECT_BYREPORTTO','REJECT_BYEMP2'],
                         },
                    ]
                },
                {
                ...
                {
                    xtype: 'label',
                    forId: 'lblntratukarshift',
                    text: 'Check for Process. Note : only "APPROVE_BYREPORTTO" status can be processed',
                },
                {
                    xtype: 'absentrecordgridbrowseintranettukarshift',
                    height: 300,
