Ext.define('Hrd.view.klaimpengobatan.FormOptions', {
    alias: 'widget.klaimpengobatanformoptions',
    extend: 'Hrd.library.box.view.FormData',
    frame: true,
    autoScroll: true,
    requires: ['Hrd.view.klaimpengobatan.GridBrowseIntranet'],
    uniquename: "_klaimpengobatanformoptions",
    deletedData: {},
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                {
                    xtype: 'klaimpengobatangridbrowseintranet',
                    height: 300,
