    ...
    comboHelper: function(comboBox) {
        var x = {
            ...
            getText: function(comboBoxField) {
                return comboBox.getStore().getAt(comboBox.getStore().findExact(comboBoxField.v, comboBox.getValue())).get(comboBoxField.d);
            },
    ...
    dateFunc: function(date) {
        ...
        var x = {
            ...
            getDayWeekName: function() {
                ...
                var name = false;
                switch(day){
                    case 0:name="Minggu";break;
                    case 1:name="Senin";break;
                    case 2:name="Selasa";break;
                    case 3:name="Rabu";break;
                    case 4:name="Kamis";break;
                    case 5:name="Jumat";break;
                    case 6:name="Sabtu";break;
                }
                return name;
            }
        };
