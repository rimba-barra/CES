Ext.define('Hrd.library.box.tools.EventSelector2b', {
    id: '',
    ...
    getEvents: function(me, controllerName) {
        ...
        events[panel + ' toolbar button[action=create]'] = {
            click: function(el) {

               // me.formDataShow(el, 'create', 'create');
            }
        };
        events[panel + ' toolbar button[action=update]'] = {
            click: function(el) {
               // me.formDataShow(el, 'update', 'create');
            }
        };
        events[panel + ' toolbar button[action=destroy]'] = {
            click: me.dataDestroy
        };
        events[panel + ' toolbar button[action=print]'] = {
            click: me.dataPrint
        };
        ...
        events[panel + ' toolbar button[action=cancel]'] = {
            click: function(fld, a) {
                me.cancelOnClick();
            }

        };
        events[panel + ' toolbar button[action=save]'] = {
            click: function(fld, a) {
                me.saveOnClick();
            }

        };
        events[panel + ' toolbar button[action=edit]'] = {
            click: function(fld, a) {
                me.editOnClick();
            }

        };
        events[panel + ' toolbar button[action=delete]'] = {
            click: function(fld, a) {
                me.deleteOnClick();
            }
