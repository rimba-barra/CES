Ext.define('Hrd.template.combobox.Positioncombobox', {
    extend: 'Hrd.template.component.Combobox',
    alias: 'widget.positioncombobox',
    store: 'Position', //masuk dalam store
    fieldLabel: 'Position',
    dynamicdata: 0, //jika 1 maka store tidak akan di load otomatis sebaliknya jika 0 akan di load otomatis ketika from render
    displayField: 'position', //mengambil data dari store
    valueField: 'position_id', //mengambil data dari store   
    matchFieldWidth: false,
    typeAhead: true,
    tpl: Ext.create('Ext.XTemplate',
          '<table class="x-grid-table" width="500px" >',
            '<tr class="x-grid-row">',
                '<th width="50px"><div class="x-column-header x-column-header-inner">Position</div></th>',
